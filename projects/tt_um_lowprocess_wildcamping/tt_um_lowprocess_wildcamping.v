module tt_um_lowprocess_wildcamping (clk,
    ena,
    rst_n,
    VPWR,
    VGND,
 ...
 wire _204_;
 wire clknet_0_clk;
 wire \c0.instruction[14] ;
 wire \c0.pc0.addr_o[1] ;
 wire \c0.rf0.regs[1][0] ;
 wire \c0.rf0.regs[1][1] ;
 wire \c0.rf0.regs[1][2] ;
 wire \c0.rf0.regs[1][3] ;
 wire \c0.rf0.regs[1][4] ;
 wire \c0.rf0.regs[1][5] ;
 wire \c0.rf0.regs[1][6] ;
 wire \c0.rf0.regs[1][7] ;
 wire \c0.rf0.regs[2][0] ;
 wire \c0.rf0.regs[2][1] ;
 wire \c0.rf0.regs[2][2] ;
 wire \c0.rf0.regs[2][3] ;
 wire \c0.rf0.regs[2][4] ;
 wire \c0.rf0.regs[2][5] ;
 wire \c0.rf0.regs[2][6] ;
 wire \c0.rf0.regs[2][7] ;
 wire \c0.rf0.regs[4][0] ;
 wire \c0.rf0.regs[4][1] ;
 wire \c0.rf0.regs[4][2] ;
 wire \c0.rf0.regs[4][3] ;
 wire \c0.rf0.regs[4][4] ;
 wire \c0.rf0.regs[4][5] ;
 wire \c0.rf0.regs[4][6] ;
 wire \c0.rf0.regs[4][7] ;
 wire clk_out;
 wire \p0.counter[0] ;
 wire net1;
 wire net2;
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _205_ (.A(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_028_));
 sky130_fd_sc_hd__inv_2 _206_ (.A(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _207_ (.A(net2),
    ...
    .VPWR(VPWR),
    .Y(_029_));
 sky130_fd_sc_hd__inv_2 _208_ (.A(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(uio_oe[7]));
 sky130_fd_sc_hd__inv_2 _209_ (.A(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(uo_out[7]));
 sky130_fd_sc_hd__nand2b_2 _210_ (.A_N(\p0.counter[0] ),
    .B(clk_out),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_030_));
 sky130_fd_sc_hd__a21oi_2 _211_ (.A1(clk_out),
    .A2(net2),
    .B1(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_000_));
 sky130_fd_sc_hd__and2b_2 _212_ (.A_N(clk_out),
    .B(\p0.counter[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__mux2_1 _213_ (.A0(_029_),
    .A1(_031_),
    .S(_030_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__or2_2 _214_ (.A(net21),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__mux2_1 _215_ (.A0(\c0.rf0.regs[4][0] ),
    .A1(net47),
    .S(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_002_));
 sky130_fd_sc_hd__mux2_1 _216_ (.A0(net45),
    .A1(\c0.rf0.regs[1][1] ),
    .S(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__or3_2 _217_ (.A(net21),
    .B(net24),
    .C(\c0.rf0.regs[4][2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_033_));
 sky130_fd_sc_hd__nand2b_2 _218_ (.A_N(net24),
    .B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_034_));
 sky130_fd_sc_hd__nand2b_2 _219_ (.A_N(\c0.rf0.regs[1][0] ),
    .B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_035_));
 sky130_fd_sc_hd__o221a_2 _220_ (.A1(\c0.rf0.regs[4][0] ),
    .A2(net19),
    .B1(net17),
    .B2(\c0.rf0.regs[2][0] ),
    .C1(_035_),
    ...
    .VPWR(VPWR),
    .X(_036_));
 sky130_fd_sc_hd__and2b_2 _221_ (.A_N(net21),
    .B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_037_));
 sky130_fd_sc_hd__nand2_2 _222_ (.A(net20),
    .B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_038_));
 sky130_fd_sc_hd__and3b_2 _223_ (.A_N(net21),
    .B(net22),
    .C(\c0.rf0.regs[2][1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_039_));
 sky130_fd_sc_hd__nand2_2 _224_ (.A(\c0.rf0.regs[2][1] ),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_040_));
 sky130_fd_sc_hd__and2_2 _225_ (.A(_036_),
    .B(_039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_041_));
 sky130_fd_sc_hd__nand2_2 _226_ (.A(_036_),
    .B(_039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_042_));
 sky130_fd_sc_hd__and2_2 _227_ (.A(\c0.rf0.regs[2][0] ),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_043_));
 sky130_fd_sc_hd__nand2_2 _228_ (.A(\c0.rf0.regs[2][0] ),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_044_));
 sky130_fd_sc_hd__nand2b_2 _229_ (.A_N(\c0.rf0.regs[1][1] ),
    .B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_045_));
 sky130_fd_sc_hd__o221a_2 _230_ (.A1(\c0.rf0.regs[4][1] ),
    .A2(net19),
    .B1(net17),
    .B2(\c0.rf0.regs[2][1] ),
    .C1(_045_),
    ...
    .VPWR(VPWR),
    .X(_046_));
 sky130_fd_sc_hd__and3_2 _231_ (.A(\c0.rf0.regs[1][1] ),
    .B(_041_),
    .C(_043_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_047_));
 sky130_fd_sc_hd__and3b_2 _232_ (.A_N(net21),
    .B(net23),
    .C(\c0.rf0.regs[2][2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_048_));
 sky130_fd_sc_hd__nand2_2 _233_ (.A(\c0.rf0.regs[2][2] ),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_049_));
 sky130_fd_sc_hd__and2_2 _234_ (.A(_036_),
    .B(_048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__and4_2 _235_ (.A(net20),
    .B(net22),
    .C(\c0.rf0.regs[1][1] ),
    .D(\c0.rf0.regs[2][1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_051_));
 sky130_fd_sc_hd__and2_2 _236_ (.A(_046_),
    .B(_048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_052_));
 sky130_fd_sc_hd__nand2_2 _237_ (.A(_041_),
    .B(_052_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_053_));
 sky130_fd_sc_hd__o21ai_2 _238_ (.A1(_050_),
    .A2(_051_),
    .B1(_053_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_054_));
 sky130_fd_sc_hd__or4b_2 _239_ (.A(_042_),
    .B(_044_),
    .C(_054_),
    .D_N(_045_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_055_));
 sky130_fd_sc_hd__xnor2_2 _240_ (.A(_047_),
    .B(_054_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_056_));
 sky130_fd_sc_hd__o221ai_2 _241_ (.A1(_026_),
    .A2(\c0.rf0.regs[1][2] ),
    .B1(\c0.rf0.regs[2][2] ),
    .B2(net18),
    .C1(_033_),
    ...
    .VPWR(VPWR),
    .Y(_057_));
 sky130_fd_sc_hd__nor2_2 _242_ (.A(_044_),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_058_));
 sky130_fd_sc_hd__nand2_2 _243_ (.A(_056_),
    .B(_058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_059_));
 sky130_fd_sc_hd__or2_2 _244_ (.A(_056_),
    .B(_058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_060_));
 sky130_fd_sc_hd__a2bb2o_2 _245_ (.A1_N(net16),
    .A2_N(net15),
    .B1(_059_),
    .B2(_060_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_061_));
 sky130_fd_sc_hd__mux2_1 _246_ (.A0(net33),
    .A1(\c0.rf0.regs[1][2] ),
    .S(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_004_));
 sky130_fd_sc_hd__or3_2 _247_ (.A(\c0.pc0.addr_o[1] ),
    .B(net24),
    .C(\c0.rf0.regs[4][3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_062_));
 sky130_fd_sc_hd__mux2_1 _248_ (.A0(net37),
    .A1(\c0.rf0.regs[1][3] ),
    .S(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_005_));
 sky130_fd_sc_hd__or3_2 _249_ (.A(net21),
    .B(net23),
    .C(\c0.rf0.regs[4][4] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_063_));
 sky130_fd_sc_hd__mux2_1 _250_ (.A0(net35),
    .A1(\c0.rf0.regs[1][4] ),
    .S(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__mux2_1 _251_ (.A0(\c0.rf0.regs[4][5] ),
    .A1(net39),
    .S(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_007_));
 sky130_fd_sc_hd__mux2_1 _252_ (.A0(\c0.rf0.regs[4][6] ),
    .A1(net41),
    .S(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_008_));
 sky130_fd_sc_hd__mux2_1 _253_ (.A0(\c0.rf0.regs[4][7] ),
    .A1(net43),
    .S(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_009_));
 sky130_fd_sc_hd__a21o_2 _254_ (.A1(net21),
    .A2(net23),
    .B1(\c0.rf0.regs[2][0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_064_));
 sky130_fd_sc_hd__and2_2 _255_ (.A(_035_),
    .B(_064_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__a21oi_2 _256_ (.A1(\c0.rf0.regs[1][1] ),
    .A2(_043_),
    .B1(_041_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_065_));
 sky130_fd_sc_hd__a2bb2o_2 _257_ (.A1_N(_047_),
    .A2_N(_065_),
    .B1(_038_),
    .B2(_046_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_066_));
 sky130_fd_sc_hd__mux2_1 _258_ (.A0(net50),
    .A1(_066_),
    .S(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_011_));
 sky130_fd_sc_hd__mux2_1 _259_ (.A0(net55),
    .A1(_061_),
    .S(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__or3b_2 _260_ (.A(net24),
    .B(\c0.rf0.regs[2][3] ),
    .C_N(net21),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_067_));
 sky130_fd_sc_hd__nand2b_2 _261_ (.A_N(\c0.rf0.regs[1][3] ),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_068_));
 sky130_fd_sc_hd__and3_2 _262_ (.A(_062_),
    .B(_067_),
    .C(_068_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_069_));
 sky130_fd_sc_hd__and2_2 _263_ (.A(_043_),
    .B(_069_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_070_));
 sky130_fd_sc_hd__nor2_2 _264_ (.A(_040_),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_071_));
 sky130_fd_sc_hd__or4b_2 _265_ (.A(_040_),
    .B(_044_),
    .C(net15),
    .D_N(_069_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_072_));
 sky130_fd_sc_hd__o21a_2 _266_ (.A1(_070_),
    .A2(_071_),
    .B1(_072_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_073_));
 sky130_fd_sc_hd__and2_2 _267_ (.A(\c0.rf0.regs[2][3] ),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_074_));
 sky130_fd_sc_hd__nand2_2 _268_ (.A(\c0.rf0.regs[2][3] ),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_075_));
 sky130_fd_sc_hd__and2_2 _269_ (.A(_036_),
    .B(_074_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_076_));
 sky130_fd_sc_hd__a21o_2 _270_ (.A1(_042_),
    .A2(_052_),
    .B1(_076_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_077_));
 sky130_fd_sc_hd__nand2_2 _271_ (.A(_052_),
    .B(_076_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_078_));
 sky130_fd_sc_hd__o21a_2 _272_ (.A1(_039_),
    .A2(_078_),
    .B1(_077_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_079_));
 sky130_fd_sc_hd__xnor2_2 _273_ (.A(_073_),
    .B(_079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_080_));
 sky130_fd_sc_hd__a21o_2 _274_ (.A1(_055_),
    .A2(_059_),
    .B1(_080_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_081_));
 sky130_fd_sc_hd__nand3_2 _275_ (.A(_055_),
    .B(_059_),
    .C(_080_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_082_));
 sky130_fd_sc_hd__a21o_2 _276_ (.A1(_081_),
    .A2(_082_),
    .B1(_038_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_083_));
 sky130_fd_sc_hd__o221a_2 _277_ (.A1(net22),
    .A2(\c0.rf0.regs[2][3] ),
    .B1(_068_),
    .B2(net20),
    .C1(_083_),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__and4_2 _278_ (.A(net20),
    .B(net23),
    .C(\c0.rf0.regs[1][0] ),
    .D(\c0.rf0.regs[2][4] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_084_));
 sky130_fd_sc_hd__nand3_2 _279_ (.A(_046_),
    .B(_074_),
    .C(_084_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_085_));
 sky130_fd_sc_hd__a21o_2 _280_ (.A1(_046_),
    .A2(_074_),
    .B1(_084_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_2 _281_ (.A(_085_),
    ...
    .VPWR(VPWR),
    .Y(_087_));
 sky130_fd_sc_hd__nor2_2 _282_ (.A(_072_),
    .B(_087_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_088_));
 sky130_fd_sc_hd__xor2_2 _283_ (.A(_072_),
    .B(_087_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_089_));
 sky130_fd_sc_hd__xnor2_2 _284_ (.A(_078_),
    .B(_089_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_090_));
 sky130_fd_sc_hd__or2_2 _285_ (.A(net22),
    .B(\c0.rf0.regs[2][4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_091_));
 sky130_fd_sc_hd__nand2b_2 _286_ (.A_N(\c0.rf0.regs[1][4] ),
    .B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_092_));
 sky130_fd_sc_hd__o211a_2 _287_ (.A1(\c0.rf0.regs[2][4] ),
    .A2(net18),
    .B1(_063_),
    .C1(_092_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_093_));
 sky130_fd_sc_hd__o2111a_2 _288_ (.A1(\c0.rf0.regs[2][4] ),
    .A2(net18),
    .B1(_039_),
    .C1(_063_),
    .D1(_092_),
    ...
    .VPWR(VPWR),
    .X(_094_));
 sky130_fd_sc_hd__and3_2 _289_ (.A(_043_),
    .B(_069_),
    .C(_094_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_095_));
 sky130_fd_sc_hd__nand2_2 _290_ (.A(_070_),
    .B(_094_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_096_));
 sky130_fd_sc_hd__a22o_2 _291_ (.A1(_039_),
    .A2(_069_),
    .B1(_093_),
    .B2(_043_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_097_));
 sky130_fd_sc_hd__nor2_2 _292_ (.A(_049_),
    .B(_057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_098_));
 sky130_fd_sc_hd__and3_2 _293_ (.A(_096_),
    .B(_097_),
    .C(_098_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_099_));
 sky130_fd_sc_hd__a21oi_2 _294_ (.A1(_096_),
    .A2(_097_),
    .B1(_098_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_100_));
 sky130_fd_sc_hd__nor2_2 _295_ (.A(_099_),
    .B(_100_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_101_));
 sky130_fd_sc_hd__nand2_2 _296_ (.A(_090_),
    .B(_101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_102_));
 sky130_fd_sc_hd__xor2_2 _297_ (.A(_090_),
    .B(_101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_103_));
 sky130_fd_sc_hd__a2bb2o_2 _298_ (.A1_N(_053_),
    .A2_N(_074_),
    .B1(_079_),
    .B2(_073_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_104_));
 sky130_fd_sc_hd__and2_2 _299_ (.A(_103_),
    .B(_104_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_105_));
 sky130_fd_sc_hd__xnor2_2 _300_ (.A(_103_),
    .B(_104_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_106_));
 sky130_fd_sc_hd__nor2_2 _301_ (.A(_081_),
    .B(_106_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_107_));
 sky130_fd_sc_hd__and2_2 _302_ (.A(_081_),
    .B(_106_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_108_));
 sky130_fd_sc_hd__nor2_2 _303_ (.A(_107_),
    .B(_108_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_109_));
 sky130_fd_sc_hd__o221a_2 _304_ (.A1(net20),
    .A2(_092_),
    .B1(_109_),
    .B2(_038_),
    .C1(_091_),
    ...
    .VPWR(VPWR),
    .X(_014_));
 sky130_fd_sc_hd__a31o_2 _305_ (.A1(_052_),
    .A2(_076_),
    .A3(_089_),
    .B1(_088_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_110_));
 sky130_fd_sc_hd__and3_2 _306_ (.A(\c0.rf0.regs[2][5] ),
    .B(_036_),
    .C(net16),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_111_));
 sky130_fd_sc_hd__and3_2 _307_ (.A(\c0.rf0.regs[1][1] ),
    .B(\c0.rf0.regs[2][4] ),
    .C(net16),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_112_));
 sky130_fd_sc_hd__nand2_2 _308_ (.A(_111_),
    .B(_112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_113_));
 sky130_fd_sc_hd__xnor2_2 _309_ (.A(_111_),
    .B(_112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_114_));
 sky130_fd_sc_hd__a21oi_2 _310_ (.A1(_097_),
    .A2(_098_),
    .B1(_095_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_115_));
 sky130_fd_sc_hd__or2_2 _311_ (.A(_114_),
    .B(_115_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_116_));
 sky130_fd_sc_hd__xnor2_2 _312_ (.A(_114_),
    .B(_115_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_117_));
 sky130_fd_sc_hd__xor2_2 _313_ (.A(_085_),
    .B(_117_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_118_));
 sky130_fd_sc_hd__nor2_2 _314_ (.A(_057_),
    .B(_075_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_119_));
 sky130_fd_sc_hd__o2111a_2 _315_ (.A1(\c0.rf0.regs[2][4] ),
    .A2(net18),
    .B1(_048_),
    .C1(_063_),
    .D1(_092_),
    ...
    .VPWR(VPWR),
    .X(_120_));
 sky130_fd_sc_hd__and4_2 _316_ (.A(_048_),
    .B(_062_),
    .C(_067_),
    .D(_068_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_121_));
 sky130_fd_sc_hd__nand2_2 _317_ (.A(_094_),
    .B(_121_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_122_));
 sky130_fd_sc_hd__xnor2_2 _318_ (.A(_094_),
    .B(_121_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_123_));
 sky130_fd_sc_hd__xor2_2 _319_ (.A(_119_),
    .B(_123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_124_));
 sky130_fd_sc_hd__nand2b_2 _320_ (.A_N(\c0.rf0.regs[1][5] ),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_125_));
 sky130_fd_sc_hd__o221ai_2 _321_ (.A1(\c0.rf0.regs[4][5] ),
    .A2(_032_),
    .B1(net18),
    .B2(\c0.rf0.regs[2][5] ),
    .C1(_125_),
    ...
    .VPWR(VPWR),
    .Y(_126_));
 sky130_fd_sc_hd__or3_2 _322_ (.A(_044_),
    .B(_124_),
    .C(_126_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_127_));
 sky130_fd_sc_hd__o21ai_2 _323_ (.A1(_044_),
    .A2(_126_),
    .B1(_124_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_2 _324_ (.A(_127_),
    ...
    .VPWR(VPWR),
    .X(_129_));
 sky130_fd_sc_hd__nand2_2 _325_ (.A(_118_),
    .B(_129_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_130_));
 sky130_fd_sc_hd__xnor2_2 _326_ (.A(_118_),
    .B(_129_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_131_));
 sky130_fd_sc_hd__nor2_2 _327_ (.A(_102_),
    .B(_131_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_132_));
 sky130_fd_sc_hd__xor2_2 _328_ (.A(_102_),
    .B(_131_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_133_));
 sky130_fd_sc_hd__xor2_2 _329_ (.A(_110_),
    .B(_133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_134_));
 sky130_fd_sc_hd__o21a_2 _330_ (.A1(_105_),
    .A2(_107_),
    .B1(_134_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_135_));
 sky130_fd_sc_hd__nor3_2 _331_ (.A(_105_),
    .B(_107_),
    .C(_134_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_136_));
 sky130_fd_sc_hd__o21ai_2 _332_ (.A1(_135_),
    .A2(_136_),
    .B1(net16),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_137_));
 sky130_fd_sc_hd__o221a_2 _333_ (.A1(net23),
    .A2(net56),
    .B1(_125_),
    .B2(net20),
    .C1(_137_),
    ...
    .VPWR(VPWR),
    .X(_015_));
 sky130_fd_sc_hd__a21oi_2 _334_ (.A1(_110_),
    .A2(_133_),
    .B1(_132_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_138_));
 sky130_fd_sc_hd__o21a_2 _335_ (.A1(_085_),
    .A2(_117_),
    .B1(_116_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_139_));
 sky130_fd_sc_hd__and3_2 _336_ (.A(\c0.rf0.regs[2][6] ),
    .B(_037_),
    .C(_046_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_140_));
 sky130_fd_sc_hd__and3_2 _337_ (.A(\c0.rf0.regs[2][5] ),
    .B(_037_),
    .C(_046_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_141_));
 sky130_fd_sc_hd__and3_2 _338_ (.A(\c0.rf0.regs[2][6] ),
    .B(_036_),
    .C(_037_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_142_));
 sky130_fd_sc_hd__nand2_2 _339_ (.A(_111_),
    .B(_140_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_143_));
 sky130_fd_sc_hd__xnor2_2 _340_ (.A(_141_),
    .B(_142_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_144_));
 sky130_fd_sc_hd__o31ai_1 _341_ (.A1(net15),
    .A2(_075_),
    .A3(_123_),
    .B1(_122_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_145_));
 sky130_fd_sc_hd__nand2b_2 _342_ (.A_N(_144_),
    .B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_146_));
 sky130_fd_sc_hd__xor2_2 _343_ (.A(_144_),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_147_));
 sky130_fd_sc_hd__xnor2_2 _344_ (.A(_113_),
    .B(_147_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_148_));
 sky130_fd_sc_hd__and4_2 _345_ (.A(net20),
    .B(net25),
    .C(\c0.rf0.regs[1][2] ),
    .D(\c0.rf0.regs[2][4] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_149_));
 sky130_fd_sc_hd__and4_2 _346_ (.A(net20),
    .B(net25),
    .C(\c0.rf0.regs[1][3] ),
    .D(\c0.rf0.regs[2][3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_150_));
 sky130_fd_sc_hd__nand2_2 _347_ (.A(_074_),
    .B(_093_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_151_));
 sky130_fd_sc_hd__and2_2 _348_ (.A(_120_),
    .B(_150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_152_));
 sky130_fd_sc_hd__xor2_2 _349_ (.A(_120_),
    .B(_150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_153_));
 sky130_fd_sc_hd__xnor2_2 _350_ (.A(_149_),
    .B(_153_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_154_));
 sky130_fd_sc_hd__nand2b_2 _351_ (.A_N(\c0.rf0.regs[1][6] ),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_155_));
 sky130_fd_sc_hd__o221a_2 _352_ (.A1(\c0.rf0.regs[4][6] ),
    .A2(_032_),
    .B1(net18),
    .B2(\c0.rf0.regs[2][6] ),
    .C1(_155_),
    ...
    .VPWR(VPWR),
    .X(_156_));
 sky130_fd_sc_hd__nand2_2 _353_ (.A(_043_),
    .B(_156_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_2 _354_ (.A(_040_),
    ...
    .VPWR(VPWR),
    .X(_158_));
 sky130_fd_sc_hd__or2_2 _355_ (.A(_157_),
    .B(_158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_159_));
 sky130_fd_sc_hd__xnor2_2 _356_ (.A(_157_),
    .B(_158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_160_));
 sky130_fd_sc_hd__or2_2 _357_ (.A(_154_),
    .B(_160_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_161_));
 sky130_fd_sc_hd__xnor2_2 _358_ (.A(_154_),
    .B(_160_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_162_));
 sky130_fd_sc_hd__or2_2 _359_ (.A(_127_),
    .B(_162_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_163_));
 sky130_fd_sc_hd__xnor2_2 _360_ (.A(_127_),
    .B(_162_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_164_));
 sky130_fd_sc_hd__xnor2_2 _361_ (.A(_148_),
    .B(_164_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_165_));
 sky130_fd_sc_hd__xor2_2 _362_ (.A(_130_),
    .B(_165_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_166_));
 sky130_fd_sc_hd__nand2b_2 _363_ (.A_N(_139_),
    .B(_166_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_167_));
 sky130_fd_sc_hd__xnor2_2 _364_ (.A(_139_),
    .B(_166_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_168_));
 sky130_fd_sc_hd__and2b_2 _365_ (.A_N(_138_),
    .B(_168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_169_));
 sky130_fd_sc_hd__xnor2_2 _366_ (.A(_138_),
    .B(_168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_170_));
 sky130_fd_sc_hd__nand2_2 _367_ (.A(_135_),
    .B(_170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_171_));
 sky130_fd_sc_hd__or2_2 _368_ (.A(_135_),
    .B(_170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_172_));
 sky130_fd_sc_hd__a21o_2 _369_ (.A1(_171_),
    .A2(_172_),
    .B1(_038_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_173_));
 sky130_fd_sc_hd__o221a_2 _370_ (.A1(net24),
    .A2(net51),
    .B1(_155_),
    .B2(net20),
    .C1(_173_),
    ...
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__a21oi_2 _371_ (.A1(_135_),
    .A2(_170_),
    .B1(_169_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_174_));
 sky130_fd_sc_hd__o21ai_2 _372_ (.A1(_130_),
    .A2(_165_),
    .B1(_167_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_175_));
 sky130_fd_sc_hd__o21ai_2 _373_ (.A1(_113_),
    .A2(_147_),
    .B1(_146_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_176_));
 sky130_fd_sc_hd__and4_2 _374_ (.A(net20),
    .B(net25),
    .C(\c0.rf0.regs[1][2] ),
    .D(\c0.rf0.regs[2][5] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_177_));
 sky130_fd_sc_hd__nor2_2 _375_ (.A(_049_),
    .B(_126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_178_));
 sky130_fd_sc_hd__mux2_1 _376_ (.A0(_049_),
    .A1(_178_),
    .S(_159_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_179_));
 sky130_fd_sc_hd__xnor2_2 _377_ (.A(_177_),
    .B(_179_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_180_));
 sky130_fd_sc_hd__nand2_2 _378_ (.A(\c0.rf0.regs[2][7] ),
    .B(_036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_181_));
 sky130_fd_sc_hd__nor2_2 _379_ (.A(_038_),
    .B(_140_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _380_ (.A0(_182_),
    ...
    .VPWR(VPWR),
    .X(_183_));
 sky130_fd_sc_hd__and3_2 _381_ (.A(\c0.rf0.regs[2][4] ),
    .B(_037_),
    .C(_069_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_184_));
 sky130_fd_sc_hd__xor2_2 _382_ (.A(_151_),
    .B(_184_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_185_));
 sky130_fd_sc_hd__or2_2 _383_ (.A(net25),
    .B(\c0.rf0.regs[2][7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_186_));
 sky130_fd_sc_hd__or2_2 _384_ (.A(_026_),
    .B(\c0.rf0.regs[1][7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_187_));
 sky130_fd_sc_hd__o221a_2 _385_ (.A1(\c0.rf0.regs[4][7] ),
    .A2(_032_),
    .B1(net18),
    .B2(\c0.rf0.regs[2][7] ),
    .C1(_187_),
    ...
    .VPWR(VPWR),
    .X(_188_));
 sky130_fd_sc_hd__and4_2 _386_ (.A(_039_),
    .B(_044_),
    .C(_156_),
    .D(_188_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_189_));
 sky130_fd_sc_hd__a22oi_2 _387_ (.A1(_039_),
    .A2(_156_),
    .B1(_188_),
    .B2(_044_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_190_));
 sky130_fd_sc_hd__nor2_2 _388_ (.A(_189_),
    .B(_190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_191_));
 sky130_fd_sc_hd__xnor2_2 _389_ (.A(_185_),
    .B(_191_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_192_));
 sky130_fd_sc_hd__xnor2_2 _390_ (.A(_180_),
    .B(_192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_193_));
 sky130_fd_sc_hd__xnor2_2 _391_ (.A(_183_),
    .B(_193_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_194_));
 sky130_fd_sc_hd__xor2_2 _392_ (.A(_143_),
    .B(_188_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_2 _393_ (.A1(_149_),
    ...
    .VPWR(VPWR),
    .X(_196_));
 sky130_fd_sc_hd__xnor2_2 _394_ (.A(_161_),
    .B(_196_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_197_));
 sky130_fd_sc_hd__xnor2_2 _395_ (.A(_195_),
    .B(_197_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_198_));
 sky130_fd_sc_hd__xnor2_2 _396_ (.A(_194_),
    .B(_198_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_199_));
 sky130_fd_sc_hd__o21a_2 _397_ (.A1(_148_),
    .A2(_164_),
    .B1(_163_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_200_));
 sky130_fd_sc_hd__xnor2_2 _398_ (.A(_176_),
    .B(_200_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_201_));
 sky130_fd_sc_hd__xnor2_2 _399_ (.A(_199_),
    .B(_201_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_202_));
 sky130_fd_sc_hd__xnor2_2 _400_ (.A(_175_),
    .B(_202_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_203_));
 sky130_fd_sc_hd__xnor2_2 _401_ (.A(_174_),
    .B(_203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_204_));
 sky130_fd_sc_hd__o221a_2 _402_ (.A1(_028_),
    .A2(_187_),
    .B1(_204_),
    .B2(_038_),
    .C1(_186_),
    ...
    .VPWR(VPWR),
    .X(_017_));
 sky130_fd_sc_hd__mux2_1 _403_ (.A0(net49),
    .A1(uio_out[0]),
    .S(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_018_));
 sky130_fd_sc_hd__mux2_1 _404_ (.A0(net50),
    .A1(uio_out[1]),
    .S(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_019_));
 sky130_fd_sc_hd__mux2_1 _405_ (.A0(net55),
    .A1(uio_out[2]),
    .S(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_020_));
 sky130_fd_sc_hd__mux2_1 _406_ (.A0(net54),
    .A1(uio_out[3]),
    .S(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_021_));
 sky130_fd_sc_hd__mux2_1 _407_ (.A0(\c0.rf0.regs[2][4] ),
    .A1(uio_out[4]),
    .S(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_022_));
 sky130_fd_sc_hd__mux2_1 _408_ (.A0(net53),
    .A1(uio_out[5]),
    .S(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_023_));
 sky130_fd_sc_hd__mux2_1 _409_ (.A0(net51),
    .A1(uio_out[6]),
    .S(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_024_));
 sky130_fd_sc_hd__mux2_1 _410_ (.A0(net52),
    .A1(uio_out[7]),
    .S(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_025_));
 sky130_fd_sc_hd__nand2_2 _411_ (.A(net18),
    .B(_038_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_027_));
 sky130_fd_sc_hd__dfxtp_2 _412_ (.CLK(clknet_2_0__leaf_clk),
    .D(net48),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\c0.rf0.regs[1][0] ));
 sky130_fd_sc_hd__dfxtp_2 _413_ (.CLK(clknet_2_0__leaf_clk),
    .D(net46),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\c0.rf0.regs[1][1] ));
 sky130_fd_sc_hd__dfxtp_2 _414_ (.CLK(clknet_2_2__leaf_clk),
    .D(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\c0.rf0.regs[1][2] ));
 sky130_fd_sc_hd__dfxtp_2 _415_ (.CLK(clknet_2_3__leaf_clk),
    .D(net38),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\c0.rf0.regs[1][3] ));
 sky130_fd_sc_hd__dfxtp_2 _416_ (.CLK(clknet_2_1__leaf_clk),
    .D(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\c0.rf0.regs[1][4] ));
 sky130_fd_sc_hd__dfxtp_2 _417_ (.CLK(clknet_2_3__leaf_clk),
    .D(net40),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _418_ (.CLK(clknet_2_3__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\c0.rf0.regs[1][6] ));
 sky130_fd_sc_hd__dfxtp_2 _419_ (.CLK(clknet_2_2__leaf_clk),
    .D(net44),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\c0.rf0.regs[1][7] ));
 sky130_fd_sc_hd__dfxtp_2 _420_ (.CLK(clknet_2_0__leaf_clk),
    .D(_010_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\c0.rf0.regs[2][0] ));
 sky130_fd_sc_hd__dfxtp_2 _421_ (.CLK(clknet_2_0__leaf_clk),
    .D(_011_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\c0.rf0.regs[2][1] ));
 sky130_fd_sc_hd__dfxtp_2 _422_ (.CLK(clknet_2_0__leaf_clk),
    .D(_012_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\c0.rf0.regs[2][2] ));
 sky130_fd_sc_hd__dfxtp_2 _423_ (.CLK(clknet_2_0__leaf_clk),
    .D(_013_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _425_ (.CLK(clknet_2_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\c0.rf0.regs[2][5] ));
 sky130_fd_sc_hd__dfxtp_2 _426_ (.CLK(clknet_2_3__leaf_clk),
    .D(_016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _427_ (.CLK(clknet_2_2__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\c0.rf0.regs[2][7] ));
 sky130_fd_sc_hd__dfxtp_2 _428_ (.CLK(clknet_2_1__leaf_clk),
    .D(_018_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _430_ (.CLK(clknet_2_1__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(uio_out[2]));
 sky130_fd_sc_hd__dfxtp_2 _431_ (.CLK(clknet_2_0__leaf_clk),
    .D(_021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uio_out[3]));
 sky130_fd_sc_hd__dfxtp_2 _432_ (.CLK(clknet_2_1__leaf_clk),
    .D(_022_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uio_out[4]));
 sky130_fd_sc_hd__dfxtp_2 _433_ (.CLK(clknet_2_1__leaf_clk),
    .D(_023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uio_out[5]));
 sky130_fd_sc_hd__dfxtp_2 _434_ (.CLK(clknet_2_1__leaf_clk),
    .D(_024_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uio_out[6]));
 sky130_fd_sc_hd__dfxtp_2 _435_ (.CLK(clknet_2_1__leaf_clk),
    .D(_025_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uio_out[7]));
 sky130_fd_sc_hd__dfrtp_2 _436_ (.CLK(clknet_2_2__leaf_clk),
    .D(_026_),
    .RESET_B(net1),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\c0.instruction[14] ));
 sky130_fd_sc_hd__dfrtp_2 _437_ (.CLK(clknet_2_2__leaf_clk),
    .D(_027_),
    .RESET_B(net1),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\c0.pc0.addr_o[1] ));
 sky130_fd_sc_hd__dfrtp_2 _438_ (.CLK(clknet_2_2__leaf_clk),
    .D(net32),
    .RESET_B(net1),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\p0.counter[0] ));
 sky130_fd_sc_hd__dfrtp_2 _439_ (.CLK(clknet_2_2__leaf_clk),
    .D(_001_),
    .RESET_B(net1),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfxtp_2 _440_ (.CLK(clknet_2_2__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\c0.rf0.regs[4][0] ));
 sky130_fd_sc_hd__dfxtp_2 _441_ (.CLK(clknet_2_1__leaf_clk),
    .D(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\c0.rf0.regs[4][1] ));
 sky130_fd_sc_hd__dfxtp_2 _442_ (.CLK(clknet_2_3__leaf_clk),
    .D(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\c0.rf0.regs[4][2] ));
 sky130_fd_sc_hd__dfxtp_2 _443_ (.CLK(clknet_2_3__leaf_clk),
    .D(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _446_ (.CLK(clknet_2_3__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\c0.rf0.regs[4][6] ));
 sky130_fd_sc_hd__dfxtp_2 _447_ (.CLK(clknet_2_2__leaf_clk),
    .D(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\c0.rf0.regs[4][7] ));
 sky130_fd_sc_hd__buf_2 _454_ (.A(uio_oe[7]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_oe[0]));
 sky130_fd_sc_hd__buf_2 _455_ (.A(uio_oe[7]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_oe[1]));
 sky130_fd_sc_hd__buf_2 _456_ (.A(uio_oe[7]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_oe[2]));
 sky130_fd_sc_hd__buf_2 _457_ (.A(uio_oe[7]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_oe[3]));
 sky130_fd_sc_hd__buf_2 _458_ (.A(uio_oe[7]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_oe[4]));
 sky130_fd_sc_hd__buf_2 _459_ (.A(uio_oe[7]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_oe[5]));
 sky130_fd_sc_hd__buf_2 _460_ (.A(uio_oe[7]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_oe[6]));
 sky130_fd_sc_hd__buf_2 _461_ (.A(clk_out),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[0]));
 sky130_fd_sc_hd__buf_2 _462_ (.A(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[1]));
 sky130_fd_sc_hd__conb_1 _462__30 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net30));
 ...
 sky130_fd_sc_hd__clkbuf_4 clkload0 (.A(clknet_2_2__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout16 (.A(_037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout17 (.A(net18),
    ...
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout18 (.A(_034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout19 (.A(_032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(_028_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout21 (.A(\c0.pc0.addr_o[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout24 (.A(net25),
    ...
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout25 (.A(\c0.instruction[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__dlygate4sd3_1 hold31 (.A(\p0.counter[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net31));
 sky130_fd_sc_hd__dlygate4sd3_1 hold32 (.A(_000_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net32));
 sky130_fd_sc_hd__dlygate4sd3_1 hold33 (.A(\c0.rf0.regs[4][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net33));
 sky130_fd_sc_hd__dlygate4sd3_1 hold34 (.A(_004_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net34));
 sky130_fd_sc_hd__dlygate4sd3_1 hold35 (.A(\c0.rf0.regs[4][4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net35));
 sky130_fd_sc_hd__dlygate4sd3_1 hold36 (.A(_006_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net36));
 sky130_fd_sc_hd__dlygate4sd3_1 hold37 (.A(\c0.rf0.regs[4][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net37));
 sky130_fd_sc_hd__dlygate4sd3_1 hold38 (.A(_005_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net38));
 sky130_fd_sc_hd__dlygate4sd3_1 hold39 (.A(\c0.rf0.regs[1][5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__dlygate4sd3_1 hold40 (.A(_007_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__dlygate4sd3_1 hold41 (.A(\c0.rf0.regs[1][6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold42 (.A(_008_),
    ...
    .VPWR(VPWR),
    .X(net42));
 sky130_fd_sc_hd__dlygate4sd3_1 hold43 (.A(\c0.rf0.regs[1][7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__dlygate4sd3_1 hold44 (.A(_009_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__dlygate4sd3_1 hold45 (.A(\c0.rf0.regs[4][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__dlygate4sd3_1 hold46 (.A(_003_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net46));
 sky130_fd_sc_hd__dlygate4sd3_1 hold47 (.A(\c0.rf0.regs[1][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__dlygate4sd3_1 hold48 (.A(_002_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net48));
 sky130_fd_sc_hd__dlygate4sd3_1 hold49 (.A(\c0.rf0.regs[2][0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__dlygate4sd3_1 hold50 (.A(\c0.rf0.regs[2][1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net50));
 sky130_fd_sc_hd__dlygate4sd3_1 hold51 (.A(\c0.rf0.regs[2][6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__dlygate4sd3_1 hold52 (.A(\c0.rf0.regs[2][7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net52));
 sky130_fd_sc_hd__dlygate4sd3_1 hold53 (.A(\c0.rf0.regs[2][5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__dlygate4sd3_1 hold54 (.A(\c0.rf0.regs[2][3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__dlygate4sd3_1 hold55 (.A(\c0.rf0.regs[2][2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__dlygate4sd3_1 hold56 (.A(\c0.rf0.regs[2][5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input9 (.A(uio_in[4]),
    ...
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__clkbuf_2 max_cap15 (.A(_057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net15));
 sky130_fd_sc_hd__conb_1 tt_um_lowprocess_wildcamping (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_lowprocess_wildcamping_26 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net26));
 sky130_fd_sc_hd__conb_1 tt_um_lowprocess_wildcamping_27 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net27));
 sky130_fd_sc_hd__conb_1 tt_um_lowprocess_wildcamping_28 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net28));
 sky130_fd_sc_hd__conb_1 tt_um_lowprocess_wildcamping_29 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net29));
 sky130_fd_sc_hd__clkdlybuf4s25_1 wire13 (.A(net14),
    ...
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__clkdlybuf4s25_1 wire14 (.A(_145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
