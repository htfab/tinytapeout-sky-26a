module tt_um_bovi_cable_tester (clk,
    ena,
    rst_n,
    VPWR,
    VGND,
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _072_ (.A(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_000_));
 sky130_fd_sc_hd__inv_2 _073_ (.A(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_063_));
 sky130_fd_sc_hd__or4_2 _074_ (.A(net20),
    .B(net19),
    .C(net18),
    .D(_063_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_064_));
 sky130_fd_sc_hd__inv_2 _075_ (.A(_064_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(uio_oe[0]));
 sky130_fd_sc_hd__or3b_2 _076_ (.A(net19),
    .B(net18),
    .C_N(net20),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_065_));
 sky130_fd_sc_hd__nor2_2 _077_ (.A(_063_),
    .B(_065_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net17));
 sky130_fd_sc_hd__or3b_2 _078_ (.A(net20),
    .B(net18),
    .C_N(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_066_));
 sky130_fd_sc_hd__nor2_2 _079_ (.A(_063_),
    .B(_066_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net16));
 sky130_fd_sc_hd__nand3b_2 _080_ (.A_N(net18),
    .B(net19),
    .C(net20),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_067_));
 sky130_fd_sc_hd__nor2_2 _081_ (.A(_063_),
    .B(_067_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net15));
 sky130_fd_sc_hd__or3b_2 _082_ (.A(net20),
    .B(net19),
    .C_N(net18),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_2 _083_ (.A(_063_),
    ...
    .VPWR(VPWR),
    .Y(net14));
 sky130_fd_sc_hd__nand3b_2 _084_ (.A_N(net19),
    .B(net18),
    .C(\idx[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_069_));
 sky130_fd_sc_hd__nor2_2 _085_ (.A(_063_),
    .B(_069_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net13));
 sky130_fd_sc_hd__nand3b_2 _086_ (.A_N(\idx[0] ),
    .B(\idx[1] ),
    .C(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_070_));
 sky130_fd_sc_hd__nor2_2 _087_ (.A(_063_),
    .B(_070_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net12));
 sky130_fd_sc_hd__and4_2 _088_ (.A(\idx[0] ),
    .B(\idx[1] ),
    .C(\idx[2] ),
    .D(net22),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(uio_oe[7]));
 sky130_fd_sc_hd__nand2_2 _089_ (.A(\settle[1] ),
    .B(\settle[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_071_));
 sky130_fd_sc_hd__or2_2 _090_ (.A(\settle[1] ),
    .B(\settle[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__and2_2 _091_ (.A(_071_),
    .B(_032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_004_));
 sky130_fd_sc_hd__xnor2_2 _092_ (.A(net40),
    .B(_071_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_005_));
 sky130_fd_sc_hd__and4_2 _093_ (.A(\settle[3] ),
    .B(\settle[2] ),
    .C(\settle[1] ),
    .D(\settle[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_033_));
 sky130_fd_sc_hd__a31o_2 _094_ (.A1(\settle[2] ),
    .A2(\settle[1] ),
    .A3(\settle[0] ),
    .B1(\settle[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__and2b_2 _095_ (.A_N(_033_),
    .B(_034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__nand2_2 _096_ (.A(\settle[4] ),
    .B(_033_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_035_));
 sky130_fd_sc_hd__xor2_2 _097_ (.A(net48),
    .B(_033_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_007_));
 sky130_fd_sc_hd__xnor2_2 _098_ (.A(net43),
    .B(_035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_008_));
 sky130_fd_sc_hd__and4_2 _099_ (.A(\settle[6] ),
    .B(\settle[5] ),
    .C(\settle[4] ),
    .D(_033_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_036_));
 sky130_fd_sc_hd__a31o_2 _100_ (.A1(\settle[5] ),
    .A2(\settle[4] ),
    .A3(_033_),
    .B1(\settle[6] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_037_));
 sky130_fd_sc_hd__and2b_2 _101_ (.A_N(_036_),
    .B(_037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_009_));
 sky130_fd_sc_hd__and4_2 _102_ (.A(\settle[7] ),
    .B(\settle[6] ),
    .C(\settle[5] ),
    .D(\settle[4] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_038_));
 sky130_fd_sc_hd__nand2_2 _103_ (.A(_033_),
    .B(_038_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_039_));
 sky130_fd_sc_hd__o21a_2 _104_ (.A1(net41),
    .A2(_036_),
    .B1(_039_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__xnor2_2 _105_ (.A(net44),
    .B(_039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_011_));
 sky130_fd_sc_hd__and2_2 _106_ (.A(\settle[9] ),
    .B(\settle[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_040_));
 sky130_fd_sc_hd__and3_2 _107_ (.A(_033_),
    .B(_038_),
    .C(_040_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_041_));
 sky130_fd_sc_hd__a31o_2 _108_ (.A1(\settle[8] ),
    .A2(_033_),
    .A3(_038_),
    .B1(\settle[9] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_042_));
 sky130_fd_sc_hd__and2b_2 _109_ (.A_N(_041_),
    .B(_042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__xor2_2 _110_ (.A(net45),
    .B(_041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__a21o_2 _111_ (.A1(\settle[10] ),
    .A2(_041_),
    .B1(\settle[11] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_043_));
 sky130_fd_sc_hd__and3_2 _112_ (.A(\settle[11] ),
    .B(\settle[10] ),
    .C(_041_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_044_));
 sky130_fd_sc_hd__and2_2 _113_ (.A(\settle[11] ),
    .B(\settle[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__a21boi_2 _114_ (.A1(_041_),
    .A2(_045_),
    .B1_N(_043_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_002_));
 sky130_fd_sc_hd__and3_2 _115_ (.A(\settle[11] ),
    .B(\settle[10] ),
    .C(\settle[12] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_046_));
 sky130_fd_sc_hd__and4_2 _116_ (.A(_033_),
    .B(_038_),
    .C(_040_),
    .D(_046_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_047_));
 sky130_fd_sc_hd__and3_2 _117_ (.A(\settle[9] ),
    .B(\settle[8] ),
    .C(\settle[12] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_048_));
 sky130_fd_sc_hd__and4_2 _118_ (.A(_033_),
    .B(_038_),
    .C(_045_),
    .D(_048_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_049_));
 sky130_fd_sc_hd__o21ba_2 _119_ (.A1(net46),
    .A2(_044_),
    .B1_N(_049_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__nor2_2 _120_ (.A(net20),
    .B(_049_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_050_));
 sky130_fd_sc_hd__nand2_2 _121_ (.A(net20),
    .B(_047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_051_));
 sky130_fd_sc_hd__and2b_2 _122_ (.A_N(_050_),
    .B(_051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__xnor2_2 _123_ (.A(net19),
    .B(_051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_014_));
 sky130_fd_sc_hd__a31o_2 _124_ (.A1(net20),
    .A2(net19),
    .A3(_047_),
    .B1(net18),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_052_));
 sky130_fd_sc_hd__nand4_2 _125_ (.A(net20),
    .B(net19),
    .C(net18),
    .D(_047_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_053_));
 sky130_fd_sc_hd__and2_2 _126_ (.A(_052_),
    .B(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_015_));
 sky130_fd_sc_hd__o31a_2 _127_ (.A1(net20),
    .A2(net19),
    .A3(net18),
    .B1(\uio_sync2[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_054_));
 sky130_fd_sc_hd__or2_2 _128_ (.A(\acc[0] ),
    .B(_054_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_055_));
 sky130_fd_sc_hd__o211a_2 _129_ (.A1(net47),
    .A2(_049_),
    .B1(net10),
    .C1(_055_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__a21o_2 _130_ (.A1(\uio_sync2[1] ),
    .A2(_065_),
    .B1(\acc[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_056_));
 sky130_fd_sc_hd__o211a_2 _131_ (.A1(net51),
    .A2(_049_),
    .B1(net10),
    .C1(_056_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_017_));
 sky130_fd_sc_hd__a21o_2 _132_ (.A1(\uio_sync2[2] ),
    .A2(_066_),
    .B1(\acc[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_057_));
 sky130_fd_sc_hd__o211a_2 _133_ (.A1(net52),
    .A2(_049_),
    .B1(net10),
    .C1(_057_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_018_));
 sky130_fd_sc_hd__a21o_2 _134_ (.A1(\uio_sync2[3] ),
    .A2(_067_),
    .B1(\acc[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_058_));
 sky130_fd_sc_hd__o211a_2 _135_ (.A1(net54),
    .A2(_049_),
    .B1(net10),
    .C1(_058_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_019_));
 sky130_fd_sc_hd__a21o_2 _136_ (.A1(\uio_sync2[4] ),
    .A2(_068_),
    .B1(\acc[4] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_059_));
 sky130_fd_sc_hd__o211a_2 _137_ (.A1(net53),
    .A2(_049_),
    .B1(net11),
    .C1(_059_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_020_));
 sky130_fd_sc_hd__a21o_2 _138_ (.A1(\uio_sync2[5] ),
    .A2(_069_),
    .B1(\acc[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_060_));
 sky130_fd_sc_hd__o211a_2 _139_ (.A1(net49),
    .A2(_049_),
    .B1(net10),
    .C1(_060_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_021_));
 sky130_fd_sc_hd__a21o_2 _140_ (.A1(\uio_sync2[6] ),
    .A2(_070_),
    .B1(\acc[6] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_061_));
 sky130_fd_sc_hd__o211a_2 _141_ (.A1(net50),
    .A2(_049_),
    .B1(net10),
    .C1(_061_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_022_));
 sky130_fd_sc_hd__a21o_2 _142_ (.A1(\uio_sync2[7] ),
    .A2(_049_),
    .B1(\acc[7] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_062_));
 sky130_fd_sc_hd__and2_2 _143_ (.A(net11),
    .B(_062_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_023_));
 sky130_fd_sc_hd__mux2_1 _144_ (.A0(_055_),
    .A1(uo_out[0]),
    .S(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_024_));
 sky130_fd_sc_hd__mux2_1 _145_ (.A0(_056_),
    .A1(uo_out[1]),
    .S(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_025_));
 sky130_fd_sc_hd__mux2_1 _146_ (.A0(_057_),
    .A1(uo_out[2]),
    .S(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_026_));
 sky130_fd_sc_hd__mux2_1 _147_ (.A0(_058_),
    .A1(uo_out[3]),
    .S(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__mux2_1 _148_ (.A0(_059_),
    .A1(uo_out[4]),
    .S(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__mux2_1 _149_ (.A0(_060_),
    .A1(uo_out[5]),
    .S(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__mux2_1 _150_ (.A0(_061_),
    .A1(uo_out[6]),
    .S(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__mux2_1 _151_ (.A0(net42),
    .A1(uo_out[7]),
    .S(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__dfrtp_2 _152_ (.CLK(clknet_3_0__leaf_clk),
    .D(_013_),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\idx[0] ));
 sky130_fd_sc_hd__dfrtp_2 _153_ (.CLK(clknet_3_0__leaf_clk),
    .D(_014_),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\idx[1] ));
 sky130_fd_sc_hd__dfrtp_2 _154_ (.CLK(clknet_3_2__leaf_clk),
    .D(_015_),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\idx[2] ));
 sky130_fd_sc_hd__dfrtp_2 _155_ (.CLK(clknet_3_1__leaf_clk),
    .D(_016_),
    .RESET_B(net24),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\acc[0] ));
 sky130_fd_sc_hd__dfrtp_2 _156_ (.CLK(clknet_3_3__leaf_clk),
    .D(_017_),
    .RESET_B(net25),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\acc[1] ));
 sky130_fd_sc_hd__dfrtp_2 _157_ (.CLK(clknet_3_3__leaf_clk),
    .D(_018_),
    .RESET_B(net26),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\acc[2] ));
 sky130_fd_sc_hd__dfrtp_2 _158_ (.CLK(clknet_3_3__leaf_clk),
    .D(_019_),
    .RESET_B(net23),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\acc[3] ));
 sky130_fd_sc_hd__dfrtp_2 _159_ (.CLK(clknet_3_1__leaf_clk),
    .D(_020_),
    .RESET_B(net23),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\acc[4] ));
 sky130_fd_sc_hd__dfrtp_2 _160_ (.CLK(clknet_3_2__leaf_clk),
    .D(_021_),
    .RESET_B(net24),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\acc[5] ));
 sky130_fd_sc_hd__dfrtp_2 _161_ (.CLK(clknet_3_2__leaf_clk),
    .D(_022_),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\acc[6] ));
 sky130_fd_sc_hd__dfrtp_2 _162_ (.CLK(clknet_3_4__leaf_clk),
    .D(_023_),
    .RESET_B(net26),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\acc[7] ));
 sky130_fd_sc_hd__dfrtp_2 _163_ (.CLK(clknet_3_0__leaf_clk),
    .D(_024_),
    .RESET_B(net24),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[0]));
 sky130_fd_sc_hd__dfrtp_2 _164_ (.CLK(clknet_3_6__leaf_clk),
    .D(_025_),
    .RESET_B(net26),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[1]));
 sky130_fd_sc_hd__dfrtp_2 _165_ (.CLK(clknet_3_3__leaf_clk),
    .D(_026_),
    .RESET_B(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[2]));
 sky130_fd_sc_hd__dfrtp_2 _166_ (.CLK(clknet_3_3__leaf_clk),
    .D(_027_),
    .RESET_B(net24),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[3]));
 sky130_fd_sc_hd__dfrtp_2 _167_ (.CLK(clknet_3_3__leaf_clk),
    .D(_028_),
    .RESET_B(net24),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[4]));
 sky130_fd_sc_hd__dfrtp_2 _168_ (.CLK(clknet_3_2__leaf_clk),
    .D(_029_),
    .RESET_B(net24),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[5]));
 sky130_fd_sc_hd__dfrtp_2 _169_ (.CLK(clknet_3_2__leaf_clk),
    .D(_030_),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[6]));
 sky130_fd_sc_hd__dfrtp_2 _170_ (.CLK(clknet_3_1__leaf_clk),
    .D(_031_),
    .RESET_B(net26),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[7]));
 sky130_fd_sc_hd__dfrtp_2 _171_ (.CLK(clknet_3_5__leaf_clk),
    .D(_000_),
    .RESET_B(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\settle[0] ));
 sky130_fd_sc_hd__dfrtp_2 _172_ (.CLK(clknet_3_5__leaf_clk),
    .D(_004_),
    .RESET_B(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\settle[1] ));
 sky130_fd_sc_hd__dfrtp_2 _173_ (.CLK(clknet_3_5__leaf_clk),
    .D(_005_),
    .RESET_B(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\settle[2] ));
 sky130_fd_sc_hd__dfrtp_2 _174_ (.CLK(clknet_3_5__leaf_clk),
    .D(_006_),
    .RESET_B(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\settle[3] ));
 sky130_fd_sc_hd__dfrtp_2 _175_ (.CLK(clknet_3_4__leaf_clk),
    .D(_007_),
    .RESET_B(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\settle[4] ));
 sky130_fd_sc_hd__dfrtp_2 _176_ (.CLK(clknet_3_5__leaf_clk),
    .D(_008_),
    .RESET_B(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\settle[5] ));
 sky130_fd_sc_hd__dfrtp_2 _177_ (.CLK(clknet_3_4__leaf_clk),
    .D(_009_),
    .RESET_B(net26),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\settle[6] ));
 sky130_fd_sc_hd__dfrtp_2 _178_ (.CLK(clknet_3_1__leaf_clk),
    .D(_010_),
    .RESET_B(net26),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\settle[7] ));
 sky130_fd_sc_hd__dfrtp_2 _179_ (.CLK(clknet_3_4__leaf_clk),
    .D(_011_),
    .RESET_B(net26),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\settle[8] ));
 sky130_fd_sc_hd__dfrtp_2 _180_ (.CLK(clknet_3_1__leaf_clk),
    .D(_012_),
    .RESET_B(net23),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\settle[9] ));
 sky130_fd_sc_hd__dfrtp_2 _181_ (.CLK(clknet_3_0__leaf_clk),
    .D(_001_),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\settle[10] ));
 sky130_fd_sc_hd__dfrtp_2 _182_ (.CLK(clknet_3_0__leaf_clk),
    .D(_002_),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\settle[11] ));
 sky130_fd_sc_hd__dfrtp_2 _183_ (.CLK(clknet_3_0__leaf_clk),
    .D(_003_),
    .RESET_B(net24),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\settle[12] ));
 sky130_fd_sc_hd__dfrtp_2 _184_ (.CLK(clknet_3_4__leaf_clk),
    .D(net2),
    .RESET_B(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uio_sync1[0] ));
 sky130_fd_sc_hd__dfrtp_2 _185_ (.CLK(clknet_3_6__leaf_clk),
    .D(net3),
    .RESET_B(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uio_sync1[1] ));
 sky130_fd_sc_hd__dfrtp_2 _186_ (.CLK(clknet_3_7__leaf_clk),
    .D(net4),
    .RESET_B(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uio_sync1[2] ));
 sky130_fd_sc_hd__dfrtp_2 _187_ (.CLK(clknet_3_6__leaf_clk),
    .D(net5),
    .RESET_B(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uio_sync1[3] ));
 sky130_fd_sc_hd__dfrtp_2 _188_ (.CLK(clknet_3_6__leaf_clk),
    .D(net6),
    .RESET_B(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uio_sync1[4] ));
 sky130_fd_sc_hd__dfrtp_2 _189_ (.CLK(clknet_3_6__leaf_clk),
    .D(net7),
    .RESET_B(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uio_sync1[5] ));
 sky130_fd_sc_hd__dfrtp_2 _190_ (.CLK(clknet_3_6__leaf_clk),
    .D(net8),
    .RESET_B(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uio_sync1[6] ));
 sky130_fd_sc_hd__dfrtp_2 _191_ (.CLK(clknet_3_1__leaf_clk),
    .D(net9),
    .RESET_B(net26),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uio_sync1[7] ));
 sky130_fd_sc_hd__dfrtp_2 _192_ (.CLK(clknet_3_5__leaf_clk),
    .D(net31),
    .RESET_B(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uio_sync2[0] ));
 sky130_fd_sc_hd__dfrtp_2 _193_ (.CLK(clknet_3_7__leaf_clk),
    .D(net33),
    .RESET_B(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uio_sync2[1] ));
 sky130_fd_sc_hd__dfrtp_2 _194_ (.CLK(clknet_3_7__leaf_clk),
    .D(net36),
    .RESET_B(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uio_sync2[2] ));
 sky130_fd_sc_hd__dfrtp_2 _195_ (.CLK(clknet_3_7__leaf_clk),
    .D(net32),
    .RESET_B(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uio_sync2[3] ));
 sky130_fd_sc_hd__dfrtp_2 _196_ (.CLK(clknet_3_7__leaf_clk),
    .D(net35),
    .RESET_B(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uio_sync2[4] ));
 sky130_fd_sc_hd__dfrtp_2 _197_ (.CLK(clknet_3_7__leaf_clk),
    .D(net34),
    .RESET_B(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uio_sync2[5] ));
 sky130_fd_sc_hd__dfrtp_2 _198_ (.CLK(clknet_3_2__leaf_clk),
    .D(net38),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uio_sync2[6] ));
 sky130_fd_sc_hd__dfrtp_2 _199_ (.CLK(clknet_3_4__leaf_clk),
    .D(net37),
    .RESET_B(net26),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\uio_sync2[7] ));
 sky130_fd_sc_hd__buf_2 _200_ (.A(uio_oe[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[0]));
 sky130_fd_sc_hd__buf_2 _201_ (.A(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[1]));
 sky130_fd_sc_hd__buf_2 _202_ (.A(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[2]));
 sky130_fd_sc_hd__buf_2 _203_ (.A(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[3]));
 sky130_fd_sc_hd__buf_2 _204_ (.A(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[4]));
 sky130_fd_sc_hd__buf_2 _205_ (.A(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[5]));
 sky130_fd_sc_hd__buf_2 _206_ (.A(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[6]));
 sky130_fd_sc_hd__buf_2 _207_ (.A(uio_oe[7]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout10 (.A(_053_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout11 (.A(_053_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net11));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout18 (.A(\idx[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout19 (.A(\idx[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(\idx[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout30 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__dlygate4sd3_1 hold31 (.A(\uio_sync1[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net31));
 sky130_fd_sc_hd__dlygate4sd3_1 hold32 (.A(\uio_sync1[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net32));
 sky130_fd_sc_hd__dlygate4sd3_1 hold33 (.A(\uio_sync1[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net33));
 sky130_fd_sc_hd__dlygate4sd3_1 hold34 (.A(\uio_sync1[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net34));
 sky130_fd_sc_hd__dlygate4sd3_1 hold35 (.A(\uio_sync1[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net35));
 sky130_fd_sc_hd__dlygate4sd3_1 hold36 (.A(\uio_sync1[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net36));
 sky130_fd_sc_hd__dlygate4sd3_1 hold37 (.A(\uio_sync1[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net37));
 sky130_fd_sc_hd__dlygate4sd3_1 hold38 (.A(\uio_sync1[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net38));
 sky130_fd_sc_hd__dlygate4sd3_1 hold39 (.A(\settle[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__dlygate4sd3_1 hold40 (.A(\settle[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__dlygate4sd3_1 hold41 (.A(\settle[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net41));
 sky130_fd_sc_hd__dlygate4sd3_1 hold42 (.A(\acc[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net42));
 sky130_fd_sc_hd__dlygate4sd3_1 hold43 (.A(\settle[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__dlygate4sd3_1 hold44 (.A(\settle[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__dlygate4sd3_1 hold45 (.A(\settle[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__dlygate4sd3_1 hold46 (.A(\settle[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net46));
 sky130_fd_sc_hd__dlygate4sd3_1 hold47 (.A(\acc[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__dlygate4sd3_1 hold48 (.A(\settle[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net48));
 sky130_fd_sc_hd__dlygate4sd3_1 hold49 (.A(\acc[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__dlygate4sd3_1 hold50 (.A(\acc[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold51 (.A(\acc[1] ),
    ...
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__dlygate4sd3_1 hold52 (.A(\acc[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net52));
 sky130_fd_sc_hd__dlygate4sd3_1 hold53 (.A(\acc[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__dlygate4sd3_1 hold54 (.A(\acc[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input4 (.A(uio_in[2]),
    ...
    .VPWR(VPWR),
    .X(net4));
 sky130_fd_sc_hd__clkdlybuf4s25_1 input5 (.A(uio_in[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 load_slew22 (.A(net21),
    ...
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__buf_2 load_slew24 (.A(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
