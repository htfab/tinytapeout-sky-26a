module tt_um_gerardvt_spade_poc (clk,
    ena,
    rst_n,
    VPWR,
    VGND,
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _225_ (.A(net37),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_199_));
 sky130_fd_sc_hd__inv_2 _226_ (.A(\core.rhs_n4[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_200_));
 sky130_fd_sc_hd__inv_2 _227_ (.A(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_201_));
 sky130_fd_sc_hd__inv_2 _228_ (.A(\core.rhs_n4[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _229_ (.A(net6),
    ...
    .VPWR(VPWR),
    .Y(_203_));
 sky130_fd_sc_hd__inv_2 _230_ (.A(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_204_));
 sky130_fd_sc_hd__nand2b_2 _231_ (.A_N(net9),
    .B(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_205_));
 sky130_fd_sc_hd__nand2_2 _232_ (.A(net16),
    .B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_206_));
 sky130_fd_sc_hd__or2_2 _233_ (.A(\core.rhs_n4[3] ),
    .B(\core.hcount[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_207_));
 sky130_fd_sc_hd__nor2_2 _234_ (.A(net14),
    .B(\core.hcount[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_208_));
 sky130_fd_sc_hd__or2_2 _235_ (.A(net14),
    .B(\core.hcount[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_2 _236_ (.A(net15),
    ...
    .VPWR(VPWR),
    .Y(_210_));
 sky130_fd_sc_hd__or2_2 _237_ (.A(net15),
    .B(\core.hcount[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_211_));
 sky130_fd_sc_hd__nand2_2 _238_ (.A(\core.rhs_n4[0] ),
    .B(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_212_));
 sky130_fd_sc_hd__a22o_2 _239_ (.A1(\core.rhs_n4[0] ),
    .A2(net12),
    .B1(\core.hcount[1] ),
    .B2(net15),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_213_));
 sky130_fd_sc_hd__and2_2 _240_ (.A(net14),
    .B(\core.hcount[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_214_));
 sky130_fd_sc_hd__nand2_2 _241_ (.A(\core.rhs_n4[3] ),
    .B(\core.hcount[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_215_));
 sky130_fd_sc_hd__a22o_2 _242_ (.A1(net14),
    .A2(\core.hcount[2] ),
    .B1(\core.hcount[3] ),
    .B2(\core.rhs_n4[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_216_));
 sky130_fd_sc_hd__a31o_2 _243_ (.A1(_209_),
    .A2(_211_),
    .A3(_213_),
    .B1(_216_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_217_));
 sky130_fd_sc_hd__and2_2 _244_ (.A(_207_),
    .B(_217_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_218_));
 sky130_fd_sc_hd__and2_2 _245_ (.A(net13),
    .B(\core.hcount[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_219_));
 sky130_fd_sc_hd__nor2_2 _246_ (.A(net13),
    .B(\core.hcount[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_2 _247_ (.A(net13),
    ...
    .VPWR(VPWR),
    .X(_221_));
 sky130_fd_sc_hd__or3_2 _248_ (.A(net16),
    .B(_219_),
    .C(_220_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_222_));
 sky130_fd_sc_hd__o211a_2 _249_ (.A1(net16),
    .A2(_218_),
    .B1(_222_),
    .C1(net17),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_223_));
 sky130_fd_sc_hd__nor2_2 _250_ (.A(_204_),
    .B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_224_));
 sky130_fd_sc_hd__a311o_2 _251_ (.A1(net13),
    .A2(_207_),
    .A3(_217_),
    .B1(_204_),
    .C1(net17),
    ...
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__o21ba_2 _252_ (.A1(net13),
    .A2(_218_),
    .B1_N(_028_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__a2111oi_2 _253_ (.A1(net17),
    .A2(_218_),
    .B1(_219_),
    .C1(_220_),
    .D1(net16),
    ...
    .VPWR(VPWR),
    .Y(_030_));
 sky130_fd_sc_hd__o32a_2 _254_ (.A1(_223_),
    .A2(_029_),
    .A3(_030_),
    .B1(_218_),
    .B2(_206_),
    ...
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__xnor2_2 _255_ (.A(\core.frame_ctr[4] ),
    .B(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_032_));
 sky130_fd_sc_hd__xnor2_2 _256_ (.A(_031_),
    .B(_032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_033_));
 sky130_fd_sc_hd__or2_2 _257_ (.A(_205_),
    .B(_033_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__nand2b_2 _258_ (.A_N(net8),
    .B(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_035_));
 sky130_fd_sc_hd__and3_2 _259_ (.A(net18),
    .B(_211_),
    .C(_213_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_036_));
 sky130_fd_sc_hd__or3_2 _260_ (.A(net4),
    .B(_208_),
    .C(_214_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_037_));
 sky130_fd_sc_hd__and2b_2 _261_ (.A_N(net4),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_038_));
 sky130_fd_sc_hd__xnor2_2 _262_ (.A(_036_),
    .B(_037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_039_));
 sky130_fd_sc_hd__nand3_2 _263_ (.A(net14),
    .B(_211_),
    .C(_213_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_040_));
 sky130_fd_sc_hd__a21o_2 _264_ (.A1(_211_),
    .A2(_213_),
    .B1(\core.rhs_n4[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_041_));
 sky130_fd_sc_hd__a31o_2 _265_ (.A1(_224_),
    .A2(_040_),
    .A3(_041_),
    .B1(_039_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_042_));
 sky130_fd_sc_hd__xnor2_2 _266_ (.A(\core.frame_ctr[2] ),
    .B(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_043_));
 sky130_fd_sc_hd__xnor2_2 _267_ (.A(_042_),
    .B(_043_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_044_));
 sky130_fd_sc_hd__and4_2 _268_ (.A(\core.timing[12] ),
    .B(\core.rhs_n4[7] ),
    .C(\core.rhs_n4[6] ),
    .D(\core.rhs_n4[5] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__and2_2 _269_ (.A(\core.hcount[8] ),
    .B(\core.hcount[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_046_));
 sky130_fd_sc_hd__a2111oi_4 _270_ (.A1(\core.hcount[7] ),
    .A2(\core.hcount[9] ),
    .B1(_045_),
    .C1(_046_),
    .D1(\core.timing[13] ),
    ...
    .VPWR(VPWR),
    .Y(_047_));
 sky130_fd_sc_hd__nand2_2 _271_ (.A(net8),
    .B(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_048_));
 sky130_fd_sc_hd__a22o_2 _272_ (.A1(net12),
    .A2(_204_),
    .B1(_206_),
    .B2(\core.rhs_n4[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_049_));
 sky130_fd_sc_hd__o21ai_2 _273_ (.A1(net4),
    .A2(_212_),
    .B1(_049_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_050_));
 sky130_fd_sc_hd__xor2_2 _274_ (.A(\core.frame_ctr[0] ),
    .B(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_051_));
 sky130_fd_sc_hd__xnor2_2 _275_ (.A(_050_),
    .B(_051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_052_));
 sky130_fd_sc_hd__inv_2 _276_ (.A(_052_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_053_));
 sky130_fd_sc_hd__o221a_2 _277_ (.A1(_035_),
    .A2(_044_),
    .B1(_048_),
    .B2(_052_),
    .C1(net11),
    ...
    .VPWR(VPWR),
    .X(_054_));
 sky130_fd_sc_hd__or2_2 _278_ (.A(net8),
    .B(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_055_));
 sky130_fd_sc_hd__xor2_2 _279_ (.A(\core.frame_ctr[6] ),
    .B(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_056_));
 sky130_fd_sc_hd__xor2_2 _280_ (.A(\core.rhs_n4[5] ),
    .B(\core.hcount[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_057_));
 sky130_fd_sc_hd__and3b_2 _281_ (.A_N(_219_),
    .B(_221_),
    .C(_057_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_058_));
 sky130_fd_sc_hd__and3_2 _282_ (.A(_207_),
    .B(_217_),
    .C(_058_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_059_));
 sky130_fd_sc_hd__o21a_2 _283_ (.A1(\core.rhs_n4[5] ),
    .A2(\core.hcount[5] ),
    .B1(_219_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_060_));
 sky130_fd_sc_hd__a21o_2 _284_ (.A1(\core.rhs_n4[5] ),
    .A2(\core.hcount[5] ),
    .B1(_060_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_061_));
 sky130_fd_sc_hd__nor2_2 _285_ (.A(_059_),
    .B(_061_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_062_));
 sky130_fd_sc_hd__and2_2 _286_ (.A(\core.rhs_n4[6] ),
    .B(\core.hcount[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_063_));
 sky130_fd_sc_hd__or2_2 _287_ (.A(\core.rhs_n4[6] ),
    .B(\core.hcount[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_064_));
 sky130_fd_sc_hd__nor3b_2 _288_ (.A(net16),
    .B(_063_),
    .C_N(_064_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_065_));
 sky130_fd_sc_hd__o21ba_2 _289_ (.A1(\core.rhs_n4[6] ),
    .A2(_204_),
    .B1_N(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_066_));
 sky130_fd_sc_hd__mux2_1 _290_ (.A0(_066_),
    .A1(net17),
    .S(_065_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_067_));
 sky130_fd_sc_hd__a21oi_2 _291_ (.A1(\core.rhs_n4[6] ),
    .A2(_224_),
    .B1(_065_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_068_));
 sky130_fd_sc_hd__mux2_1 _292_ (.A0(_067_),
    .A1(_068_),
    .S(_062_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_069_));
 sky130_fd_sc_hd__xnor2_2 _293_ (.A(_056_),
    .B(_069_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_070_));
 sky130_fd_sc_hd__o211a_2 _294_ (.A1(_055_),
    .A2(_070_),
    .B1(_034_),
    .C1(_054_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(\core._e_2848 ));
 sky130_fd_sc_hd__and3b_2 _295_ (.A_N(_033_),
    .B(_035_),
    .C(_205_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_071_));
 sky130_fd_sc_hd__a2bb2o_2 _296_ (.A1_N(_205_),
    .A2_N(_044_),
    .B1(_053_),
    .B2(net9),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_072_));
 sky130_fd_sc_hd__o21ai_2 _297_ (.A1(_071_),
    .A2(_072_),
    .B1(_048_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_073_));
 sky130_fd_sc_hd__o211a_2 _298_ (.A1(_048_),
    .A2(_070_),
    .B1(_073_),
    .C1(net11),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(\core._e_2888 ));
 sky130_fd_sc_hd__o31a_2 _299_ (.A1(_059_),
    .A2(_061_),
    .A3(_063_),
    .B1(_064_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_074_));
 sky130_fd_sc_hd__nand2_2 _300_ (.A(\core.rhs_n4[7] ),
    .B(_074_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_075_));
 sky130_fd_sc_hd__o21a_2 _301_ (.A1(\core.rhs_n4[7] ),
    .A2(_074_),
    .B1(_224_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_076_));
 sky130_fd_sc_hd__a21oi_2 _302_ (.A1(\core.rhs_n4[7] ),
    .A2(\core.hcount[7] ),
    .B1(net16),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_077_));
 sky130_fd_sc_hd__o21ai_2 _303_ (.A1(\core.rhs_n4[7] ),
    .A2(\core.hcount[7] ),
    .B1(_077_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_078_));
 sky130_fd_sc_hd__a21oi_2 _304_ (.A1(net17),
    .A2(_074_),
    .B1(_078_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_079_));
 sky130_fd_sc_hd__o211a_2 _305_ (.A1(net16),
    .A2(_074_),
    .B1(_078_),
    .C1(net17),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_080_));
 sky130_fd_sc_hd__a211o_2 _306_ (.A1(_075_),
    .A2(_076_),
    .B1(_079_),
    .C1(_080_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_081_));
 sky130_fd_sc_hd__or2_2 _307_ (.A(_206_),
    .B(_074_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_082_));
 sky130_fd_sc_hd__xnor2_2 _308_ (.A(\core.frame_ctr[7] ),
    .B(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_083_));
 sky130_fd_sc_hd__nand3_2 _309_ (.A(_081_),
    .B(_082_),
    .C(_083_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_084_));
 sky130_fd_sc_hd__a21o_2 _310_ (.A1(_081_),
    .A2(_082_),
    .B1(_083_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_085_));
 sky130_fd_sc_hd__nand2_2 _311_ (.A(_084_),
    .B(_085_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_086_));
 sky130_fd_sc_hd__a31o_2 _312_ (.A1(_209_),
    .A2(_211_),
    .A3(_213_),
    .B1(_214_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_087_));
 sky130_fd_sc_hd__o21ai_2 _313_ (.A1(_200_),
    .A2(net18),
    .B1(_087_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_088_));
 sky130_fd_sc_hd__o31a_2 _314_ (.A1(_200_),
    .A2(net18),
    .A3(_087_),
    .B1(net4),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_089_));
 sky130_fd_sc_hd__a22o_2 _315_ (.A1(_207_),
    .A2(_215_),
    .B1(_038_),
    .B2(_087_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_090_));
 sky130_fd_sc_hd__nand4_2 _316_ (.A(_207_),
    .B(_215_),
    .C(_038_),
    .D(_087_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_091_));
 sky130_fd_sc_hd__nand2_2 _317_ (.A(_090_),
    .B(_091_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_092_));
 sky130_fd_sc_hd__a22o_2 _318_ (.A1(_088_),
    .A2(_089_),
    .B1(_092_),
    .B2(_204_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_093_));
 sky130_fd_sc_hd__xnor2_2 _319_ (.A(\core.frame_ctr[3] ),
    .B(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_094_));
 sky130_fd_sc_hd__xnor2_2 _320_ (.A(_093_),
    .B(_094_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_095_));
 sky130_fd_sc_hd__and3_2 _321_ (.A(\core.rhs_n4[0] ),
    .B(\core.hcount[0] ),
    .C(_038_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_096_));
 sky130_fd_sc_hd__nand2_2 _322_ (.A(_210_),
    .B(_211_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_097_));
 sky130_fd_sc_hd__and2b_2 _323_ (.A_N(net18),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_098_));
 sky130_fd_sc_hd__nor2_2 _324_ (.A(_212_),
    .B(_098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_099_));
 sky130_fd_sc_hd__a21o_2 _325_ (.A1(_212_),
    .A2(_098_),
    .B1(_204_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_100_));
 sky130_fd_sc_hd__xor2_2 _326_ (.A(_096_),
    .B(_097_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_101_));
 sky130_fd_sc_hd__a2bb2o_2 _327_ (.A1_N(_099_),
    .A2_N(_100_),
    .B1(_101_),
    .B2(_204_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_102_));
 sky130_fd_sc_hd__xor2_2 _328_ (.A(\core.frame_ctr[1] ),
    .B(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_103_));
 sky130_fd_sc_hd__xnor2_2 _329_ (.A(_102_),
    .B(_103_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_104_));
 sky130_fd_sc_hd__nor2_2 _330_ (.A(_205_),
    .B(_104_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_105_));
 sky130_fd_sc_hd__a31o_2 _331_ (.A1(_205_),
    .A2(_035_),
    .A3(_095_),
    .B1(_105_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_106_));
 sky130_fd_sc_hd__a31o_2 _332_ (.A1(net9),
    .A2(_084_),
    .A3(_085_),
    .B1(_106_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_107_));
 sky130_fd_sc_hd__o21a_2 _333_ (.A1(_218_),
    .A2(_219_),
    .B1(_221_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_108_));
 sky130_fd_sc_hd__and2b_2 _334_ (.A_N(net17),
    .B(\core.rhs_n4[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_109_));
 sky130_fd_sc_hd__xnor2_2 _335_ (.A(_108_),
    .B(_109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_110_));
 sky130_fd_sc_hd__o211a_2 _336_ (.A1(_218_),
    .A2(_219_),
    .B1(_221_),
    .C1(_038_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_111_));
 sky130_fd_sc_hd__nor2_2 _337_ (.A(net16),
    .B(_057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_112_));
 sky130_fd_sc_hd__mux2_1 _338_ (.A0(_112_),
    .A1(_057_),
    .S(_111_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_113_));
 sky130_fd_sc_hd__a21o_2 _339_ (.A1(net16),
    .A2(_110_),
    .B1(_113_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_114_));
 sky130_fd_sc_hd__xor2_2 _340_ (.A(\core.frame_ctr[5] ),
    .B(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_115_));
 sky130_fd_sc_hd__xnor2_2 _341_ (.A(_114_),
    .B(_115_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_116_));
 sky130_fd_sc_hd__o21ai_2 _342_ (.A1(_048_),
    .A2(_116_),
    .B1(_047_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_117_));
 sky130_fd_sc_hd__a21oi_2 _343_ (.A1(_048_),
    .A2(_107_),
    .B1(_117_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(\core._e_2908 ));
 sky130_fd_sc_hd__nand2b_2 _344_ (.A_N(_205_),
    .B(_095_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_118_));
 sky130_fd_sc_hd__o211a_2 _345_ (.A1(_035_),
    .A2(_104_),
    .B1(_118_),
    .C1(net11),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_119_));
 sky130_fd_sc_hd__or2_2 _346_ (.A(_055_),
    .B(_116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_120_));
 sky130_fd_sc_hd__o211a_2 _347_ (.A1(_048_),
    .A2(_086_),
    .B1(_119_),
    .C1(_120_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(\core._e_2868 ));
 sky130_fd_sc_hd__or2_2 _348_ (.A(_033_),
    .B(_048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_121_));
 sky130_fd_sc_hd__o221a_2 _349_ (.A1(_205_),
    .A2(_052_),
    .B1(_055_),
    .B2(_044_),
    .C1(net11),
    ...
    .VPWR(VPWR),
    .X(_122_));
 sky130_fd_sc_hd__o211a_2 _350_ (.A1(_035_),
    .A2(_070_),
    .B1(_121_),
    .C1(_122_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(\core._e_2928 ));
 sky130_fd_sc_hd__nand2b_2 _351_ (.A_N(_035_),
    .B(_095_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_123_));
 sky130_fd_sc_hd__o221a_2 _352_ (.A1(_048_),
    .A2(_104_),
    .B1(_116_),
    .B2(_205_),
    .C1(_123_),
    ...
    .VPWR(VPWR),
    .X(_124_));
 sky130_fd_sc_hd__o211a_2 _353_ (.A1(_055_),
    .A2(_086_),
    .B1(_124_),
    .C1(_047_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(\core._e_2828 ));
 sky130_fd_sc_hd__and3_2 _354_ (.A(\core.hcount[4] ),
    .B(\core.hcount[5] ),
    .C(\core.hcount[6] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_125_));
 sky130_fd_sc_hd__or2_2 _355_ (.A(\core.hcount[5] ),
    .B(\core.hcount[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_126_));
 sky130_fd_sc_hd__and4bb_2 _356_ (.A_N(\core.hcount[8] ),
    .B_N(_125_),
    .C(\core.hcount[9] ),
    .D(\core.hcount[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_127_));
 sky130_fd_sc_hd__o21ai_2 _357_ (.A1(\core.hcount[4] ),
    .A2(_126_),
    .B1(_127_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(\core.hsync ));
 sky130_fd_sc_hd__or3b_2 _358_ (.A(_200_),
    .B(net14),
    .C_N(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_128_));
 sky130_fd_sc_hd__or4b_2 _359_ (.A(\core.timing[13] ),
    .B(_128_),
    .C(net13),
    .D_N(_045_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(\core.timing[1] ));
 sky130_fd_sc_hd__nand3_2 _360_ (.A(net12),
    .B(\core.hcount[1] ),
    .C(\core.hcount[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_129_));
 sky130_fd_sc_hd__and4_2 _361_ (.A(net12),
    .B(\core.hcount[1] ),
    .C(\core.hcount[2] ),
    .D(\core.hcount[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_130_));
 sky130_fd_sc_hd__and2_2 _362_ (.A(\core.hcount[4] ),
    .B(_130_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_131_));
 sky130_fd_sc_hd__or4bb_2 _363_ (.A(_126_),
    .B(\core.hcount[7] ),
    .C_N(_046_),
    .D_N(_131_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_132_));
 sky130_fd_sc_hd__or4_2 _364_ (.A(_200_),
    .B(_201_),
    .C(net15),
    .D(\core.rhs_n4[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_133_));
 sky130_fd_sc_hd__or4_2 _365_ (.A(\core.rhs_n4[7] ),
    .B(\core.rhs_n4[6] ),
    .C(\core.rhs_n4[5] ),
    .D(net13),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_134_));
 sky130_fd_sc_hd__or4b_2 _366_ (.A(\core.timing[12] ),
    .B(_133_),
    .C(_134_),
    .D_N(\core.timing[13] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_135_));
 sky130_fd_sc_hd__or4_2 _367_ (.A(\core.rhs_n4[5] ),
    .B(\core.rhs_n4[4] ),
    .C(net15),
    .D(\core.rhs_n4[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_136_));
 sky130_fd_sc_hd__or4b_2 _368_ (.A(\core.timing[12] ),
    .B(\core.rhs_n4[7] ),
    .C(\core.rhs_n4[6] ),
    .D_N(\core.timing[13] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_137_));
 sky130_fd_sc_hd__or4_2 _369_ (.A(_200_),
    .B(_201_),
    .C(_136_),
    .D(_137_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_138_));
 sky130_fd_sc_hd__or3_2 _370_ (.A(net2),
    .B(_132_),
    .C(_138_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_139_));
 sky130_fd_sc_hd__inv_2 _371_ (.A(_139_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_140_));
 sky130_fd_sc_hd__or3_2 _372_ (.A(net5),
    .B(net6),
    .C(_139_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_141_));
 sky130_fd_sc_hd__xnor2_2 _373_ (.A(\core.frame_ctr[0] ),
    .B(_141_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_142_));
 sky130_fd_sc_hd__and2_2 _374_ (.A(net20),
    .B(_142_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_000_));
 sky130_fd_sc_hd__or2_2 _375_ (.A(\core.frame_ctr[0] ),
    .B(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_143_));
 sky130_fd_sc_hd__a31o_2 _376_ (.A1(_203_),
    .A2(_140_),
    .A3(_143_),
    .B1(\core.frame_ctr[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_144_));
 sky130_fd_sc_hd__nand2_2 _377_ (.A(\core.frame_ctr[1] ),
    .B(_143_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_145_));
 sky130_fd_sc_hd__or2_2 _378_ (.A(net6),
    .B(_145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_146_));
 sky130_fd_sc_hd__o211a_2 _379_ (.A1(_139_),
    .A2(_146_),
    .B1(_144_),
    .C1(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__nand2_2 _380_ (.A(_203_),
    .B(_145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_147_));
 sky130_fd_sc_hd__or2_2 _381_ (.A(net5),
    .B(_203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_148_));
 sky130_fd_sc_hd__xnor2_2 _382_ (.A(\core.frame_ctr[2] ),
    .B(_148_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_149_));
 sky130_fd_sc_hd__xnor2_2 _383_ (.A(_146_),
    .B(_149_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_150_));
 sky130_fd_sc_hd__or2_2 _384_ (.A(_139_),
    .B(_150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_151_));
 sky130_fd_sc_hd__o211a_2 _385_ (.A1(\core.frame_ctr[2] ),
    .A2(_140_),
    .B1(_151_),
    .C1(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_002_));
 sky130_fd_sc_hd__a22oi_2 _386_ (.A1(net5),
    .A2(net6),
    .B1(_147_),
    .B2(\core.frame_ctr[2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_152_));
 sky130_fd_sc_hd__nor4_2 _387_ (.A(net2),
    .B(_132_),
    .C(_135_),
    .D(_152_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_153_));
 sky130_fd_sc_hd__or2_2 _388_ (.A(\core.frame_ctr[3] ),
    .B(_153_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_154_));
 sky130_fd_sc_hd__and2_2 _389_ (.A(\core.frame_ctr[3] ),
    .B(_153_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_155_));
 sky130_fd_sc_hd__and3b_2 _390_ (.A_N(_155_),
    .B(net19),
    .C(_154_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__or2_2 _391_ (.A(\core.frame_ctr[4] ),
    .B(_155_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_156_));
 sky130_fd_sc_hd__and3_2 _392_ (.A(\core.frame_ctr[4] ),
    .B(\core.frame_ctr[3] ),
    .C(_153_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_157_));
 sky130_fd_sc_hd__and3b_2 _393_ (.A_N(_157_),
    .B(net19),
    .C(_156_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_004_));
 sky130_fd_sc_hd__or2_2 _394_ (.A(\core.frame_ctr[5] ),
    .B(_157_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_158_));
 sky130_fd_sc_hd__and2_2 _395_ (.A(\core.frame_ctr[5] ),
    .B(_157_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_159_));
 sky130_fd_sc_hd__and3b_2 _396_ (.A_N(_159_),
    .B(net19),
    .C(_158_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_005_));
 sky130_fd_sc_hd__or2_2 _397_ (.A(\core.frame_ctr[6] ),
    .B(_159_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_160_));
 sky130_fd_sc_hd__and3_2 _398_ (.A(\core.frame_ctr[6] ),
    .B(\core.frame_ctr[5] ),
    .C(_157_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_161_));
 sky130_fd_sc_hd__and3b_2 _399_ (.A_N(_161_),
    .B(net19),
    .C(_160_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__a21boi_2 _400_ (.A1(net43),
    .A2(_161_),
    .B1_N(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_162_));
 sky130_fd_sc_hd__o21a_2 _401_ (.A1(net43),
    .A2(_161_),
    .B1(_162_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_007_));
 sky130_fd_sc_hd__and2b_2 _402_ (.A_N(_132_),
    .B(_138_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_163_));
 sky130_fd_sc_hd__nor2_2 _403_ (.A(_202_),
    .B(_132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_164_));
 sky130_fd_sc_hd__inv_2 _404_ (.A(_164_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_165_));
 sky130_fd_sc_hd__o211a_2 _405_ (.A1(\core.rhs_n4[0] ),
    .A2(_163_),
    .B1(_165_),
    .C1(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_008_));
 sky130_fd_sc_hd__a21boi_2 _406_ (.A1(net15),
    .A2(_164_),
    .B1_N(net20),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_166_));
 sky130_fd_sc_hd__o21a_2 _407_ (.A1(net36),
    .A2(_164_),
    .B1(_166_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_2 _409_ (.A(net20),
    ...
    .VPWR(VPWR),
    .X(_168_));
 sky130_fd_sc_hd__a21o_2 _410_ (.A1(net15),
    .A2(\core.rhs_n4[0] ),
    .B1(net14),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_169_));
 sky130_fd_sc_hd__nand3_2 _411_ (.A(net14),
    .B(net15),
    .C(\core.rhs_n4[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_170_));
 sky130_fd_sc_hd__a32o_2 _412_ (.A1(_168_),
    .A2(_169_),
    .A3(_170_),
    .B1(net10),
    .B2(net14),
    ...
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__nand2_2 _413_ (.A(_200_),
    .B(_170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_171_));
 sky130_fd_sc_hd__nor2_2 _414_ (.A(_200_),
    .B(_170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_172_));
 sky130_fd_sc_hd__or2_2 _415_ (.A(_200_),
    .B(_170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_173_));
 sky130_fd_sc_hd__a32o_2 _416_ (.A1(_168_),
    .A2(_171_),
    .A3(_173_),
    .B1(net10),
    .B2(net42),
    ...
    .VPWR(VPWR),
    .X(_011_));
 sky130_fd_sc_hd__nor2_2 _417_ (.A(_132_),
    .B(_173_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_174_));
 sky130_fd_sc_hd__or2_2 _418_ (.A(net13),
    .B(_174_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_175_));
 sky130_fd_sc_hd__and2_2 _419_ (.A(net13),
    .B(_174_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_176_));
 sky130_fd_sc_hd__and3b_2 _420_ (.A_N(_176_),
    .B(net19),
    .C(_175_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__or2_2 _421_ (.A(\core.rhs_n4[5] ),
    .B(_176_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_177_));
 sky130_fd_sc_hd__and3_2 _422_ (.A(\core.rhs_n4[5] ),
    .B(net13),
    .C(_174_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_178_));
 sky130_fd_sc_hd__and3b_2 _423_ (.A_N(_178_),
    .B(net19),
    .C(_177_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__or2_2 _424_ (.A(\core.rhs_n4[6] ),
    .B(_178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_179_));
 sky130_fd_sc_hd__and2_2 _425_ (.A(\core.rhs_n4[6] ),
    .B(_178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_180_));
 sky130_fd_sc_hd__and3b_2 _426_ (.A_N(_180_),
    .B(net19),
    .C(_179_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_014_));
 sky130_fd_sc_hd__or2_2 _427_ (.A(\core.rhs_n4[7] ),
    .B(_180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_181_));
 sky130_fd_sc_hd__nand2_2 _428_ (.A(\core.rhs_n4[7] ),
    .B(_180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_182_));
 sky130_fd_sc_hd__and3_2 _429_ (.A(net19),
    .B(_181_),
    .C(_182_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_015_));
 sky130_fd_sc_hd__a21bo_2 _430_ (.A1(_045_),
    .A2(_176_),
    .B1_N(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_183_));
 sky130_fd_sc_hd__a21oi_2 _431_ (.A1(_199_),
    .A2(_182_),
    .B1(_183_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_016_));
 sky130_fd_sc_hd__a31o_2 _432_ (.A1(\core.rhs_n4[4] ),
    .A2(_045_),
    .A3(_172_),
    .B1(\core.timing[13] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_184_));
 sky130_fd_sc_hd__nand4_2 _433_ (.A(\core.timing[13] ),
    .B(\core.rhs_n4[4] ),
    .C(_045_),
    .D(_172_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_185_));
 sky130_fd_sc_hd__a32o_2 _434_ (.A1(_168_),
    .A2(_184_),
    .A3(_185_),
    .B1(net10),
    .B2(net45),
    ...
    .VPWR(VPWR),
    .X(_017_));
 sky130_fd_sc_hd__and2b_2 _435_ (.A_N(net12),
    .B(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_018_));
 sky130_fd_sc_hd__o21ai_2 _436_ (.A1(net12),
    .A2(\core.hcount[1] ),
    .B1(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_186_));
 sky130_fd_sc_hd__a21oi_2 _437_ (.A1(net12),
    .A2(net44),
    .B1(_186_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_019_));
 sky130_fd_sc_hd__a21o_2 _438_ (.A1(net12),
    .A2(\core.hcount[1] ),
    .B1(\core.hcount[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_187_));
 sky130_fd_sc_hd__and3_2 _439_ (.A(_129_),
    .B(_167_),
    .C(_187_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_020_));
 sky130_fd_sc_hd__a31o_2 _440_ (.A1(net12),
    .A2(\core.hcount[1] ),
    .A3(\core.hcount[2] ),
    .B1(\core.hcount[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_188_));
 sky130_fd_sc_hd__and3b_2 _441_ (.A_N(_130_),
    .B(_188_),
    .C(net20),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_021_));
 sky130_fd_sc_hd__o21ai_2 _442_ (.A1(\core.hcount[4] ),
    .A2(_130_),
    .B1(net20),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_189_));
 sky130_fd_sc_hd__nor2_2 _443_ (.A(_131_),
    .B(_189_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_022_));
 sky130_fd_sc_hd__and3_2 _444_ (.A(\core.hcount[4] ),
    .B(\core.hcount[5] ),
    .C(_130_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_190_));
 sky130_fd_sc_hd__o21ai_2 _445_ (.A1(\core.hcount[5] ),
    .A2(_131_),
    .B1(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_191_));
 sky130_fd_sc_hd__nor2_2 _446_ (.A(_190_),
    .B(_191_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_023_));
 sky130_fd_sc_hd__and2_2 _447_ (.A(_125_),
    .B(_130_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_192_));
 sky130_fd_sc_hd__o21ai_2 _448_ (.A1(net41),
    .A2(_190_),
    .B1(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_193_));
 sky130_fd_sc_hd__nor2_2 _449_ (.A(_192_),
    .B(_193_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_024_));
 sky130_fd_sc_hd__and3_2 _450_ (.A(\core.hcount[7] ),
    .B(_125_),
    .C(_130_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_194_));
 sky130_fd_sc_hd__o21ai_2 _451_ (.A1(\core.hcount[7] ),
    .A2(_192_),
    .B1(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_195_));
 sky130_fd_sc_hd__nor2_2 _452_ (.A(_194_),
    .B(_195_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_025_));
 sky130_fd_sc_hd__and2_2 _453_ (.A(\core.hcount[8] ),
    .B(_194_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_196_));
 sky130_fd_sc_hd__o21ai_2 _454_ (.A1(net40),
    .A2(_194_),
    .B1(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_197_));
 sky130_fd_sc_hd__nor2_2 _455_ (.A(_196_),
    .B(_197_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_026_));
 sky130_fd_sc_hd__o21ai_2 _456_ (.A1(net39),
    .A2(_196_),
    .B1(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_198_));
 sky130_fd_sc_hd__a21oi_2 _457_ (.A1(net39),
    .A2(_196_),
    .B1(_198_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_027_));
 sky130_fd_sc_hd__dfxtp_2 _458_ (.CLK(clknet_2_3__leaf_clk),
    .D(_000_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.frame_ctr[0] ));
 sky130_fd_sc_hd__dfxtp_2 _459_ (.CLK(clknet_2_3__leaf_clk),
    .D(_001_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.frame_ctr[1] ));
 sky130_fd_sc_hd__dfxtp_2 _460_ (.CLK(clknet_2_3__leaf_clk),
    .D(_002_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.frame_ctr[2] ));
 sky130_fd_sc_hd__dfxtp_2 _461_ (.CLK(clknet_2_1__leaf_clk),
    .D(_003_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.frame_ctr[3] ));
 sky130_fd_sc_hd__dfxtp_2 _462_ (.CLK(clknet_2_1__leaf_clk),
    .D(_004_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _463_ (.CLK(clknet_2_1__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\core.frame_ctr[5] ));
 sky130_fd_sc_hd__dfxtp_2 _464_ (.CLK(clknet_2_1__leaf_clk),
    .D(_006_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.frame_ctr[6] ));
 sky130_fd_sc_hd__dfxtp_2 _465_ (.CLK(clknet_2_1__leaf_clk),
    .D(_007_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.frame_ctr[7] ));
 sky130_fd_sc_hd__dfxtp_2 _466_ (.CLK(clknet_2_2__leaf_clk),
    .D(_008_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _469_ (.CLK(clknet_2_2__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\core.rhs_n4[3] ));
 sky130_fd_sc_hd__dfxtp_2 _470_ (.CLK(clknet_2_0__leaf_clk),
    .D(_012_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.rhs_n4[4] ));
 sky130_fd_sc_hd__dfxtp_2 _471_ (.CLK(clknet_2_0__leaf_clk),
    .D(_013_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _473_ (.CLK(clknet_2_1__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\core.rhs_n4[7] ));
 sky130_fd_sc_hd__dfxtp_2 _474_ (.CLK(clknet_2_0__leaf_clk),
    .D(net38),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.timing[12] ));
 sky130_fd_sc_hd__dfxtp_2 _475_ (.CLK(clknet_2_2__leaf_clk),
    .D(_017_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.timing[13] ));
 sky130_fd_sc_hd__dfxtp_2 _476_ (.CLK(clknet_2_3__leaf_clk),
    .D(_018_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.hcount[0] ));
 sky130_fd_sc_hd__dfxtp_2 _477_ (.CLK(clknet_2_3__leaf_clk),
    .D(_019_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.hcount[1] ));
 sky130_fd_sc_hd__dfxtp_2 _478_ (.CLK(clknet_2_3__leaf_clk),
    .D(_020_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.hcount[2] ));
 sky130_fd_sc_hd__dfxtp_2 _479_ (.CLK(clknet_2_2__leaf_clk),
    .D(_021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.hcount[3] ));
 sky130_fd_sc_hd__dfxtp_2 _480_ (.CLK(clknet_2_2__leaf_clk),
    .D(_022_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.hcount[4] ));
 sky130_fd_sc_hd__dfxtp_2 _481_ (.CLK(clknet_2_2__leaf_clk),
    .D(_023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _482_ (.CLK(clknet_2_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\core.hcount[6] ));
 sky130_fd_sc_hd__dfxtp_2 _483_ (.CLK(clknet_2_0__leaf_clk),
    .D(_025_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.hcount[7] ));
 sky130_fd_sc_hd__dfxtp_2 _484_ (.CLK(clknet_2_0__leaf_clk),
    .D(_026_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.hcount[8] ));
 sky130_fd_sc_hd__dfxtp_2 _485_ (.CLK(clknet_2_0__leaf_clk),
    .D(_027_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\core.hcount[9] ));
 sky130_fd_sc_hd__buf_2 _502_ (.A(\core._e_2848 ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[0]));
 sky130_fd_sc_hd__buf_2 _503_ (.A(\core._e_2888 ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[1]));
 sky130_fd_sc_hd__buf_2 _504_ (.A(\core._e_2928 ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[2]));
 sky130_fd_sc_hd__buf_2 _505_ (.A(\core.timing[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[3]));
 sky130_fd_sc_hd__buf_2 _506_ (.A(\core._e_2828 ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[4]));
 sky130_fd_sc_hd__buf_2 _507_ (.A(\core._e_2868 ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[5]));
 sky130_fd_sc_hd__buf_2 _508_ (.A(\core._e_2908 ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[6]));
 sky130_fd_sc_hd__buf_2 _509_ (.A(\core.hsync ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout10 (.A(_167_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout12 (.A(\core.hcount[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net12));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout13 (.A(\core.rhs_n4[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout14 (.A(\core.rhs_n4[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout15 (.A(\core.rhs_n4[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout16 (.A(net4),
    ...
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout17 (.A(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout18 (.A(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__dlygate4sd3_1 hold36 (.A(\core.rhs_n4[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net36));
 sky130_fd_sc_hd__dlygate4sd3_1 hold37 (.A(\core.timing[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net37));
 sky130_fd_sc_hd__dlygate4sd3_1 hold38 (.A(_016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net38));
 sky130_fd_sc_hd__dlygate4sd3_1 hold39 (.A(\core.hcount[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__dlygate4sd3_1 hold40 (.A(\core.hcount[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__dlygate4sd3_1 hold41 (.A(\core.hcount[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net41));
 sky130_fd_sc_hd__dlygate4sd3_1 hold42 (.A(\core.rhs_n4[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net42));
 sky130_fd_sc_hd__dlygate4sd3_1 hold43 (.A(\core.frame_ctr[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__dlygate4sd3_1 hold44 (.A(\core.hcount[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__dlygate4sd3_1 hold45 (.A(\core.timing[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input9 (.A(ui_in[7]),
    ...
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__buf_1 max_cap11 (.A(_047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net11));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_spade_poc (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_spade_poc_21 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net21));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_spade_poc_22 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net22));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_spade_poc_23 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net23));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_spade_poc_24 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net24));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_spade_poc_25 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net25));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_spade_poc_26 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net26));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_spade_poc_27 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net27));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_spade_poc_28 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net28));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_spade_poc_29 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net29));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_spade_poc_30 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net30));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_spade_poc_31 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net31));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_spade_poc_32 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net32));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_spade_poc_33 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net33));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_spade_poc_34 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net34));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_spade_poc_35 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net35));
