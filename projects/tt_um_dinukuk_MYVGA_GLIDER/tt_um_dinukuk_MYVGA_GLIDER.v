module tt_um_dinukuk_MYVGA_GLIDER (clk,
    ena,
    rst_n,
    VPWR,
    VGND,
 ...
 sky130_fd_sc_hd__inv_2 _261_ (.A(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_225_));
 sky130_fd_sc_hd__inv_2 _262_ (.A(\cy[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _263_ (.A(net3),
    ...
    .VPWR(VPWR),
    .Y(_227_));
 sky130_fd_sc_hd__o21ai_2 _264_ (.A1(\hpos[8] ),
    .A2(net8),
    .B1(\hpos[9] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_228_));
 sky130_fd_sc_hd__or2_2 _265_ (.A(\abs_x[0] ),
    .B(\cx[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_229_));
 sky130_fd_sc_hd__or3_2 _266_ (.A(\abs_x[0] ),
    .B(\cx[1] ),
    .C(\cx[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_230_));
 sky130_fd_sc_hd__or4_2 _267_ (.A(\abs_x[0] ),
    .B(\cx[1] ),
    .C(\cx[2] ),
    .D(\cx[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_231_));
 sky130_fd_sc_hd__nand2_2 _268_ (.A(net7),
    .B(_231_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_232_));
 sky130_fd_sc_hd__xor2_2 _269_ (.A(\cx[4] ),
    .B(_232_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_233_));
 sky130_fd_sc_hd__o21a_2 _270_ (.A1(\cx[4] ),
    .A2(_231_),
    .B1(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_234_));
 sky130_fd_sc_hd__xnor2_2 _271_ (.A(\cx[5] ),
    .B(_234_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_235_));
 sky130_fd_sc_hd__nor2_2 _272_ (.A(net11),
    .B(\hvsync_gen.vpos[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_236_));
 sky130_fd_sc_hd__and2_2 _273_ (.A(net11),
    .B(\hvsync_gen.vpos[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_237_));
 sky130_fd_sc_hd__nor2_2 _274_ (.A(_236_),
    .B(_237_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_238_));
 sky130_fd_sc_hd__or3_2 _275_ (.A(net11),
    .B(\hvsync_gen.vpos[6] ),
    .C(\hvsync_gen.vpos[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_239_));
 sky130_fd_sc_hd__o41a_2 _276_ (.A1(net11),
    ...
    .VPWR(VPWR),
    .X(_240_));
 sky130_fd_sc_hd__inv_2 _277_ (.A(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_241_));
 sky130_fd_sc_hd__nand2_2 _278_ (.A(net10),
    .B(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_242_));
 sky130_fd_sc_hd__or2_2 _279_ (.A(\abs_y[0] ),
    .B(\cy[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_243_));
 sky130_fd_sc_hd__or3_2 _280_ (.A(\abs_y[0] ),
    .B(\cy[1] ),
    .C(\cy[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_244_));
 sky130_fd_sc_hd__or4_2 _281_ (.A(\abs_y[0] ),
    .B(\cy[1] ),
    .C(\cy[3] ),
    .D(\cy[2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_245_));
 sky130_fd_sc_hd__o211a_2 _282_ (.A1(_225_),
    .A2(_245_),
    .B1(net6),
    .C1(net10),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_246_));
 sky130_fd_sc_hd__xnor2_2 _283_ (.A(_238_),
    .B(_246_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_247_));
 sky130_fd_sc_hd__inv_2 _284_ (.A(_247_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_248_));
 sky130_fd_sc_hd__and3_2 _285_ (.A(net10),
    .B(net6),
    .C(_245_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_249_));
 sky130_fd_sc_hd__xnor2_2 _286_ (.A(net11),
    .B(_249_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_250_));
 sky130_fd_sc_hd__xnor2_2 _287_ (.A(_225_),
    .B(_249_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_251_));
 sky130_fd_sc_hd__o22a_2 _288_ (.A1(_235_),
    .A2(_247_),
    .B1(_250_),
    .B2(_233_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_252_));
 sky130_fd_sc_hd__and3_2 _289_ (.A(\cx[2] ),
    .B(_228_),
    .C(_229_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_253_));
 sky130_fd_sc_hd__a21oi_2 _290_ (.A1(_228_),
    .A2(_229_),
    .B1(\cx[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_254_));
 sky130_fd_sc_hd__or2_2 _291_ (.A(_253_),
    .B(_254_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_255_));
 sky130_fd_sc_hd__nand4_2 _292_ (.A(net9),
    .B(\cy[2] ),
    .C(net6),
    .D(_243_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_256_));
 sky130_fd_sc_hd__a31o_2 _293_ (.A1(net9),
    .A2(net6),
    .A3(_243_),
    .B1(\cy[2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_257_));
 sky130_fd_sc_hd__nand2_2 _294_ (.A(_256_),
    .B(_257_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_258_));
 sky130_fd_sc_hd__o211a_2 _295_ (.A1(_253_),
    .A2(_254_),
    .B1(_256_),
    .C1(_257_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_259_));
 sky130_fd_sc_hd__nand2b_2 _296_ (.A_N(\abs_x[0] ),
    .B(\abs_y[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_260_));
 sky130_fd_sc_hd__nand2_2 _297_ (.A(\abs_x[0] ),
    .B(\cx[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_029_));
 sky130_fd_sc_hd__o211a_2 _298_ (.A1(\hpos[8] ),
    .A2(net8),
    .B1(\hpos[9] ),
    .C1(\cx[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__a31o_2 _299_ (.A1(_228_),
    .A2(_229_),
    .A3(_029_),
    .B1(_030_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__xor2_2 _300_ (.A(\abs_y[0] ),
    .B(\cy[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__and3_2 _301_ (.A(net9),
    .B(net6),
    .C(_032_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_033_));
 sky130_fd_sc_hd__a21boi_2 _302_ (.A1(net9),
    .A2(net6),
    .B1_N(\cy[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_034_));
 sky130_fd_sc_hd__or2_2 _303_ (.A(_033_),
    .B(_034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__o2bb2a_2 _304_ (.A1_N(_260_),
    .A2_N(_031_),
    .B1(_033_),
    .B2(_034_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_036_));
 sky130_fd_sc_hd__nor2_2 _305_ (.A(\cx[1] ),
    .B(_260_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_037_));
 sky130_fd_sc_hd__a211o_2 _306_ (.A1(_256_),
    .A2(_257_),
    .B1(_253_),
    .C1(_254_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_038_));
 sky130_fd_sc_hd__nand4_2 _307_ (.A(net9),
    .B(\cy[3] ),
    .C(net6),
    .D(_244_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_039_));
 sky130_fd_sc_hd__a31o_2 _308_ (.A1(net9),
    .A2(net6),
    .A3(_244_),
    .B1(\cy[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_040_));
 sky130_fd_sc_hd__nand2_2 _309_ (.A(_039_),
    .B(_040_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_041_));
 sky130_fd_sc_hd__and3_2 _310_ (.A(\cx[3] ),
    .B(net7),
    .C(_230_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_042_));
 sky130_fd_sc_hd__a21oi_2 _311_ (.A1(net7),
    .A2(_230_),
    .B1(\cx[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_043_));
 sky130_fd_sc_hd__or2_2 _312_ (.A(_042_),
    .B(_043_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_044_));
 sky130_fd_sc_hd__a211o_2 _313_ (.A1(_039_),
    .A2(_040_),
    .B1(_042_),
    .C1(_043_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__o311a_2 _314_ (.A1(_259_),
    .A2(_036_),
    .A3(_037_),
    .B1(_038_),
    .C1(_045_),
    ...
    .VPWR(VPWR),
    .X(_046_));
 sky130_fd_sc_hd__nand2_2 _315_ (.A(_235_),
    .B(_247_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_047_));
 sky130_fd_sc_hd__o211a_2 _316_ (.A1(_042_),
    .A2(_043_),
    .B1(_039_),
    .C1(_040_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_048_));
 sky130_fd_sc_hd__a221o_2 _317_ (.A1(_235_),
    .A2(_247_),
    .B1(_250_),
    .B2(_233_),
    .C1(_048_),
    ...
    .VPWR(VPWR),
    .X(_049_));
 sky130_fd_sc_hd__o21ai_2 _318_ (.A1(_046_),
    .A2(_049_),
    .B1(_252_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_050_));
 sky130_fd_sc_hd__a21o_2 _319_ (.A1(\cx[5] ),
    .A2(net7),
    .B1(_234_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_051_));
 sky130_fd_sc_hd__xor2_2 _320_ (.A(\cx[6] ),
    .B(_051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_052_));
 sky130_fd_sc_hd__o311a_2 _321_ (.A1(_225_),
    ...
    .VPWR(VPWR),
    .X(_053_));
 sky130_fd_sc_hd__o21ai_2 _322_ (.A1(net11),
    .A2(\hvsync_gen.vpos[5] ),
    ...
    .VPWR(VPWR),
    .Y(_054_));
 sky130_fd_sc_hd__nand2_2 _323_ (.A(_239_),
    .B(_054_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_055_));
 sky130_fd_sc_hd__xnor2_2 _324_ (.A(_053_),
    .B(_055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_056_));
 sky130_fd_sc_hd__inv_2 _325_ (.A(_056_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_057_));
 sky130_fd_sc_hd__o32a_2 _326_ (.A1(_233_),
    .A2(_250_),
    .A3(_047_),
    .B1(_052_),
    .B2(_056_),
    ...
    .VPWR(VPWR),
    .X(_058_));
 sky130_fd_sc_hd__and3b_2 _327_ (.A_N(net8),
    .B(\hpos[9] ),
    .C(\hpos[8] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_059_));
 sky130_fd_sc_hd__or4_2 _328_ (.A(\cx[4] ),
    .B(\cx[6] ),
    .C(\cx[5] ),
    .D(_231_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_060_));
 sky130_fd_sc_hd__and3_2 _329_ (.A(net8),
    .B(net7),
    .C(_060_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_061_));
 sky130_fd_sc_hd__nor2_2 _330_ (.A(_059_),
    .B(_061_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_062_));
 sky130_fd_sc_hd__o21ai_2 _331_ (.A1(net8),
    .A2(_060_),
    .B1(_062_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_063_));
 sky130_fd_sc_hd__xor2_2 _332_ (.A(\hvsync_gen.vpos[7] ),
    .B(_239_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_064_));
 sky130_fd_sc_hd__or4_2 _333_ (.A(_225_),
    .B(\hvsync_gen.vpos[6] ),
    .C(\hvsync_gen.vpos[5] ),
    .D(_245_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_065_));
 sky130_fd_sc_hd__and3_2 _334_ (.A(net10),
    .B(_240_),
    .C(_065_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_066_));
 sky130_fd_sc_hd__xor2_2 _335_ (.A(_064_),
    .B(_066_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_067_));
 sky130_fd_sc_hd__inv_2 _336_ (.A(_067_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_068_));
 sky130_fd_sc_hd__and2_2 _337_ (.A(_052_),
    .B(_056_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_069_));
 sky130_fd_sc_hd__a221o_2 _338_ (.A1(_050_),
    .A2(_058_),
    .B1(_063_),
    .B2(_067_),
    .C1(_069_),
    ...
    .VPWR(VPWR),
    .X(_070_));
 sky130_fd_sc_hd__mux2_1 _339_ (.A0(_061_),
    .A1(_062_),
    .S(\hpos[8] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_071_));
 sky130_fd_sc_hd__or3_2 _340_ (.A(\hvsync_gen.vpos[8] ),
    .B(\hvsync_gen.vpos[7] ),
    .C(_239_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_072_));
 sky130_fd_sc_hd__or3_2 _341_ (.A(\hvsync_gen.vpos[7] ),
    .B(_242_),
    .C(_065_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_073_));
 sky130_fd_sc_hd__o211a_2 _342_ (.A1(net10),
    .A2(_241_),
    .B1(_072_),
    .C1(_073_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_074_));
 sky130_fd_sc_hd__inv_2 _343_ (.A(_074_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_075_));
 sky130_fd_sc_hd__a211oi_2 _344_ (.A1(net8),
    .A2(_060_),
    .B1(\hpos[9] ),
    .C1(\hpos[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_076_));
 sky130_fd_sc_hd__o21ai_2 _345_ (.A1(net10),
    .A2(_240_),
    .B1(_073_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_077_));
 sky130_fd_sc_hd__nor2_2 _346_ (.A(_076_),
    .B(_077_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_078_));
 sky130_fd_sc_hd__o21ba_2 _347_ (.A1(_063_),
    .A2(_067_),
    .B1_N(_078_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_079_));
 sky130_fd_sc_hd__o211ai_2 _348_ (.A1(_071_),
    .A2(_075_),
    .B1(_079_),
    .C1(_070_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_080_));
 sky130_fd_sc_hd__nand2_2 _349_ (.A(_076_),
    .B(_077_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_081_));
 sky130_fd_sc_hd__nand2_2 _350_ (.A(_071_),
    .B(_075_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_082_));
 sky130_fd_sc_hd__a21o_2 _351_ (.A1(_081_),
    .A2(_082_),
    .B1(_078_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_083_));
 sky130_fd_sc_hd__and2_2 _352_ (.A(_080_),
    .B(_083_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_084_));
 sky130_fd_sc_hd__nand2_2 _353_ (.A(_080_),
    .B(_083_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_085_));
 sky130_fd_sc_hd__mux2_1 _354_ (.A0(_233_),
    .A1(_251_),
    .S(_084_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_086_));
 sky130_fd_sc_hd__mux2_1 _355_ (.A0(_235_),
    .A1(_248_),
    .S(_085_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_087_));
 sky130_fd_sc_hd__nor2_2 _356_ (.A(_086_),
    .B(_087_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_088_));
 sky130_fd_sc_hd__nand2_2 _357_ (.A(_086_),
    .B(_087_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_089_));
 sky130_fd_sc_hd__and2b_2 _358_ (.A_N(_088_),
    .B(_089_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_090_));
 sky130_fd_sc_hd__mux2_1 _359_ (.A0(_041_),
    .A1(_044_),
    .S(_085_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_091_));
 sky130_fd_sc_hd__mux2_1 _360_ (.A0(_233_),
    .A1(_251_),
    .S(_085_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_092_));
 sky130_fd_sc_hd__nor2_2 _361_ (.A(_091_),
    .B(_092_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_093_));
 sky130_fd_sc_hd__nand2_2 _362_ (.A(_091_),
    .B(_092_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_094_));
 sky130_fd_sc_hd__mux2_1 _363_ (.A0(_255_),
    .A1(_258_),
    .S(_084_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_095_));
 sky130_fd_sc_hd__mux2_1 _364_ (.A0(_041_),
    .A1(_044_),
    .S(_084_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_096_));
 sky130_fd_sc_hd__nor2_2 _365_ (.A(_095_),
    .B(_096_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_2 _366_ (.A1(_080_),
    ...
    .VPWR(VPWR),
    .X(_098_));
 sky130_fd_sc_hd__nand3b_2 _367_ (.A_N(_035_),
    .B(_080_),
    .C(_083_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_099_));
 sky130_fd_sc_hd__and3b_2 _368_ (.A_N(_255_),
    .B(_080_),
    .C(_083_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_100_));
 sky130_fd_sc_hd__a21oi_2 _369_ (.A1(_080_),
    .A2(_083_),
    .B1(_258_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_101_));
 sky130_fd_sc_hd__o211a_2 _370_ (.A1(_100_),
    .A2(_101_),
    .B1(_098_),
    .C1(_099_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_102_));
 sky130_fd_sc_hd__a211o_2 _371_ (.A1(_098_),
    .A2(_099_),
    .B1(_100_),
    .C1(_101_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_103_));
 sky130_fd_sc_hd__and2b_2 _372_ (.A_N(_102_),
    .B(_103_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_104_));
 sky130_fd_sc_hd__and3_2 _373_ (.A(\abs_y[0] ),
    .B(_080_),
    .C(_083_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_105_));
 sky130_fd_sc_hd__a32o_2 _374_ (.A1(\abs_x[0] ),
    .A2(_035_),
    .A3(_085_),
    .B1(_105_),
    .B2(_031_),
    ...
    .VPWR(VPWR),
    .X(_106_));
 sky130_fd_sc_hd__a21o_2 _375_ (.A1(_103_),
    .A2(_106_),
    .B1(_102_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_107_));
 sky130_fd_sc_hd__nand2_2 _376_ (.A(_095_),
    .B(_096_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_108_));
 sky130_fd_sc_hd__and2b_2 _377_ (.A_N(_097_),
    .B(_108_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_109_));
 sky130_fd_sc_hd__a21oi_2 _378_ (.A1(_107_),
    .A2(_108_),
    .B1(_097_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_110_));
 sky130_fd_sc_hd__a211o_2 _379_ (.A1(_107_),
    .A2(_108_),
    .B1(_093_),
    .C1(_097_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_111_));
 sky130_fd_sc_hd__nand3_2 _380_ (.A(_090_),
    .B(_094_),
    .C(_111_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_112_));
 sky130_fd_sc_hd__a21o_2 _381_ (.A1(_094_),
    .A2(_111_),
    .B1(_090_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_113_));
 sky130_fd_sc_hd__nand2_2 _382_ (.A(\anim_offset[1] ),
    .B(_227_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_114_));
 sky130_fd_sc_hd__o21a_2 _383_ (.A1(\anim_offset[1] ),
    .A2(\anim_offset[2] ),
    .B1(_227_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_115_));
 sky130_fd_sc_hd__a21o_2 _384_ (.A1(\anim_offset[3] ),
    .A2(_227_),
    .B1(_115_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_116_));
 sky130_fd_sc_hd__xnor2_2 _385_ (.A(\anim_offset[4] ),
    .B(_116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_117_));
 sky130_fd_sc_hd__and3_2 _386_ (.A(_112_),
    .B(_113_),
    .C(_117_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_118_));
 sky130_fd_sc_hd__a21o_2 _387_ (.A1(_112_),
    .A2(_113_),
    .B1(_117_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_119_));
 sky130_fd_sc_hd__and2b_2 _388_ (.A_N(_118_),
    .B(_119_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_120_));
 sky130_fd_sc_hd__xor2_2 _389_ (.A(\anim_offset[3] ),
    .B(_115_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_121_));
 sky130_fd_sc_hd__nand2b_2 _390_ (.A_N(_093_),
    .B(_094_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_122_));
 sky130_fd_sc_hd__xnor2_2 _391_ (.A(_110_),
    .B(_122_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_123_));
 sky130_fd_sc_hd__nand2_2 _392_ (.A(_121_),
    .B(_123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_124_));
 sky130_fd_sc_hd__xnor2_2 _393_ (.A(\anim_offset[2] ),
    .B(_114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_125_));
 sky130_fd_sc_hd__xnor2_2 _394_ (.A(_104_),
    .B(_106_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_126_));
 sky130_fd_sc_hd__xnor2_2 _395_ (.A(_107_),
    .B(_109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_127_));
 sky130_fd_sc_hd__a21o_2 _396_ (.A1(\anim_offset[1] ),
    .A2(_126_),
    .B1(_125_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_128_));
 sky130_fd_sc_hd__and3_2 _397_ (.A(\anim_offset[1] ),
    .B(_125_),
    .C(_126_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_129_));
 sky130_fd_sc_hd__o221ai_2 _398_ (.A1(_121_),
    .A2(_123_),
    .B1(_127_),
    .B2(_129_),
    .C1(_128_),
    ...
    .VPWR(VPWR),
    .Y(_130_));
 sky130_fd_sc_hd__nand2_2 _399_ (.A(_124_),
    .B(_130_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_131_));
 sky130_fd_sc_hd__and4_2 _400_ (.A(\hvsync_gen.vpos[8] ),
    .B(\hvsync_gen.vpos[6] ),
    .C(\hvsync_gen.vpos[7] ),
    .D(\hvsync_gen.vpos[5] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_132_));
 sky130_fd_sc_hd__nor3b_2 _401_ (.A(net9),
    .B(_132_),
    .C_N(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_133_));
 sky130_fd_sc_hd__xnor2_2 _402_ (.A(_120_),
    .B(_131_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_134_));
 sky130_fd_sc_hd__and2_2 _403_ (.A(_133_),
    .B(_134_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[4]));
 sky130_fd_sc_hd__a31oi_2 _404_ (.A1(_119_),
    .A2(_124_),
    .A3(_130_),
    .B1(_118_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_135_));
 sky130_fd_sc_hd__mux2_1 _405_ (.A0(_235_),
    .A1(_248_),
    .S(_084_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_136_));
 sky130_fd_sc_hd__mux2_1 _406_ (.A0(_052_),
    .A1(_057_),
    .S(_085_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_137_));
 sky130_fd_sc_hd__and2b_2 _407_ (.A_N(_136_),
    .B(_137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_138_));
 sky130_fd_sc_hd__xor2_2 _408_ (.A(_136_),
    .B(_137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_139_));
 sky130_fd_sc_hd__inv_2 _409_ (.A(_139_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_140_));
 sky130_fd_sc_hd__a31o_2 _410_ (.A1(_089_),
    .A2(_094_),
    .A3(_111_),
    .B1(_088_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_141_));
 sky130_fd_sc_hd__xnor2_2 _411_ (.A(_139_),
    .B(_141_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_142_));
 sky130_fd_sc_hd__o21a_2 _412_ (.A1(\anim_offset[4] ),
    .A2(_116_),
    .B1(_227_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_143_));
 sky130_fd_sc_hd__xnor2_2 _413_ (.A(\anim_offset[5] ),
    .B(_143_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_144_));
 sky130_fd_sc_hd__nand2_2 _414_ (.A(_142_),
    .B(_144_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_145_));
 sky130_fd_sc_hd__xnor2_2 _415_ (.A(_142_),
    .B(_144_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_146_));
 sky130_fd_sc_hd__nand2_2 _416_ (.A(_135_),
    .B(_146_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_147_));
 sky130_fd_sc_hd__or2_2 _417_ (.A(_135_),
    .B(_146_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_148_));
 sky130_fd_sc_hd__and3_2 _418_ (.A(_133_),
    .B(_147_),
    .C(_148_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _420_ (.A0(_052_),
    ...
    .VPWR(VPWR),
    .X(_150_));
 sky130_fd_sc_hd__mux2_1 _421_ (.A0(_063_),
    .A1(_068_),
    .S(_085_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_151_));
 sky130_fd_sc_hd__and2_2 _422_ (.A(_150_),
    .B(_151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_152_));
 sky130_fd_sc_hd__or2_2 _423_ (.A(_150_),
    .B(_151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_153_));
 sky130_fd_sc_hd__and2b_2 _424_ (.A_N(_152_),
    .B(_153_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_154_));
 sky130_fd_sc_hd__a21o_2 _425_ (.A1(_140_),
    .A2(_141_),
    .B1(_138_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_155_));
 sky130_fd_sc_hd__xor2_2 _426_ (.A(_154_),
    .B(_155_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_156_));
 sky130_fd_sc_hd__o21a_2 _427_ (.A1(\anim_offset[5] ),
    .A2(_143_),
    .B1(_227_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_157_));
 sky130_fd_sc_hd__xnor2_2 _428_ (.A(\anim_offset[6] ),
    .B(_157_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_158_));
 sky130_fd_sc_hd__nand2_2 _429_ (.A(_156_),
    .B(_158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_159_));
 sky130_fd_sc_hd__xnor2_2 _430_ (.A(_156_),
    .B(_158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_160_));
 sky130_fd_sc_hd__nand2_2 _431_ (.A(_149_),
    .B(_160_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_161_));
 sky130_fd_sc_hd__or2_2 _432_ (.A(_149_),
    .B(_160_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_162_));
 sky130_fd_sc_hd__and3_2 _433_ (.A(_133_),
    .B(_161_),
    .C(_162_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[6]));
 sky130_fd_sc_hd__o21a_2 _434_ (.A1(_149_),
    .A2(_160_),
    .B1(_159_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_163_));
 sky130_fd_sc_hd__a21o_2 _435_ (.A1(_153_),
    .A2(_155_),
    .B1(_152_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_164_));
 sky130_fd_sc_hd__xnor2_2 _436_ (.A(_067_),
    .B(_071_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_165_));
 sky130_fd_sc_hd__xnor2_2 _437_ (.A(_063_),
    .B(_075_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_166_));
 sky130_fd_sc_hd__mux2_1 _438_ (.A0(_165_),
    .A1(_166_),
    .S(_085_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_167_));
 sky130_fd_sc_hd__o21a_2 _439_ (.A1(\anim_offset[6] ),
    .A2(_157_),
    .B1(_227_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_168_));
 sky130_fd_sc_hd__xnor2_2 _440_ (.A(\anim_offset[7] ),
    .B(_168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_169_));
 sky130_fd_sc_hd__xnor2_2 _441_ (.A(_167_),
    .B(_169_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_170_));
 sky130_fd_sc_hd__xnor2_2 _442_ (.A(_164_),
    .B(_170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_171_));
 sky130_fd_sc_hd__xnor2_2 _443_ (.A(_163_),
    .B(_171_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_172_));
 sky130_fd_sc_hd__and2_2 _444_ (.A(_133_),
    .B(_172_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[2]));
 sky130_fd_sc_hd__and3_2 _445_ (.A(\abs_y[0] ),
    .B(\cy[1] ),
    .C(\cy[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_173_));
 sky130_fd_sc_hd__and2_2 _446_ (.A(\cy[3] ),
    .B(_173_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_174_));
 sky130_fd_sc_hd__o2111a_2 _447_ (.A1(\abs_y[0] ),
    .A2(_226_),
    .B1(_132_),
    .C1(\cy[1] ),
    .D1(\cy[3] ),
    ...
    .VPWR(VPWR),
    .X(_175_));
 sky130_fd_sc_hd__or4b_2 _448_ (.A(net11),
    .B(net10),
    .C(_174_),
    .D_N(_175_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__and3_2 _449_ (.A(\cx[4] ),
    .B(\cx[6] ),
    .C(\cx[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_176_));
 sky130_fd_sc_hd__o311a_2 _450_ (.A1(\cx[4] ),
    .A2(\cx[6] ),
    .A3(\cx[5] ),
    .B1(\hpos[7] ),
    .C1(\hpos[9] ),
    ...
    .VPWR(VPWR),
    .X(_177_));
 sky130_fd_sc_hd__or3b_2 _451_ (.A(\hpos[8] ),
    .B(_176_),
    .C_N(_177_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_000_));
 sky130_fd_sc_hd__and3_2 _452_ (.A(\abs_x[0] ),
    .B(\cx[1] ),
    .C(\cx[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_178_));
 sky130_fd_sc_hd__and2_2 _453_ (.A(\cx[3] ),
    .B(_178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_179_));
 sky130_fd_sc_hd__and3_2 _454_ (.A(\cx[4] ),
    .B(\cx[3] ),
    .C(_178_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_180_));
 sky130_fd_sc_hd__and4bb_2 _455_ (.A_N(\cx[6] ),
    .B_N(\cx[5] ),
    .C(_059_),
    .D(_180_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_181_));
 sky130_fd_sc_hd__nand2_2 _456_ (.A(net9),
    .B(\cy[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_182_));
 sky130_fd_sc_hd__o41a_2 _457_ (.A1(_226_),
    .A2(_243_),
    .A3(_072_),
    .A4(_182_),
    .B1(net12),
    ...
    .VPWR(VPWR),
    .X(_183_));
 sky130_fd_sc_hd__and2_2 _458_ (.A(_181_),
    .B(_183_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_184_));
 sky130_fd_sc_hd__and2b_2 _459_ (.A_N(_181_),
    .B(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_185_));
 sky130_fd_sc_hd__mux2_1 _460_ (.A0(_184_),
    .A1(net4),
    .S(\abs_y[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_002_));
 sky130_fd_sc_hd__a22o_2 _461_ (.A1(_032_),
    .A2(_184_),
    .B1(net4),
    .B2(\cy[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__a21oi_2 _462_ (.A1(\abs_y[0] ),
    .A2(\cy[1] ),
    .B1(\cy[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_186_));
 sky130_fd_sc_hd__nor2_2 _463_ (.A(_173_),
    .B(_186_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_187_));
 sky130_fd_sc_hd__a22o_2 _464_ (.A1(\cy[2] ),
    .A2(net4),
    .B1(_187_),
    .B2(_184_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_004_));
 sky130_fd_sc_hd__o21ai_2 _465_ (.A1(\cy[3] ),
    .A2(_173_),
    .B1(_184_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_188_));
 sky130_fd_sc_hd__a2bb2o_2 _466_ (.A1_N(_174_),
    .A2_N(_188_),
    .B1(net5),
    .B2(\cy[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_005_));
 sky130_fd_sc_hd__xnor2_2 _467_ (.A(_225_),
    .B(_174_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_189_));
 sky130_fd_sc_hd__a22o_2 _468_ (.A1(net28),
    .A2(net5),
    .B1(_189_),
    .B2(_184_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__a31o_2 _469_ (.A1(net11),
    .A2(\cy[3] ),
    .A3(_173_),
    ...
    .VPWR(VPWR),
    .X(_190_));
 sky130_fd_sc_hd__and3_2 _470_ (.A(\cy[3] ),
    .B(_237_),
    .C(_173_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_191_));
 sky130_fd_sc_hd__inv_2 _471_ (.A(_191_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_192_));
 sky130_fd_sc_hd__a32o_2 _472_ (.A1(_184_),
    .A2(_190_),
    .A3(_192_),
    .B1(net5),
    ...
    .VPWR(VPWR),
    .X(_007_));
 sky130_fd_sc_hd__or2_2 _473_ (.A(\hvsync_gen.vpos[6] ),
    .B(_191_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_193_));
 sky130_fd_sc_hd__and3_2 _474_ (.A(\hvsync_gen.vpos[6] ),
    .B(_237_),
    .C(_174_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_194_));
 sky130_fd_sc_hd__inv_2 _475_ (.A(_194_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_195_));
 sky130_fd_sc_hd__a32o_2 _476_ (.A1(_184_),
    .A2(_193_),
    .A3(_195_),
    .B1(net5),
    .B2(net32),
    ...
    .VPWR(VPWR),
    .X(_008_));
 sky130_fd_sc_hd__nand2_2 _477_ (.A(\hvsync_gen.vpos[7] ),
    .B(_194_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_196_));
 sky130_fd_sc_hd__or2_2 _478_ (.A(\hvsync_gen.vpos[7] ),
    .B(_194_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_197_));
 sky130_fd_sc_hd__a32o_2 _479_ (.A1(_184_),
    .A2(_196_),
    .A3(_197_),
    .B1(net5),
    ...
    .VPWR(VPWR),
    .X(_009_));
 sky130_fd_sc_hd__nand3_2 _480_ (.A(net11),
    .B(_132_),
    .C(_174_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_198_));
 sky130_fd_sc_hd__a21o_2 _481_ (.A1(_183_),
    .A2(_198_),
    .B1(net4),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_199_));
 sky130_fd_sc_hd__a31o_2 _482_ (.A1(\hvsync_gen.vpos[7] ),
    .A2(_184_),
    .A3(_194_),
    .B1(\hvsync_gen.vpos[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_200_));
 sky130_fd_sc_hd__and2_2 _483_ (.A(_199_),
    .B(_200_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__nor2_2 _484_ (.A(net9),
    .B(_198_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_201_));
 sky130_fd_sc_hd__a22o_2 _485_ (.A1(net9),
    .A2(_199_),
    .B1(_201_),
    .B2(_184_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_011_));
 sky130_fd_sc_hd__and2b_2 _486_ (.A_N(\abs_x[0] ),
    .B(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__and3_2 _487_ (.A(_229_),
    .B(_029_),
    .C(net4),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__a21o_2 _488_ (.A1(\abs_x[0] ),
    .A2(\cx[1] ),
    .B1(\cx[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_202_));
 sky130_fd_sc_hd__and3b_2 _489_ (.A_N(_178_),
    .B(_202_),
    .C(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_014_));
 sky130_fd_sc_hd__o21ai_2 _490_ (.A1(net34),
    .A2(_178_),
    .B1(net4),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_203_));
 sky130_fd_sc_hd__nor2_2 _491_ (.A(_179_),
    .B(_203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_015_));
 sky130_fd_sc_hd__o21ai_2 _492_ (.A1(\cx[4] ),
    .A2(_179_),
    .B1(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_204_));
 sky130_fd_sc_hd__nor2_2 _493_ (.A(_180_),
    .B(_204_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_016_));
 sky130_fd_sc_hd__and2_2 _494_ (.A(\cx[5] ),
    .B(_180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_205_));
 sky130_fd_sc_hd__o21ai_2 _495_ (.A1(\cx[5] ),
    .A2(_180_),
    .B1(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_206_));
 sky130_fd_sc_hd__nor2_2 _496_ (.A(_205_),
    .B(_206_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_017_));
 sky130_fd_sc_hd__and3_2 _497_ (.A(\cx[3] ),
    .B(_176_),
    .C(_178_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_207_));
 sky130_fd_sc_hd__o21ai_2 _498_ (.A1(net36),
    .A2(_205_),
    .B1(net4),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_208_));
 sky130_fd_sc_hd__nor2_2 _499_ (.A(_207_),
    .B(_208_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_018_));
 sky130_fd_sc_hd__nand2_2 _500_ (.A(net8),
    .B(_207_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_209_));
 sky130_fd_sc_hd__or2_2 _501_ (.A(net8),
    .B(_207_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_210_));
 sky130_fd_sc_hd__and3_2 _502_ (.A(net4),
    .B(_209_),
    .C(_210_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_019_));
 sky130_fd_sc_hd__a21o_2 _503_ (.A1(net8),
    .A2(_207_),
    .B1(\hpos[8] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_211_));
 sky130_fd_sc_hd__and3_2 _504_ (.A(\hpos[8] ),
    .B(net8),
    .C(_207_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_212_));
 sky130_fd_sc_hd__and3b_2 _505_ (.A_N(_212_),
    .B(net4),
    .C(_211_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_020_));
 sky130_fd_sc_hd__o21ai_2 _506_ (.A1(\hpos[9] ),
    .A2(_212_),
    .B1(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_213_));
 sky130_fd_sc_hd__a21oi_2 _507_ (.A1(net29),
    .A2(_212_),
    .B1(_213_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_021_));
 sky130_fd_sc_hd__nor3_2 _508_ (.A(net10),
    .B(_245_),
    .C(_072_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_214_));
 sky130_fd_sc_hd__and3_2 _509_ (.A(_063_),
    .B(_076_),
    .C(_214_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_215_));
 sky130_fd_sc_hd__o21ai_2 _510_ (.A1(net2),
    .A2(\anim_offset[1] ),
    .B1(_215_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_216_));
 sky130_fd_sc_hd__and2_2 _511_ (.A(net2),
    .B(\anim_offset[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_217_));
 sky130_fd_sc_hd__o22a_2 _512_ (.A1(\anim_offset[1] ),
    .A2(_215_),
    .B1(_216_),
    .B2(_217_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_022_));
 sky130_fd_sc_hd__o211a_2 _513_ (.A1(net2),
    .A2(\anim_offset[1] ),
    .B1(\anim_offset[2] ),
    .C1(_215_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_218_));
 sky130_fd_sc_hd__xnor2_2 _514_ (.A(net33),
    .B(_216_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_023_));
 sky130_fd_sc_hd__xor2_2 _515_ (.A(\anim_offset[3] ),
    .B(_218_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_024_));
 sky130_fd_sc_hd__and3_2 _516_ (.A(\anim_offset[4] ),
    .B(\anim_offset[3] ),
    .C(_218_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_219_));
 sky130_fd_sc_hd__a21oi_2 _517_ (.A1(\anim_offset[3] ),
    .A2(_218_),
    .B1(net35),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_220_));
 sky130_fd_sc_hd__nor2_2 _518_ (.A(_219_),
    .B(_220_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_025_));
 sky130_fd_sc_hd__and2_2 _519_ (.A(\anim_offset[5] ),
    .B(_219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_221_));
 sky130_fd_sc_hd__nor2_2 _520_ (.A(net37),
    .B(_219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_222_));
 sky130_fd_sc_hd__nor2_2 _521_ (.A(_221_),
    .B(_222_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_026_));
 sky130_fd_sc_hd__nand2_2 _522_ (.A(\anim_offset[6] ),
    .B(_221_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_223_));
 sky130_fd_sc_hd__or2_2 _523_ (.A(\anim_offset[6] ),
    .B(_221_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_224_));
 sky130_fd_sc_hd__and2_2 _524_ (.A(_223_),
    .B(_224_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__xnor2_2 _525_ (.A(net31),
    .B(_223_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_028_));
 sky130_fd_sc_hd__dfxtp_2 _526_ (.CLK(clknet_2_0__leaf_clk),
    .D(_002_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\abs_y[0] ));
 sky130_fd_sc_hd__dfxtp_2 _527_ (.CLK(clknet_2_0__leaf_clk),
    .D(_003_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cy[1] ));
 sky130_fd_sc_hd__dfxtp_2 _528_ (.CLK(clknet_2_0__leaf_clk),
    .D(_004_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cy[2] ));
 sky130_fd_sc_hd__dfxtp_2 _529_ (.CLK(clknet_2_0__leaf_clk),
    .D(_005_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cy[3] ));
 sky130_fd_sc_hd__dfxtp_2 _530_ (.CLK(clknet_2_2__leaf_clk),
    .D(_006_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vpos[4] ));
 sky130_fd_sc_hd__dfxtp_2 _531_ (.CLK(clknet_2_0__leaf_clk),
    .D(_007_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vpos[5] ));
 sky130_fd_sc_hd__dfxtp_2 _532_ (.CLK(clknet_2_0__leaf_clk),
    .D(_008_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vpos[6] ));
 sky130_fd_sc_hd__dfxtp_2 _533_ (.CLK(clknet_2_2__leaf_clk),
    .D(_009_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vpos[7] ));
 sky130_fd_sc_hd__dfxtp_2 _534_ (.CLK(clknet_2_2__leaf_clk),
    .D(_010_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vpos[8] ));
 sky130_fd_sc_hd__dfxtp_2 _535_ (.CLK(clknet_2_0__leaf_clk),
    .D(_011_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vpos[9] ));
 sky130_fd_sc_hd__dfxtp_2 _536_ (.CLK(clknet_2_0__leaf_clk),
    .D(_012_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _537_ (.CLK(clknet_2_1__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\cx[1] ));
 sky130_fd_sc_hd__dfxtp_2 _538_ (.CLK(clknet_2_1__leaf_clk),
    .D(_014_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _539_ (.CLK(clknet_2_1__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\cx[3] ));
 sky130_fd_sc_hd__dfxtp_2 _540_ (.CLK(clknet_2_1__leaf_clk),
    .D(_016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cx[4] ));
 sky130_fd_sc_hd__dfxtp_2 _541_ (.CLK(clknet_2_1__leaf_clk),
    .D(_017_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cx[5] ));
 sky130_fd_sc_hd__dfxtp_2 _542_ (.CLK(clknet_2_1__leaf_clk),
    .D(_018_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cx[6] ));
 sky130_fd_sc_hd__dfxtp_2 _543_ (.CLK(clknet_2_1__leaf_clk),
    .D(_019_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hpos[7] ));
 sky130_fd_sc_hd__dfxtp_2 _544_ (.CLK(clknet_2_1__leaf_clk),
    .D(_020_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfrtp_2 _551_ (.CLK(clknet_2_2__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\anim_offset[6] ));
 sky130_fd_sc_hd__dfrtp_2 _552_ (.CLK(clknet_2_3__leaf_clk),
    .D(_028_),
    .RESET_B(net1),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\anim_offset[7] ));
 sky130_fd_sc_hd__dfxtp_2 _553_ (.CLK(clknet_2_1__leaf_clk),
    .D(_000_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(hsync));
 sky130_fd_sc_hd__dfxtp_2 _554_ (.CLK(clknet_2_3__leaf_clk),
    .D(_001_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\hvsync_gen.vsync ));
 sky130_fd_sc_hd__conb_1 tt_um_dinukuk_MYVGA_GLIDER_13 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net13));
 sky130_fd_sc_hd__conb_1 tt_um_dinukuk_MYVGA_GLIDER_14 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net14));
 sky130_fd_sc_hd__conb_1 tt_um_dinukuk_MYVGA_GLIDER_15 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net15));
 sky130_fd_sc_hd__conb_1 tt_um_dinukuk_MYVGA_GLIDER_16 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net16));
 sky130_fd_sc_hd__conb_1 tt_um_dinukuk_MYVGA_GLIDER_17 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net17));
 sky130_fd_sc_hd__conb_1 tt_um_dinukuk_MYVGA_GLIDER_18 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net18));
 sky130_fd_sc_hd__conb_1 tt_um_dinukuk_MYVGA_GLIDER_19 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net19));
 sky130_fd_sc_hd__conb_1 tt_um_dinukuk_MYVGA_GLIDER_20 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net20));
 sky130_fd_sc_hd__conb_1 tt_um_dinukuk_MYVGA_GLIDER_21 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net21));
 sky130_fd_sc_hd__conb_1 tt_um_dinukuk_MYVGA_GLIDER_22 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net22));
 sky130_fd_sc_hd__conb_1 tt_um_dinukuk_MYVGA_GLIDER_23 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net23));
 sky130_fd_sc_hd__conb_1 tt_um_dinukuk_MYVGA_GLIDER_24 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net24));
 sky130_fd_sc_hd__conb_1 tt_um_dinukuk_MYVGA_GLIDER_25 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net25));
 sky130_fd_sc_hd__conb_1 tt_um_dinukuk_MYVGA_GLIDER_26 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net26));
 sky130_fd_sc_hd__conb_1 tt_um_dinukuk_MYVGA_GLIDER_27 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net27));
 sky130_fd_sc_hd__clkbuf_16 clkbuf_0_clk (.A(clk),
    ...
    .VPWR(VPWR),
    .X(clknet_0_clk));
 sky130_fd_sc_hd__buf_2 _571_ (.A(uo_out[5]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[0]));
 sky130_fd_sc_hd__buf_2 _572_ (.A(uo_out[6]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[1]));
 sky130_fd_sc_hd__buf_2 _573_ (.A(\hvsync_gen.vsync ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[3]));
 sky130_fd_sc_hd__buf_2 _574_ (.A(hsync),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout4 (.A(net5),
    ...
    .VPWR(VPWR),
    .X(net4));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout5 (.A(_185_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net5));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout6 (.A(_240_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net6));
 sky130_fd_sc_hd__clkbuf_2 max_cap7 (.A(_228_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net7));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout8 (.A(\hpos[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout9 (.A(net10),
    ...
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout10 (.A(\hvsync_gen.vpos[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout11 (.A(\hvsync_gen.vpos[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout12 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net12));
 sky130_fd_sc_hd__conb_1 tt_um_dinukuk_MYVGA_GLIDER (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 ...
 sky130_fd_sc_hd__bufinv_16 clkload2 (.A(clknet_2_3__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dlygate4sd3_1 hold28 (.A(\hvsync_gen.vpos[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__dlygate4sd3_1 hold29 (.A(\hpos[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net29));
 sky130_fd_sc_hd__dlygate4sd3_1 hold30 (.A(_021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__dlygate4sd3_1 hold31 (.A(\anim_offset[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net31));
 sky130_fd_sc_hd__dlygate4sd3_1 hold32 (.A(\hvsync_gen.vpos[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net32));
 sky130_fd_sc_hd__dlygate4sd3_1 hold33 (.A(\anim_offset[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net33));
 sky130_fd_sc_hd__dlygate4sd3_1 hold34 (.A(\cx[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net34));
 sky130_fd_sc_hd__dlygate4sd3_1 hold35 (.A(\anim_offset[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net35));
 sky130_fd_sc_hd__dlygate4sd3_1 hold36 (.A(\cx[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net36));
 sky130_fd_sc_hd__dlygate4sd3_1 hold37 (.A(\anim_offset[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
