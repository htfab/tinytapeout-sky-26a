module tt_um_alu_bns (clk,
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA_1 (.DIODE(_130_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _294_ (.A(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _295_ (.A(net19),
    ...
    .VPWR(VPWR),
    .Y(_156_));
 sky130_fd_sc_hd__inv_2 _296_ (.A(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _297_ (.A(net13),
    ...
    .VPWR(VPWR),
    .Y(_178_));
 sky130_fd_sc_hd__nor2_2 _298_ (.A(net8),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_189_));
 sky130_fd_sc_hd__and2b_2 _299_ (.A_N(net26),
    .B(_189_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_199_));
 sky130_fd_sc_hd__or3_2 _300_ (.A(net8),
    .B(net15),
    .C(net26),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_210_));
 sky130_fd_sc_hd__or2_2 _301_ (.A(net33),
    .B(_146_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_221_));
 sky130_fd_sc_hd__nand2_2 _302_ (.A(net33),
    .B(_146_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_228_));
 sky130_fd_sc_hd__nand2_2 _303_ (.A(_221_),
    .B(_228_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_229_));
 sky130_fd_sc_hd__xnor2_2 _304_ (.A(net7),
    .B(_229_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_230_));
 sky130_fd_sc_hd__and3b_2 _305_ (.A_N(net8),
    .B(net15),
    .C(net26),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_231_));
 sky130_fd_sc_hd__nand2_2 _306_ (.A(net20),
    .B(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_232_));
 sky130_fd_sc_hd__or2_2 _307_ (.A(net20),
    .B(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_233_));
 sky130_fd_sc_hd__nand2_2 _308_ (.A(_232_),
    .B(_233_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_234_));
 sky130_fd_sc_hd__and2b_2 _309_ (.A_N(net28),
    .B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_235_));
 sky130_fd_sc_hd__and2b_2 _310_ (.A_N(net30),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_236_));
 sky130_fd_sc_hd__and2_2 _311_ (.A(net23),
    .B(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_237_));
 sky130_fd_sc_hd__nand2_2 _312_ (.A(net23),
    .B(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_238_));
 sky130_fd_sc_hd__nor2_2 _313_ (.A(net23),
    .B(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_239_));
 sky130_fd_sc_hd__or2_2 _314_ (.A(_237_),
    .B(_239_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_240_));
 sky130_fd_sc_hd__a21o_2 _315_ (.A1(_221_),
    .A2(_240_),
    .B1(_236_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_241_));
 sky130_fd_sc_hd__and2_2 _316_ (.A(net22),
    .B(net28),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_242_));
 sky130_fd_sc_hd__nor2_2 _317_ (.A(net22),
    .B(net28),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_243_));
 sky130_fd_sc_hd__or2_2 _318_ (.A(_242_),
    .B(_243_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_244_));
 sky130_fd_sc_hd__a21o_2 _319_ (.A1(_241_),
    .A2(_244_),
    .B1(_235_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_245_));
 sky130_fd_sc_hd__and2b_2 _320_ (.A_N(net12),
    .B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a221o_2 _321_ (.A1(net19),
    ...
    .VPWR(VPWR),
    .X(_247_));
 sky130_fd_sc_hd__xnor2_2 _322_ (.A(net6),
    .B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_248_));
 sky130_fd_sc_hd__o21a_2 _323_ (.A1(net19),
    .A2(_178_),
    .B1(_248_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_249_));
 sky130_fd_sc_hd__a2bb2o_2 _324_ (.A1_N(_167_),
    .A2_N(net14),
    .B1(_247_),
    .B2(_249_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_250_));
 sky130_fd_sc_hd__or4b_2 _325_ (.A(net15),
    .B(net26),
    .C(_230_),
    .D_N(net8),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_251_));
 sky130_fd_sc_hd__nand2_2 _326_ (.A(net8),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_252_));
 sky130_fd_sc_hd__nor2_2 _327_ (.A(net26),
    .B(_252_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_253_));
 sky130_fd_sc_hd__nor3b_2 _328_ (.A(net8),
    .B(net26),
    .C_N(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_254_));
 sky130_fd_sc_hd__or3b_2 _329_ (.A(net8),
    .B(net26),
    .C_N(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_255_));
 sky130_fd_sc_hd__or2_2 _330_ (.A(_253_),
    .B(_254_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_256_));
 sky130_fd_sc_hd__a21oi_2 _331_ (.A1(net16),
    .A2(_189_),
    .B1(_256_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_2 _332_ (.A(net33),
    ...
    .VPWR(VPWR),
    .Y(_258_));
 sky130_fd_sc_hd__nand3b_2 _333_ (.A_N(net15),
    .B(net16),
    .C(net8),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_259_));
 sky130_fd_sc_hd__inv_2 _334_ (.A(_259_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_260_));
 sky130_fd_sc_hd__or2_2 _335_ (.A(net28),
    .B(_259_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_261_));
 sky130_fd_sc_hd__o311a_2 _336_ (.A1(net30),
    .A2(_228_),
    .A3(_261_),
    .B1(_251_),
    .C1(_210_),
    ...
    .VPWR(VPWR),
    .X(_262_));
 sky130_fd_sc_hd__o21ai_2 _337_ (.A1(_257_),
    .A2(_258_),
    .B1(_262_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_263_));
 sky130_fd_sc_hd__or2_2 _338_ (.A(net33),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_264_));
 sky130_fd_sc_hd__nand2_2 _339_ (.A(net33),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_265_));
 sky130_fd_sc_hd__nand2_2 _340_ (.A(_264_),
    .B(_265_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_266_));
 sky130_fd_sc_hd__xor2_2 _341_ (.A(net22),
    .B(_266_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_267_));
 sky130_fd_sc_hd__or2_2 _342_ (.A(_156_),
    .B(_267_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_268_));
 sky130_fd_sc_hd__nand2_2 _343_ (.A(_156_),
    .B(_267_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_269_));
 sky130_fd_sc_hd__nand2_2 _344_ (.A(_268_),
    .B(_269_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_270_));
 sky130_fd_sc_hd__nor2_2 _345_ (.A(_167_),
    .B(_270_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_271_));
 sky130_fd_sc_hd__and2_2 _346_ (.A(_167_),
    .B(_270_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_272_));
 sky130_fd_sc_hd__nor2_2 _347_ (.A(_271_),
    .B(_272_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_273_));
 sky130_fd_sc_hd__or2_2 _348_ (.A(net20),
    .B(_273_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_274_));
 sky130_fd_sc_hd__nand3_2 _349_ (.A(net8),
    .B(net15),
    .C(net16),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_275_));
 sky130_fd_sc_hd__a21oi_2 _350_ (.A1(net20),
    .A2(_273_),
    .B1(_275_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_276_));
 sky130_fd_sc_hd__a22o_2 _351_ (.A1(_231_),
    .A2(_250_),
    .B1(_274_),
    .B2(_276_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_277_));
 sky130_fd_sc_hd__o2bb2a_2 _352_ (.A1_N(_199_),
    .A2_N(_230_),
    .B1(_263_),
    .B2(_277_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[0]));
 sky130_fd_sc_hd__a21o_2 _353_ (.A1(net20),
    .A2(_273_),
    .B1(_271_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_278_));
 sky130_fd_sc_hd__a21bo_2 _354_ (.A1(net22),
    .A2(_264_),
    .B1_N(_265_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_279_));
 sky130_fd_sc_hd__mux2_1 _355_ (.A0(_265_),
    .A1(_279_),
    .S(_268_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_280_));
 sky130_fd_sc_hd__or2_2 _356_ (.A(_278_),
    .B(_280_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_281_));
 sky130_fd_sc_hd__a21oi_2 _357_ (.A1(_278_),
    .A2(_280_),
    .B1(_275_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_282_));
 sky130_fd_sc_hd__xnor2_2 _358_ (.A(net19),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_283_));
 sky130_fd_sc_hd__and4b_2 _359_ (.A_N(_229_),
    .B(_231_),
    .C(_234_),
    .D(_240_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_284_));
 sky130_fd_sc_hd__and4_2 _360_ (.A(_244_),
    .B(_248_),
    .C(_283_),
    .D(_284_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_285_));
 sky130_fd_sc_hd__a22o_2 _361_ (.A1(net17),
    .A2(net24),
    .B1(net31),
    .B2(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_286_));
 sky130_fd_sc_hd__nand4_2 _362_ (.A(net34),
    .B(net17),
    .C(net23),
    .D(net31),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_287_));
 sky130_fd_sc_hd__o21ai_2 _363_ (.A1(net17),
    .A2(net24),
    .B1(_221_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_288_));
 sky130_fd_sc_hd__or2_2 _364_ (.A(net30),
    .B(_288_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_289_));
 sky130_fd_sc_hd__nor2_2 _365_ (.A(_261_),
    .B(_289_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_290_));
 sky130_fd_sc_hd__a31o_2 _366_ (.A1(net16),
    .A2(_189_),
    .A3(_237_),
    .B1(_290_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_291_));
 sky130_fd_sc_hd__a31o_2 _367_ (.A1(_256_),
    .A2(_286_),
    .A3(_287_),
    .B1(_291_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_292_));
 sky130_fd_sc_hd__nor2_2 _368_ (.A(net15),
    .B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_293_));
 sky130_fd_sc_hd__o21ai_2 _369_ (.A1(net34),
    .A2(net9),
    .B1(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_000_));
 sky130_fd_sc_hd__and2_2 _370_ (.A(_258_),
    .B(_000_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__xor2_2 _371_ (.A(_240_),
    .B(_001_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_002_));
 sky130_fd_sc_hd__a22o_2 _372_ (.A1(_281_),
    .A2(_282_),
    .B1(_293_),
    .B2(_002_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__or3_2 _373_ (.A(_285_),
    .B(_292_),
    .C(_003_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[1]));
 sky130_fd_sc_hd__a21oi_2 _374_ (.A1(_238_),
    .A2(_001_),
    .B1(_239_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_004_));
 sky130_fd_sc_hd__xnor2_2 _375_ (.A(_244_),
    .B(_004_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_005_));
 sky130_fd_sc_hd__mux2_1 _376_ (.A0(net3),
    .A1(net24),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__nor2_2 _377_ (.A(net31),
    .B(_006_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_007_));
 sky130_fd_sc_hd__a211o_2 _378_ (.A1(net31),
    .A2(_228_),
    .B1(_261_),
    .C1(_007_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_008_));
 sky130_fd_sc_hd__nand2_2 _379_ (.A(_275_),
    .B(_008_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_009_));
 sky130_fd_sc_hd__o21ai_2 _380_ (.A1(_265_),
    .A2(_268_),
    .B1(_282_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_010_));
 sky130_fd_sc_hd__and2_2 _381_ (.A(net34),
    .B(net29),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_011_));
 sky130_fd_sc_hd__nand2_2 _382_ (.A(net34),
    .B(net29),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_012_));
 sky130_fd_sc_hd__and2_2 _383_ (.A(net17),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__nand2_2 _384_ (.A(net17),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_014_));
 sky130_fd_sc_hd__a21o_2 _385_ (.A1(_237_),
    .A2(_258_),
    .B1(_013_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_015_));
 sky130_fd_sc_hd__or3b_2 _386_ (.A(_238_),
    .B(_014_),
    .C_N(_258_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__nand2_2 _387_ (.A(_015_),
    .B(_016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_017_));
 sky130_fd_sc_hd__or2_2 _388_ (.A(_012_),
    .B(_017_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_018_));
 sky130_fd_sc_hd__nand2_2 _389_ (.A(_012_),
    .B(_017_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_019_));
 sky130_fd_sc_hd__a32o_2 _390_ (.A1(_256_),
    .A2(_018_),
    .A3(_019_),
    .B1(_009_),
    .B2(_010_),
    ...
    .VPWR(VPWR),
    .X(_020_));
 sky130_fd_sc_hd__a211o_2 _391_ (.A1(_189_),
    .A2(_242_),
    .B1(_285_),
    .C1(_020_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_021_));
 sky130_fd_sc_hd__a22o_2 _392_ (.A1(_293_),
    .A2(_005_),
    .B1(_021_),
    .B2(_210_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[2]));
 sky130_fd_sc_hd__nor2_2 _393_ (.A(_242_),
    .B(_004_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_022_));
 sky130_fd_sc_hd__nor2_2 _394_ (.A(_243_),
    .B(_022_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_023_));
 sky130_fd_sc_hd__xnor2_2 _395_ (.A(_234_),
    .B(_023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_024_));
 sky130_fd_sc_hd__nand2_2 _396_ (.A(net33),
    .B(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_025_));
 sky130_fd_sc_hd__inv_2 _397_ (.A(_025_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_026_));
 sky130_fd_sc_hd__nand2_2 _398_ (.A(net17),
    .B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_027_));
 sky130_fd_sc_hd__nand2_2 _399_ (.A(net3),
    .B(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_028_));
 sky130_fd_sc_hd__a22o_2 _400_ (.A1(net23),
    .A2(_013_),
    .B1(_028_),
    .B2(_287_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__a221o_2 _401_ (.A1(net23),
    .A2(_013_),
    .B1(_028_),
    .B2(_287_),
    .C1(_027_),
    ...
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__xor2_2 _402_ (.A(_027_),
    .B(_029_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__nand4_2 _403_ (.A(net23),
    .B(_011_),
    .C(_015_),
    .D(_016_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_032_));
 sky130_fd_sc_hd__a32o_2 _404_ (.A1(_011_),
    .A2(_015_),
    .A3(_016_),
    .B1(net29),
    .B2(net23),
    ...
    .VPWR(VPWR),
    .X(_033_));
 sky130_fd_sc_hd__nand3_2 _405_ (.A(_031_),
    .B(_032_),
    .C(_033_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_2 _406_ (.A1(_032_),
    ...
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__and3_2 _407_ (.A(_026_),
    .B(_034_),
    .C(_035_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_036_));
 sky130_fd_sc_hd__a21oi_2 _408_ (.A1(_034_),
    .A2(_035_),
    .B1(_026_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_037_));
 sky130_fd_sc_hd__nor2_2 _409_ (.A(_036_),
    .B(_037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_038_));
 sky130_fd_sc_hd__a211o_2 _410_ (.A1(_146_),
    .A2(net21),
    .B1(net31),
    .C1(_013_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_039_));
 sky130_fd_sc_hd__a21oi_2 _411_ (.A1(net30),
    .A2(_288_),
    .B1(_261_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_040_));
 sky130_fd_sc_hd__and3_2 _412_ (.A(net20),
    .B(net27),
    .C(_189_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_041_));
 sky130_fd_sc_hd__a22o_2 _413_ (.A1(_256_),
    .A2(_038_),
    .B1(_039_),
    .B2(_040_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_042_));
 sky130_fd_sc_hd__or3_2 _414_ (.A(_285_),
    .B(_041_),
    .C(_042_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_043_));
 sky130_fd_sc_hd__a22o_2 _415_ (.A1(_293_),
    .A2(_024_),
    .B1(_043_),
    .B2(_210_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[3]));
 sky130_fd_sc_hd__a21bo_2 _416_ (.A1(_233_),
    .A2(_023_),
    .B1_N(_232_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_044_));
 sky130_fd_sc_hd__xnor2_2 _417_ (.A(_283_),
    .B(_044_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_045_));
 sky130_fd_sc_hd__nand2_2 _418_ (.A(net33),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_046_));
 sky130_fd_sc_hd__nand2_2 _419_ (.A(net17),
    .B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_047_));
 sky130_fd_sc_hd__nand2_2 _420_ (.A(net21),
    .B(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_048_));
 sky130_fd_sc_hd__nand2_2 _421_ (.A(_237_),
    .B(_013_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_049_));
 sky130_fd_sc_hd__a21o_2 _422_ (.A1(_030_),
    .A2(_049_),
    .B1(_048_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__nand3_2 _423_ (.A(_030_),
    .B(_048_),
    .C(_049_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_051_));
 sky130_fd_sc_hd__nand2_2 _424_ (.A(_050_),
    .B(_051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_052_));
 sky130_fd_sc_hd__xor2_2 _425_ (.A(_047_),
    .B(_052_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_053_));
 sky130_fd_sc_hd__a21bo_2 _426_ (.A1(_031_),
    .A2(_033_),
    .B1_N(_032_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_054_));
 sky130_fd_sc_hd__nand2_2 _427_ (.A(_242_),
    .B(_054_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_055_));
 sky130_fd_sc_hd__or2_2 _428_ (.A(_242_),
    .B(_054_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_056_));
 sky130_fd_sc_hd__xnor2_2 _429_ (.A(_242_),
    .B(_054_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_057_));
 sky130_fd_sc_hd__xor2_2 _430_ (.A(_053_),
    .B(_057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_058_));
 sky130_fd_sc_hd__nand2_2 _431_ (.A(net25),
    .B(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_059_));
 sky130_fd_sc_hd__mux2_1 _432_ (.A0(_059_),
    .A1(net25),
    .S(_036_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_060_));
 sky130_fd_sc_hd__xor2_2 _433_ (.A(_058_),
    .B(_060_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_061_));
 sky130_fd_sc_hd__and3_2 _434_ (.A(net33),
    .B(net13),
    .C(_061_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_062_));
 sky130_fd_sc_hd__a21oi_2 _435_ (.A1(net33),
    .A2(net13),
    .B1(_061_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_063_));
 sky130_fd_sc_hd__nor2_2 _436_ (.A(_062_),
    .B(_063_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_064_));
 sky130_fd_sc_hd__a31o_2 _437_ (.A1(net19),
    .A2(net13),
    .A3(_189_),
    .B1(_285_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_065_));
 sky130_fd_sc_hd__mux4_2 _438_ (.A0(net5),
    .A1(net21),
    .A2(net22),
    .A3(net25),
    .S0(net9),
    ...
    .VPWR(VPWR),
    .X(_066_));
 sky130_fd_sc_hd__o21ai_2 _439_ (.A1(net30),
    .A2(_228_),
    .B1(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_067_));
 sky130_fd_sc_hd__o211a_2 _440_ (.A1(net28),
    .A2(_066_),
    .B1(_067_),
    .C1(_260_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_068_));
 sky130_fd_sc_hd__a211o_2 _441_ (.A1(_256_),
    .A2(_064_),
    .B1(_065_),
    .C1(_068_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_069_));
 sky130_fd_sc_hd__a22o_2 _442_ (.A1(_293_),
    .A2(_045_),
    .B1(_069_),
    .B2(_210_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[4]));
 sky130_fd_sc_hd__nand2_2 _443_ (.A(net33),
    .B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_070_));
 sky130_fd_sc_hd__nand2_2 _444_ (.A(net17),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_071_));
 sky130_fd_sc_hd__nand2_2 _445_ (.A(net19),
    .B(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_072_));
 sky130_fd_sc_hd__o21ai_2 _446_ (.A1(_047_),
    .A2(_052_),
    .B1(_050_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_073_));
 sky130_fd_sc_hd__xor2_2 _447_ (.A(_072_),
    .B(_073_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_074_));
 sky130_fd_sc_hd__nor2_2 _448_ (.A(_071_),
    .B(_074_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_075_));
 sky130_fd_sc_hd__xnor2_2 _449_ (.A(_071_),
    .B(_074_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_076_));
 sky130_fd_sc_hd__and2_2 _450_ (.A(net20),
    .B(net28),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_077_));
 sky130_fd_sc_hd__a21bo_2 _451_ (.A1(_053_),
    .A2(_056_),
    .B1_N(_055_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_078_));
 sky130_fd_sc_hd__nand2_2 _452_ (.A(_077_),
    .B(_078_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_079_));
 sky130_fd_sc_hd__xnor2_2 _453_ (.A(_077_),
    .B(_078_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_080_));
 sky130_fd_sc_hd__xnor2_2 _454_ (.A(_076_),
    .B(_080_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_081_));
 sky130_fd_sc_hd__nand2_2 _455_ (.A(net22),
    .B(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_082_));
 sky130_fd_sc_hd__o2bb2a_2 _456_ (.A1_N(net25),
    .A2_N(_036_),
    .B1(_058_),
    .B2(_060_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_083_));
 sky130_fd_sc_hd__nor2_2 _457_ (.A(_082_),
    .B(_083_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_084_));
 sky130_fd_sc_hd__xnor2_2 _458_ (.A(_082_),
    .B(_083_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_085_));
 sky130_fd_sc_hd__xor2_2 _459_ (.A(_081_),
    .B(_085_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_086_));
 sky130_fd_sc_hd__nand2_2 _460_ (.A(net25),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_087_));
 sky130_fd_sc_hd__nand2b_2 _461_ (.A_N(_062_),
    .B(_087_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_088_));
 sky130_fd_sc_hd__mux2_1 _462_ (.A0(_087_),
    .A1(net25),
    .S(_062_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_089_));
 sky130_fd_sc_hd__xor2_2 _463_ (.A(_086_),
    .B(_089_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_090_));
 sky130_fd_sc_hd__nor2_2 _464_ (.A(_070_),
    .B(_090_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_091_));
 sky130_fd_sc_hd__inv_2 _465_ (.A(_091_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_092_));
 sky130_fd_sc_hd__or2_2 _466_ (.A(_025_),
    .B(_087_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_093_));
 sky130_fd_sc_hd__nand2_2 _467_ (.A(net18),
    .B(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_094_));
 sky130_fd_sc_hd__nor2_2 _468_ (.A(_047_),
    .B(_094_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_095_));
 sky130_fd_sc_hd__xor2_2 _469_ (.A(_071_),
    .B(_072_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_096_));
 sky130_fd_sc_hd__nor2_2 _470_ (.A(_077_),
    .B(_096_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_097_));
 sky130_fd_sc_hd__and2_2 _471_ (.A(_077_),
    .B(_096_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_098_));
 sky130_fd_sc_hd__nor2_2 _472_ (.A(_097_),
    .B(_098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_099_));
 sky130_fd_sc_hd__nand2_2 _473_ (.A(_047_),
    .B(_048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_100_));
 sky130_fd_sc_hd__o21ai_2 _474_ (.A1(_027_),
    .A2(_072_),
    .B1(_100_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_101_));
 sky130_fd_sc_hd__a2bb2o_2 _475_ (.A1_N(_027_),
    .A2_N(_072_),
    .B1(_100_),
    .B2(_242_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_102_));
 sky130_fd_sc_hd__xor2_2 _476_ (.A(_099_),
    .B(_102_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_103_));
 sky130_fd_sc_hd__nand2_2 _477_ (.A(net22),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_104_));
 sky130_fd_sc_hd__nor2_2 _478_ (.A(_059_),
    .B(_104_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_105_));
 sky130_fd_sc_hd__a21o_2 _479_ (.A1(_082_),
    .A2(_087_),
    .B1(_105_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_106_));
 sky130_fd_sc_hd__xor2_2 _480_ (.A(_070_),
    .B(_106_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_107_));
 sky130_fd_sc_hd__and2_2 _481_ (.A(_103_),
    .B(_107_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_108_));
 sky130_fd_sc_hd__nor2_2 _482_ (.A(_103_),
    .B(_107_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_109_));
 sky130_fd_sc_hd__or2_2 _483_ (.A(_108_),
    .B(_109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_110_));
 sky130_fd_sc_hd__xnor2_2 _484_ (.A(_242_),
    .B(_101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_111_));
 sky130_fd_sc_hd__or2_2 _485_ (.A(_014_),
    .B(_048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_112_));
 sky130_fd_sc_hd__nand2_2 _486_ (.A(_027_),
    .B(_028_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_113_));
 sky130_fd_sc_hd__and4_2 _487_ (.A(net23),
    .B(net29),
    .C(_112_),
    .D(_113_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_114_));
 sky130_fd_sc_hd__a31o_2 _488_ (.A1(net21),
    .A2(net32),
    .A3(_013_),
    .B1(_114_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_115_));
 sky130_fd_sc_hd__nand2_2 _489_ (.A(_111_),
    .B(_115_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_116_));
 sky130_fd_sc_hd__xor2_2 _490_ (.A(_111_),
    .B(_115_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_117_));
 sky130_fd_sc_hd__xor2_2 _491_ (.A(_046_),
    .B(_059_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_118_));
 sky130_fd_sc_hd__a21bo_2 _492_ (.A1(_117_),
    .A2(_118_),
    .B1_N(_116_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_119_));
 sky130_fd_sc_hd__and2b_2 _493_ (.A_N(_110_),
    .B(_119_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_120_));
 sky130_fd_sc_hd__xor2_2 _494_ (.A(_110_),
    .B(_119_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_121_));
 sky130_fd_sc_hd__nor2_2 _495_ (.A(_093_),
    .B(_121_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_122_));
 sky130_fd_sc_hd__xnor2_2 _496_ (.A(_093_),
    .B(_121_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_123_));
 sky130_fd_sc_hd__nor2_2 _497_ (.A(_117_),
    .B(_118_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_124_));
 sky130_fd_sc_hd__nor2_2 _498_ (.A(_237_),
    .B(_013_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_125_));
 sky130_fd_sc_hd__a22o_2 _499_ (.A1(net23),
    .A2(net29),
    .B1(_112_),
    .B2(_113_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_126_));
 sky130_fd_sc_hd__nand2b_2 _500_ (.A_N(_114_),
    .B(_126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_127_));
 sky130_fd_sc_hd__a221o_2 _501_ (.A1(_012_),
    .A2(_049_),
    .B1(_127_),
    .B2(_025_),
    .C1(_125_),
    ...
    .VPWR(VPWR),
    .X(_128_));
 sky130_fd_sc_hd__or2_2 _502_ (.A(_025_),
    .B(_127_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_129_));
 sky130_fd_sc_hd__a221o_2 _503_ (.A1(_117_),
    .A2(_118_),
    .B1(_128_),
    .B2(_129_),
    .C1(_124_),
    ...
    .VPWR(VPWR),
    .X(_130_));
 sky130_fd_sc_hd__and2_2 _504_ (.A(_123_),
    .B(_130_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_131_));
 sky130_fd_sc_hd__nor2_2 _505_ (.A(_123_),
    .B(_130_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_132_));
 sky130_fd_sc_hd__or2_2 _506_ (.A(_131_),
    .B(_132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_133_));
 sky130_fd_sc_hd__or4b_2 _507_ (.A(_287_),
    .B(_038_),
    .C(_064_),
    .D_N(_244_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_134_));
 sky130_fd_sc_hd__nor2_2 _508_ (.A(_133_),
    .B(_134_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_135_));
 sky130_fd_sc_hd__and2_2 _509_ (.A(_133_),
    .B(_134_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_136_));
 sky130_fd_sc_hd__or2_2 _510_ (.A(_135_),
    .B(_136_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_137_));
 sky130_fd_sc_hd__or3_2 _511_ (.A(net26),
    .B(_252_),
    .C(_137_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_138_));
 sky130_fd_sc_hd__a21oi_2 _512_ (.A1(net5),
    .A2(net13),
    .B1(_044_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_139_));
 sky130_fd_sc_hd__a21oi_2 _513_ (.A1(_156_),
    .A2(_178_),
    .B1(_139_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_140_));
 sky130_fd_sc_hd__xnor2_2 _514_ (.A(_248_),
    .B(_140_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_141_));
 sky130_fd_sc_hd__a41o_2 _515_ (.A1(net26),
    .A2(net6),
    .A3(net14),
    .A4(_189_),
    .B1(_285_),
    ...
    .VPWR(VPWR),
    .X(_142_));
 sky130_fd_sc_hd__mux4_2 _516_ (.A0(net6),
    .A1(net21),
    .A2(net5),
    .A3(net22),
    .S0(net30),
    ...
    .VPWR(VPWR),
    .X(_143_));
 sky130_fd_sc_hd__nand2_2 _517_ (.A(net29),
    .B(_289_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_144_));
 sky130_fd_sc_hd__o211a_2 _518_ (.A1(net29),
    .A2(_143_),
    .B1(_144_),
    .C1(_260_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_145_));
 sky130_fd_sc_hd__a2bb2o_2 _519_ (.A1_N(_255_),
    .A2_N(_137_),
    .B1(_141_),
    .B2(_293_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_147_));
 sky130_fd_sc_hd__or4b_2 _520_ (.A(_142_),
    .B(_145_),
    .C(_147_),
    .D_N(_138_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[5]));
 sky130_fd_sc_hd__o21bai_2 _521_ (.A1(_070_),
    .A2(_106_),
    .B1_N(_105_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_148_));
 sky130_fd_sc_hd__nand2_2 _522_ (.A(net22),
    .B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_149_));
 sky130_fd_sc_hd__nand2_2 _523_ (.A(net25),
    .B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_150_));
 sky130_fd_sc_hd__or2_2 _524_ (.A(_087_),
    .B(_149_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_151_));
 sky130_fd_sc_hd__nand2_2 _525_ (.A(_104_),
    .B(_150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_152_));
 sky130_fd_sc_hd__and2_2 _526_ (.A(_151_),
    .B(_152_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_153_));
 sky130_fd_sc_hd__nand2_2 _527_ (.A(net19),
    .B(net28),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_154_));
 sky130_fd_sc_hd__and2_2 _528_ (.A(_094_),
    .B(_154_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_155_));
 sky130_fd_sc_hd__nand2_2 _529_ (.A(net18),
    .B(net28),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_157_));
 sky130_fd_sc_hd__o21ba_2 _530_ (.A1(_072_),
    .A2(_157_),
    .B1_N(_155_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_158_));
 sky130_fd_sc_hd__xnor2_2 _531_ (.A(_232_),
    .B(_158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_159_));
 sky130_fd_sc_hd__o21a_2 _532_ (.A1(_095_),
    .A2(_098_),
    .B1(_159_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_160_));
 sky130_fd_sc_hd__nor3_2 _533_ (.A(_095_),
    .B(_098_),
    .C(_159_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_161_));
 sky130_fd_sc_hd__nor2_2 _534_ (.A(_160_),
    .B(_161_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_162_));
 sky130_fd_sc_hd__xnor2_2 _535_ (.A(_153_),
    .B(_162_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_163_));
 sky130_fd_sc_hd__a21oi_2 _536_ (.A1(_099_),
    .A2(_102_),
    .B1(_108_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_164_));
 sky130_fd_sc_hd__xnor2_2 _537_ (.A(_163_),
    .B(_164_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_165_));
 sky130_fd_sc_hd__and2b_2 _538_ (.A_N(_165_),
    .B(_148_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_166_));
 sky130_fd_sc_hd__xnor2_2 _539_ (.A(_148_),
    .B(_165_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_168_));
 sky130_fd_sc_hd__o21a_2 _540_ (.A1(_120_),
    .A2(_122_),
    .B1(_168_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_169_));
 sky130_fd_sc_hd__nor3_2 _541_ (.A(_120_),
    .B(_122_),
    .C(_168_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_170_));
 sky130_fd_sc_hd__nor2_2 _542_ (.A(_169_),
    .B(_170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_171_));
 sky130_fd_sc_hd__o21a_2 _543_ (.A1(_132_),
    .A2(_135_),
    .B1(_171_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_172_));
 sky130_fd_sc_hd__o31ai_2 _544_ (.A1(_132_),
    .A2(_135_),
    .A3(_171_),
    .B1(_253_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_173_));
 sky130_fd_sc_hd__nand2b_2 _545_ (.A_N(_091_),
    .B(_150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_174_));
 sky130_fd_sc_hd__mux2_1 _546_ (.A0(_150_),
    .A1(net25),
    .S(_091_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_175_));
 sky130_fd_sc_hd__a31o_2 _547_ (.A1(net19),
    .A2(net32),
    .A3(_073_),
    .B1(_075_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_176_));
 sky130_fd_sc_hd__and3_2 _548_ (.A(net18),
    .B(net32),
    .C(_176_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_177_));
 sky130_fd_sc_hd__xnor2_2 _549_ (.A(_094_),
    .B(_176_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_179_));
 sky130_fd_sc_hd__o21ai_2 _550_ (.A1(_076_),
    .A2(_080_),
    .B1(_079_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_180_));
 sky130_fd_sc_hd__nand2b_2 _551_ (.A_N(_154_),
    .B(_180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_181_));
 sky130_fd_sc_hd__xnor2_2 _552_ (.A(_154_),
    .B(_180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_182_));
 sky130_fd_sc_hd__xor2_2 _553_ (.A(_179_),
    .B(_182_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_183_));
 sky130_fd_sc_hd__o21bai_2 _554_ (.A1(_081_),
    .A2(_085_),
    .B1_N(_084_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_184_));
 sky130_fd_sc_hd__and3_2 _555_ (.A(net20),
    .B(net27),
    .C(_184_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_185_));
 sky130_fd_sc_hd__nand2b_2 _556_ (.A_N(_184_),
    .B(_232_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_186_));
 sky130_fd_sc_hd__xor2_2 _557_ (.A(_232_),
    .B(_184_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_187_));
 sky130_fd_sc_hd__xnor2_2 _558_ (.A(_183_),
    .B(_187_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_188_));
 sky130_fd_sc_hd__a22o_2 _559_ (.A1(net25),
    .A2(_062_),
    .B1(_086_),
    .B2(_088_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_190_));
 sky130_fd_sc_hd__nand2b_2 _560_ (.A_N(_104_),
    .B(_190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_191_));
 sky130_fd_sc_hd__xnor2_2 _561_ (.A(_104_),
    .B(_190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_192_));
 sky130_fd_sc_hd__xor2_2 _562_ (.A(_188_),
    .B(_192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_193_));
 sky130_fd_sc_hd__xnor2_2 _563_ (.A(_092_),
    .B(_193_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_194_));
 sky130_fd_sc_hd__xnor2_2 _564_ (.A(_175_),
    .B(_194_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_195_));
 sky130_fd_sc_hd__a2bb2o_2 _565_ (.A1_N(_172_),
    .A2_N(_173_),
    .B1(_195_),
    .B2(_254_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[6]));
 sky130_fd_sc_hd__a21o_2 _566_ (.A1(_183_),
    .A2(_186_),
    .B1(_185_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_196_));
 sky130_fd_sc_hd__a21bo_2 _567_ (.A1(_179_),
    .A2(_182_),
    .B1_N(_181_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_197_));
 sky130_fd_sc_hd__mux2_1 _568_ (.A0(_157_),
    .A1(net28),
    .S(_177_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_198_));
 sky130_fd_sc_hd__xnor2_2 _569_ (.A(_197_),
    .B(_198_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_200_));
 sky130_fd_sc_hd__xnor2_2 _570_ (.A(_196_),
    .B(_200_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_201_));
 sky130_fd_sc_hd__nand2_2 _571_ (.A(net19),
    .B(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_202_));
 sky130_fd_sc_hd__xnor2_2 _572_ (.A(_149_),
    .B(_202_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_203_));
 sky130_fd_sc_hd__xnor2_2 _573_ (.A(_201_),
    .B(_203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_204_));
 sky130_fd_sc_hd__nand2_2 _574_ (.A(net20),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_205_));
 sky130_fd_sc_hd__a21bo_2 _575_ (.A1(_188_),
    .A2(_192_),
    .B1_N(_191_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_206_));
 sky130_fd_sc_hd__xnor2_2 _576_ (.A(_205_),
    .B(_206_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_207_));
 sky130_fd_sc_hd__mux2_1 _577_ (.A0(_092_),
    .A1(_175_),
    .S(_193_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_208_));
 sky130_fd_sc_hd__a22o_2 _578_ (.A1(net25),
    .A2(_091_),
    .B1(_174_),
    .B2(_193_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_209_));
 sky130_fd_sc_hd__xnor2_2 _579_ (.A(_204_),
    .B(_208_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_211_));
 sky130_fd_sc_hd__xnor2_2 _580_ (.A(_207_),
    .B(_209_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_212_));
 sky130_fd_sc_hd__or2_2 _581_ (.A(_211_),
    .B(_212_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_213_));
 sky130_fd_sc_hd__a21oi_2 _582_ (.A1(_211_),
    .A2(_212_),
    .B1(_255_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_214_));
 sky130_fd_sc_hd__nor2_2 _583_ (.A(_169_),
    .B(_172_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_215_));
 sky130_fd_sc_hd__o21bai_2 _584_ (.A1(_163_),
    .A2(_164_),
    .B1_N(_166_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_216_));
 sky130_fd_sc_hd__a21o_2 _585_ (.A1(_153_),
    .A2(_162_),
    .B1(_160_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_217_));
 sky130_fd_sc_hd__o22a_2 _586_ (.A1(_232_),
    .A2(_155_),
    .B1(_157_),
    .B2(_072_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_218_));
 sky130_fd_sc_hd__xnor2_2 _587_ (.A(_157_),
    .B(_202_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_219_));
 sky130_fd_sc_hd__xnor2_2 _588_ (.A(_149_),
    .B(_205_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_220_));
 sky130_fd_sc_hd__xnor2_2 _589_ (.A(_219_),
    .B(_220_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_222_));
 sky130_fd_sc_hd__xnor2_2 _590_ (.A(_218_),
    .B(_222_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_223_));
 sky130_fd_sc_hd__xnor2_2 _591_ (.A(_217_),
    .B(_223_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_224_));
 sky130_fd_sc_hd__xnor2_2 _592_ (.A(_151_),
    .B(_224_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_225_));
 sky130_fd_sc_hd__xor2_2 _593_ (.A(_216_),
    .B(_225_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_226_));
 sky130_fd_sc_hd__xnor2_2 _594_ (.A(_215_),
    .B(_226_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_227_));
 sky130_fd_sc_hd__a22o_2 _595_ (.A1(_213_),
    .A2(_214_),
    .B1(_227_),
    .B2(_253_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout19 (.A(net5),
    ...
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout25 (.A(net2),
    ...
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout26 (.A(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout31 (.A(net32),
    ...
    .VPWR(VPWR),
    .X(net31));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout32 (.A(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input9 (.A(uio_in[0]),
    ...
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__clkbuf_2 max_cap18 (.A(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__buf_2 max_cap27 (.A(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net27));
 sky130_fd_sc_hd__conb_1 tt_um_alu_bns (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_alu_bns_35 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net35));
 sky130_fd_sc_hd__conb_1 tt_um_alu_bns_36 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net36));
 sky130_fd_sc_hd__conb_1 tt_um_alu_bns_37 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net37));
 sky130_fd_sc_hd__conb_1 tt_um_alu_bns_38 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net38));
 sky130_fd_sc_hd__conb_1 tt_um_alu_bns_39 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net39));
 sky130_fd_sc_hd__conb_1 tt_um_alu_bns_40 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net40));
 sky130_fd_sc_hd__conb_1 tt_um_alu_bns_41 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net41));
 sky130_fd_sc_hd__conb_1 tt_um_alu_bns_42 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net42));
 sky130_fd_sc_hd__conb_1 tt_um_alu_bns_43 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net43));
 sky130_fd_sc_hd__conb_1 tt_um_alu_bns_44 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net44));
 sky130_fd_sc_hd__conb_1 tt_um_alu_bns_45 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net45));
 sky130_fd_sc_hd__conb_1 tt_um_alu_bns_46 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net46));
 sky130_fd_sc_hd__conb_1 tt_um_alu_bns_47 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net47));
 sky130_fd_sc_hd__conb_1 tt_um_alu_bns_48 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net48));
 sky130_fd_sc_hd__conb_1 tt_um_alu_bns_49 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net49));
