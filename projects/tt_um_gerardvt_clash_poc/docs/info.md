...
The design is authored in [Clash HDL](https://clash-lang.org) — a Haskell-based hardware description language — and compiled to Verilog via `cabal exec clash` before synthesis.
