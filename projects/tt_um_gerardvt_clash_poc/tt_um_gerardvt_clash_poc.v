module tt_um_gerardvt_clash_poc (clk,
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA_1 (.DIODE(_0497_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _0517_ (.A(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0491_));
 sky130_fd_sc_hd__inv_2 _0518_ (.A(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0492_));
 sky130_fd_sc_hd__inv_2 _0519_ (.A(\t[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0493_));
 sky130_fd_sc_hd__inv_2 _0520_ (.A(\vCount1[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0494_));
 sky130_fd_sc_hd__inv_2 _0521_ (.A(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0495_));
 sky130_fd_sc_hd__inv_2 _0522_ (.A(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0496_));
 sky130_fd_sc_hd__inv_2 _0523_ (.A(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0497_));
 sky130_fd_sc_hd__o21a_2 _0524_ (.A1(\hCount1[7] ),
    .A2(\hCount1[8] ),
    .B1(\hCount1[9] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0498_));
 sky130_fd_sc_hd__and4_2 _0525_ (.A(\vCount1[5] ),
    .B(\vCount1[7] ),
    .C(\vCount1[6] ),
    .D(\vCount1[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0499_));
 sky130_fd_sc_hd__or3_2 _0526_ (.A(\vCount1[9] ),
    .B(_0498_),
    .C(_0499_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0500_));
 sky130_fd_sc_hd__nor2_2 _0527_ (.A(net36),
    .B(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0501_));
 sky130_fd_sc_hd__or2_2 _0528_ (.A(net36),
    .B(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0502_));
 sky130_fd_sc_hd__nor2_2 _0529_ (.A(\hCount1[8] ),
    .B(\vCount1[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0503_));
 sky130_fd_sc_hd__nand2_2 _0530_ (.A(\hCount1[8] ),
    .B(\vCount1[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0504_));
 sky130_fd_sc_hd__and2b_2 _0531_ (.A_N(_0503_),
    .B(_0504_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0505_));
 sky130_fd_sc_hd__xor2_2 _0532_ (.A(\hCount1[7] ),
    .B(\vCount1[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0506_));
 sky130_fd_sc_hd__and2_2 _0533_ (.A(net31),
    .B(\vCount1[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0507_));
 sky130_fd_sc_hd__nor2_2 _0534_ (.A(net31),
    .B(\vCount1[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0508_));
 sky130_fd_sc_hd__nor2_2 _0535_ (.A(_0507_),
    .B(_0508_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0509_));
 sky130_fd_sc_hd__nand2_2 _0536_ (.A(\hCount1[5] ),
    .B(\vCount1[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0510_));
 sky130_fd_sc_hd__or2_2 _0537_ (.A(\hCount1[5] ),
    .B(\vCount1[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0511_));
 sky130_fd_sc_hd__and2_2 _0538_ (.A(_0510_),
    .B(_0511_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0512_));
 sky130_fd_sc_hd__and2_2 _0539_ (.A(\hCount1[4] ),
    .B(\vCount1[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0513_));
 sky130_fd_sc_hd__nor2_2 _0540_ (.A(\hCount1[4] ),
    .B(\vCount1[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0514_));
 sky130_fd_sc_hd__nor2_2 _0541_ (.A(_0513_),
    .B(_0514_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0515_));
 sky130_fd_sc_hd__and2_2 _0542_ (.A(\hCount1[3] ),
    .B(\vCount1[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0516_));
 sky130_fd_sc_hd__or2_2 _0543_ (.A(\hCount1[3] ),
    .B(\vCount1[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0028_));
 sky130_fd_sc_hd__xor2_2 _0544_ (.A(\hCount1[2] ),
    .B(\vCount1[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0029_));
 sky130_fd_sc_hd__or2_4 _0545_ (.A(\hCount1[1] ),
    .B(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0030_));
 sky130_fd_sc_hd__nand2_2 _0546_ (.A(\hCount1[1] ),
    .B(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0031_));
 sky130_fd_sc_hd__a22o_2 _0547_ (.A1(\hCount1[0] ),
    .A2(\vCount1[0] ),
    .B1(net30),
    .B2(\hCount1[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0032_));
 sky130_fd_sc_hd__and2_2 _0548_ (.A(_0030_),
    .B(_0032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0033_));
 sky130_fd_sc_hd__a32o_2 _0549_ (.A1(_0029_),
    .A2(_0032_),
    .A3(_0030_),
    .B1(\vCount1[2] ),
    .B2(\hCount1[2] ),
    ...
    .VPWR(VPWR),
    .X(_0034_));
 sky130_fd_sc_hd__o21ai_2 _0550_ (.A1(_0516_),
    .A2(net62),
    .B1(_0028_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0035_));
 sky130_fd_sc_hd__o211a_2 _0551_ (.A1(_0516_),
    .A2(_0034_),
    .B1(_0028_),
    .C1(_0515_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0036_));
 sky130_fd_sc_hd__o21ai_2 _0552_ (.A1(_0513_),
    .A2(_0036_),
    .B1(_0512_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0037_));
 sky130_fd_sc_hd__a21boi_2 _0553_ (.A1(_0510_),
    .A2(_0037_),
    .B1_N(_0509_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0038_));
 sky130_fd_sc_hd__o21a_2 _0554_ (.A1(_0507_),
    .A2(_0038_),
    .B1(_0506_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0039_));
 sky130_fd_sc_hd__a21oi_2 _0555_ (.A1(\hCount1[7] ),
    .A2(\vCount1[7] ),
    .B1(_0039_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0040_));
 sky130_fd_sc_hd__xnor2_2 _0556_ (.A(_0505_),
    .B(_0040_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0041_));
 sky130_fd_sc_hd__and2_2 _0557_ (.A(\t[6] ),
    .B(_0041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0042_));
 sky130_fd_sc_hd__xnor2_2 _0558_ (.A(_0493_),
    .B(_0041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0043_));
 sky130_fd_sc_hd__or3_2 _0559_ (.A(_0506_),
    .B(_0507_),
    .C(_0038_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0044_));
 sky130_fd_sc_hd__and2b_2 _0560_ (.A_N(_0039_),
    .B(_0044_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0045_));
 sky130_fd_sc_hd__and2_2 _0561_ (.A(net20),
    .B(_0045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0046_));
 sky130_fd_sc_hd__and3b_2 _0562_ (.A_N(_0509_),
    .B(_0510_),
    .C(_0037_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0047_));
 sky130_fd_sc_hd__nor2_2 _0563_ (.A(_0038_),
    .B(_0047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0048_));
 sky130_fd_sc_hd__and2_2 _0564_ (.A(net22),
    .B(_0048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0049_));
 sky130_fd_sc_hd__or3_2 _0565_ (.A(_0512_),
    .B(_0513_),
    .C(_0036_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0050_));
 sky130_fd_sc_hd__and2_4 _0566_ (.A(_0037_),
    .B(_0050_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0051_));
 sky130_fd_sc_hd__and3_2 _0567_ (.A(net23),
    .B(_0037_),
    .C(_0050_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0052_));
 sky130_fd_sc_hd__or2_2 _0568_ (.A(net23),
    .B(_0051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0053_));
 sky130_fd_sc_hd__xnor2_2 _0569_ (.A(net23),
    .B(_0051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0054_));
 sky130_fd_sc_hd__xnor2_2 _0570_ (.A(_0515_),
    .B(_0035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0055_));
 sky130_fd_sc_hd__and2_2 _0571_ (.A(net25),
    .B(_0055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0056_));
 sky130_fd_sc_hd__and2b_2 _0572_ (.A_N(_0516_),
    .B(_0028_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0057_));
 sky130_fd_sc_hd__xor2_2 _0573_ (.A(net62),
    .B(_0057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0058_));
 sky130_fd_sc_hd__nand2_2 _0574_ (.A(net27),
    .B(_0058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0059_));
 sky130_fd_sc_hd__or2_4 _0575_ (.A(net27),
    .B(_0058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0060_));
 sky130_fd_sc_hd__xor2_2 _0576_ (.A(_0029_),
    .B(_0033_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0061_));
 sky130_fd_sc_hd__and2_2 _0577_ (.A(net28),
    .B(_0061_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0062_));
 sky130_fd_sc_hd__a21bo_2 _0578_ (.A1(_0060_),
    .A2(_0062_),
    .B1_N(_0059_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0063_));
 sky130_fd_sc_hd__or2_2 _0579_ (.A(net25),
    .B(_0055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0064_));
 sky130_fd_sc_hd__xnor2_2 _0580_ (.A(net25),
    .B(_0055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0065_));
 sky130_fd_sc_hd__a21o_2 _0581_ (.A1(_0063_),
    .A2(_0064_),
    .B1(_0056_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0066_));
 sky130_fd_sc_hd__a21o_4 _0582_ (.A1(_0053_),
    .A2(_0066_),
    .B1(_0052_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0067_));
 sky130_fd_sc_hd__or2_2 _0583_ (.A(net22),
    .B(_0048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0068_));
 sky130_fd_sc_hd__xnor2_2 _0584_ (.A(net22),
    .B(_0048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0069_));
 sky130_fd_sc_hd__a21o_2 _0585_ (.A1(_0067_),
    .A2(_0068_),
    .B1(_0049_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0070_));
 sky130_fd_sc_hd__or2_2 _0586_ (.A(net20),
    .B(_0045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0071_));
 sky130_fd_sc_hd__xnor2_2 _0587_ (.A(net20),
    .B(_0045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0072_));
 sky130_fd_sc_hd__a21o_4 _0588_ (.A1(_0070_),
    .A2(_0071_),
    .B1(_0046_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0073_));
 sky130_fd_sc_hd__a21o_2 _0589_ (.A1(_0043_),
    .A2(_0073_),
    .B1(_0042_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0074_));
 sky130_fd_sc_hd__o21a_2 _0590_ (.A1(_0503_),
    .A2(_0040_),
    .B1(_0504_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0075_));
 sky130_fd_sc_hd__xnor2_2 _0591_ (.A(\hCount1[9] ),
    .B(\vCount1[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0076_));
 sky130_fd_sc_hd__xnor2_2 _0592_ (.A(\t[7] ),
    .B(_0076_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0077_));
 sky130_fd_sc_hd__xnor2_2 _0593_ (.A(_0075_),
    .B(_0077_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0078_));
 sky130_fd_sc_hd__xnor2_4 _0594_ (.A(_0078_),
    .B(_0074_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0079_));
 sky130_fd_sc_hd__and2_2 _0595_ (.A(\t[6] ),
    .B(\vCount1[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0080_));
 sky130_fd_sc_hd__nor2_2 _0596_ (.A(\t[6] ),
    .B(\vCount1[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0081_));
 sky130_fd_sc_hd__nor2_2 _0597_ (.A(_0080_),
    .B(_0081_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0082_));
 sky130_fd_sc_hd__nand2_2 _0598_ (.A(net20),
    .B(\vCount1[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0083_));
 sky130_fd_sc_hd__and2_2 _0599_ (.A(net22),
    .B(\vCount1[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0084_));
 sky130_fd_sc_hd__nor2_2 _0600_ (.A(net22),
    .B(\vCount1[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0085_));
 sky130_fd_sc_hd__nand2_2 _0601_ (.A(net23),
    .B(\vCount1[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0086_));
 sky130_fd_sc_hd__nand2_2 _0602_ (.A(net25),
    .B(\vCount1[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_2 _0603_ (.A(net25),
    ...
    .VPWR(VPWR),
    .X(_0088_));
 sky130_fd_sc_hd__nand2_2 _0604_ (.A(_0087_),
    .B(_0088_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0089_));
 sky130_fd_sc_hd__and2_2 _0605_ (.A(net27),
    .B(\vCount1[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0090_));
 sky130_fd_sc_hd__nor2_2 _0606_ (.A(net27),
    .B(\vCount1[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0091_));
 sky130_fd_sc_hd__and4bb_2 _0607_ (.A_N(_0090_),
    .B_N(_0091_),
    .C(net28),
    .D(net61),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0092_));
 sky130_fd_sc_hd__or2_2 _0608_ (.A(_0090_),
    .B(_0092_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0093_));
 sky130_fd_sc_hd__a21bo_2 _0609_ (.A1(_0088_),
    .A2(_0093_),
    .B1_N(_0087_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0094_));
 sky130_fd_sc_hd__or2_2 _0610_ (.A(net24),
    .B(\vCount1[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0095_));
 sky130_fd_sc_hd__nand2_2 _0611_ (.A(_0086_),
    .B(_0095_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0096_));
 sky130_fd_sc_hd__nand2b_2 _0612_ (.A_N(_0096_),
    .B(_0094_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0097_));
 sky130_fd_sc_hd__a211oi_2 _0613_ (.A1(_0086_),
    .A2(_0097_),
    .B1(_0084_),
    .C1(_0085_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0098_));
 sky130_fd_sc_hd__or2_2 _0614_ (.A(net20),
    .B(\vCount1[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0099_));
 sky130_fd_sc_hd__o211a_2 _0615_ (.A1(_0084_),
    .A2(_0098_),
    .B1(_0099_),
    .C1(_0083_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0100_));
 sky130_fd_sc_hd__a21oi_2 _0616_ (.A1(net20),
    .A2(\vCount1[6] ),
    .B1(_0100_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0101_));
 sky130_fd_sc_hd__o21bai_2 _0617_ (.A1(_0081_),
    .A2(_0101_),
    .B1_N(_0080_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0102_));
 sky130_fd_sc_hd__xor2_2 _0618_ (.A(\t[7] ),
    .B(\vCount1[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0103_));
 sky130_fd_sc_hd__nand2_2 _0619_ (.A(_0102_),
    .B(_0103_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0104_));
 sky130_fd_sc_hd__o21a_2 _0620_ (.A1(_0102_),
    .A2(_0103_),
    .B1(_0497_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0105_));
 sky130_fd_sc_hd__a22o_4 _0621_ (.A1(net34),
    .A2(_0079_),
    .B1(_0104_),
    .B2(_0105_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0106_));
 sky130_fd_sc_hd__xnor2_2 _0622_ (.A(_0043_),
    .B(_0073_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0107_));
 sky130_fd_sc_hd__nand2_2 _0623_ (.A(net34),
    .B(_0107_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0108_));
 sky130_fd_sc_hd__xnor2_2 _0624_ (.A(_0082_),
    .B(_0101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0109_));
 sky130_fd_sc_hd__o21ai_2 _0625_ (.A1(net34),
    .A2(_0109_),
    .B1(_0108_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0110_));
 sky130_fd_sc_hd__xnor2_2 _0626_ (.A(_0106_),
    .B(_0110_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0111_));
 sky130_fd_sc_hd__inv_2 _0627_ (.A(_0111_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0112_));
 sky130_fd_sc_hd__xnor2_2 _0628_ (.A(_0070_),
    .B(_0072_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0113_));
 sky130_fd_sc_hd__and2_2 _0629_ (.A(net20),
    .B(_0113_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0114_));
 sky130_fd_sc_hd__xnor2_2 _0630_ (.A(_0067_),
    .B(_0069_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0115_));
 sky130_fd_sc_hd__and2_2 _0631_ (.A(net22),
    .B(_0115_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0116_));
 sky130_fd_sc_hd__xor2_2 _0632_ (.A(_0048_),
    .B(_0067_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0117_));
 sky130_fd_sc_hd__xnor2_2 _0633_ (.A(_0054_),
    .B(_0066_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0118_));
 sky130_fd_sc_hd__nand2_2 _0634_ (.A(net23),
    .B(_0118_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0119_));
 sky130_fd_sc_hd__xnor2_2 _0635_ (.A(_0063_),
    .B(_0065_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0120_));
 sky130_fd_sc_hd__xnor2_2 _0636_ (.A(net25),
    .B(_0120_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0121_));
 sky130_fd_sc_hd__mux2_1 _0637_ (.A0(net27),
    .A1(net28),
    .S(_0058_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0122_));
 sky130_fd_sc_hd__a21bo_2 _0638_ (.A1(_0059_),
    .A2(_0062_),
    .B1_N(_0122_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0123_));
 sky130_fd_sc_hd__o2bb2ai_2 _0639_ (.A1_N(net25),
    .A2_N(_0120_),
    .B1(_0121_),
    .B2(_0123_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0124_));
 sky130_fd_sc_hd__or2_2 _0640_ (.A(net23),
    .B(_0118_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0125_));
 sky130_fd_sc_hd__nand2_2 _0641_ (.A(_0119_),
    .B(_0125_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0126_));
 sky130_fd_sc_hd__a21bo_2 _0642_ (.A1(_0124_),
    .A2(_0125_),
    .B1_N(_0119_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0127_));
 sky130_fd_sc_hd__a21o_2 _0643_ (.A1(_0117_),
    .A2(_0127_),
    .B1(_0116_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0128_));
 sky130_fd_sc_hd__or2_4 _0644_ (.A(net20),
    .B(_0113_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0129_));
 sky130_fd_sc_hd__nand2b_2 _0645_ (.A_N(_0114_),
    .B(_0129_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0130_));
 sky130_fd_sc_hd__a21o_4 _0646_ (.A1(_0128_),
    .A2(_0129_),
    .B1(_0114_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0131_));
 sky130_fd_sc_hd__nor2_2 _0647_ (.A(_0493_),
    .B(_0107_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0132_));
 sky130_fd_sc_hd__xor2_2 _0648_ (.A(_0041_),
    .B(_0073_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0133_));
 sky130_fd_sc_hd__xnor2_2 _0649_ (.A(_0131_),
    .B(_0133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0134_));
 sky130_fd_sc_hd__a21o_4 _0650_ (.A1(_0131_),
    .A2(_0133_),
    .B1(_0132_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0135_));
 sky130_fd_sc_hd__xnor2_4 _0651_ (.A(\t[7] ),
    .B(_0079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0136_));
 sky130_fd_sc_hd__xnor2_4 _0652_ (.A(_0136_),
    .B(_0135_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0137_));
 sky130_fd_sc_hd__xnor2_2 _0653_ (.A(_0134_),
    .B(_0137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0138_));
 sky130_fd_sc_hd__nor2_2 _0654_ (.A(_0112_),
    .B(_0138_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0139_));
 sky130_fd_sc_hd__or2_2 _0655_ (.A(_0112_),
    .B(_0138_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0140_));
 sky130_fd_sc_hd__and2_2 _0656_ (.A(_0112_),
    .B(_0138_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0141_));
 sky130_fd_sc_hd__nor2_2 _0657_ (.A(_0139_),
    .B(_0141_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0142_));
 sky130_fd_sc_hd__nand2_2 _0658_ (.A(\t[6] ),
    .B(\hCount1[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0143_));
 sky130_fd_sc_hd__or2_2 _0659_ (.A(\t[6] ),
    .B(\hCount1[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0144_));
 sky130_fd_sc_hd__nand2_2 _0660_ (.A(_0143_),
    .B(_0144_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0145_));
 sky130_fd_sc_hd__nand2_2 _0661_ (.A(net21),
    .B(net31),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0146_));
 sky130_fd_sc_hd__and2_2 _0662_ (.A(net22),
    .B(\hCount1[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0147_));
 sky130_fd_sc_hd__nor2_2 _0663_ (.A(\t[4] ),
    .B(\hCount1[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0148_));
 sky130_fd_sc_hd__nand2_2 _0664_ (.A(net23),
    .B(\hCount1[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0149_));
 sky130_fd_sc_hd__nand2_2 _0665_ (.A(net25),
    .B(\hCount1[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0150_));
 sky130_fd_sc_hd__or2_2 _0666_ (.A(net26),
    .B(\hCount1[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0151_));
 sky130_fd_sc_hd__nand2_2 _0667_ (.A(_0150_),
    .B(_0151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0152_));
 sky130_fd_sc_hd__and2_2 _0668_ (.A(net27),
    .B(\hCount1[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0153_));
 sky130_fd_sc_hd__nor2_2 _0669_ (.A(net27),
    .B(\hCount1[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0154_));
 sky130_fd_sc_hd__and4bb_2 _0670_ (.A_N(_0153_),
    .B_N(_0154_),
    .C(net28),
    .D(\hCount1[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0155_));
 sky130_fd_sc_hd__or2_2 _0671_ (.A(_0153_),
    .B(_0155_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0156_));
 sky130_fd_sc_hd__a21bo_2 _0672_ (.A1(_0151_),
    .A2(_0156_),
    .B1_N(_0150_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0157_));
 sky130_fd_sc_hd__or2_2 _0673_ (.A(net23),
    .B(\hCount1[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0158_));
 sky130_fd_sc_hd__nand2_2 _0674_ (.A(_0149_),
    .B(_0158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0159_));
 sky130_fd_sc_hd__nand2b_2 _0675_ (.A_N(_0159_),
    .B(_0157_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0160_));
 sky130_fd_sc_hd__a211oi_2 _0676_ (.A1(_0149_),
    .A2(_0160_),
    .B1(_0147_),
    .C1(_0148_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0161_));
 sky130_fd_sc_hd__or2_2 _0677_ (.A(net21),
    .B(net31),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0162_));
 sky130_fd_sc_hd__o211a_2 _0678_ (.A1(_0147_),
    .A2(_0161_),
    .B1(_0162_),
    .C1(_0146_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0163_));
 sky130_fd_sc_hd__a21o_2 _0679_ (.A1(net21),
    .A2(net31),
    .B1(_0163_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0164_));
 sky130_fd_sc_hd__nand2b_2 _0680_ (.A_N(_0145_),
    .B(_0164_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0165_));
 sky130_fd_sc_hd__xor2_2 _0681_ (.A(\t[7] ),
    .B(\hCount1[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0166_));
 sky130_fd_sc_hd__and3_2 _0682_ (.A(_0143_),
    .B(_0165_),
    .C(_0166_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0167_));
 sky130_fd_sc_hd__a21o_2 _0683_ (.A1(_0143_),
    .A2(_0165_),
    .B1(_0166_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0168_));
 sky130_fd_sc_hd__nand2_2 _0684_ (.A(_0497_),
    .B(_0168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0169_));
 sky130_fd_sc_hd__o2bb2a_2 _0685_ (.A1_N(net34),
    .A2_N(_0079_),
    .B1(_0167_),
    .B2(_0169_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0170_));
 sky130_fd_sc_hd__xnor2_2 _0686_ (.A(_0145_),
    .B(_0164_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0171_));
 sky130_fd_sc_hd__o21a_2 _0687_ (.A1(net34),
    .A2(_0171_),
    .B1(_0108_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0172_));
 sky130_fd_sc_hd__xnor2_2 _0688_ (.A(_0170_),
    .B(_0172_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0173_));
 sky130_fd_sc_hd__o21ai_2 _0689_ (.A1(_0141_),
    .A2(_0173_),
    .B1(_0140_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0174_));
 sky130_fd_sc_hd__xnor2_2 _0690_ (.A(_0142_),
    .B(_0173_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0175_));
 sky130_fd_sc_hd__nand2_2 _0691_ (.A(net34),
    .B(_0113_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0176_));
 sky130_fd_sc_hd__a211oi_2 _0692_ (.A1(_0083_),
    .A2(_0099_),
    .B1(_0098_),
    .C1(_0084_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0177_));
 sky130_fd_sc_hd__o31a_2 _0693_ (.A1(net34),
    .A2(_0100_),
    .A3(_0177_),
    .B1(_0176_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0178_));
 sky130_fd_sc_hd__xor2_4 _0694_ (.A(_0106_),
    .B(_0178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0179_));
 sky130_fd_sc_hd__xor2_2 _0695_ (.A(_0128_),
    .B(_0130_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0180_));
 sky130_fd_sc_hd__xnor2_2 _0696_ (.A(_0180_),
    .B(_0137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0181_));
 sky130_fd_sc_hd__nor2_2 _0697_ (.A(_0179_),
    .B(_0181_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0182_));
 sky130_fd_sc_hd__and2_2 _0698_ (.A(_0179_),
    .B(_0181_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0183_));
 sky130_fd_sc_hd__or2_2 _0699_ (.A(_0182_),
    .B(_0183_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0184_));
 sky130_fd_sc_hd__a211oi_2 _0700_ (.A1(_0146_),
    .A2(_0162_),
    .B1(_0161_),
    .C1(_0147_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0185_));
 sky130_fd_sc_hd__o31a_2 _0701_ (.A1(net34),
    .A2(_0163_),
    .A3(_0185_),
    .B1(_0176_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0186_));
 sky130_fd_sc_hd__xor2_2 _0702_ (.A(net18),
    .B(_0186_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0187_));
 sky130_fd_sc_hd__nor2_2 _0703_ (.A(_0184_),
    .B(_0187_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0188_));
 sky130_fd_sc_hd__o21a_2 _0704_ (.A1(_0182_),
    .A2(_0188_),
    .B1(_0175_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0189_));
 sky130_fd_sc_hd__and2_2 _0705_ (.A(_0184_),
    .B(_0187_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0190_));
 sky130_fd_sc_hd__or2_4 _0706_ (.A(_0188_),
    .B(_0190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0191_));
 sky130_fd_sc_hd__nand2_2 _0707_ (.A(net33),
    .B(_0115_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0192_));
 sky130_fd_sc_hd__o211a_2 _0708_ (.A1(_0084_),
    .A2(_0085_),
    .B1(_0086_),
    .C1(_0097_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0193_));
 sky130_fd_sc_hd__o31a_2 _0709_ (.A1(net37),
    .A2(_0098_),
    .A3(_0193_),
    .B1(_0192_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0194_));
 sky130_fd_sc_hd__xnor2_2 _0710_ (.A(_0106_),
    .B(_0194_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0195_));
 sky130_fd_sc_hd__xnor2_2 _0711_ (.A(_0117_),
    .B(_0127_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0196_));
 sky130_fd_sc_hd__xor2_2 _0712_ (.A(net59),
    .B(_0196_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0197_));
 sky130_fd_sc_hd__nand2_2 _0713_ (.A(_0195_),
    .B(_0197_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0198_));
 sky130_fd_sc_hd__xnor2_2 _0714_ (.A(_0195_),
    .B(_0197_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0199_));
 sky130_fd_sc_hd__o211a_2 _0715_ (.A1(_0147_),
    .A2(_0148_),
    .B1(_0149_),
    .C1(_0160_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0200_));
 sky130_fd_sc_hd__o31a_2 _0716_ (.A1(net37),
    .A2(_0161_),
    .A3(_0200_),
    .B1(_0192_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0201_));
 sky130_fd_sc_hd__xor2_2 _0717_ (.A(net18),
    .B(_0201_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0202_));
 sky130_fd_sc_hd__inv_2 _0718_ (.A(_0202_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0203_));
 sky130_fd_sc_hd__o21a_2 _0719_ (.A1(_0199_),
    .A2(_0202_),
    .B1(_0198_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0204_));
 sky130_fd_sc_hd__nor2_2 _0720_ (.A(_0191_),
    .B(_0204_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0205_));
 sky130_fd_sc_hd__xor2_2 _0721_ (.A(_0191_),
    .B(_0204_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0206_));
 sky130_fd_sc_hd__xnor2_2 _0722_ (.A(_0199_),
    .B(_0202_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0207_));
 sky130_fd_sc_hd__or2_2 _0723_ (.A(_0497_),
    .B(_0118_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0208_));
 sky130_fd_sc_hd__xnor2_2 _0724_ (.A(_0094_),
    .B(_0096_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0209_));
 sky130_fd_sc_hd__o21ai_2 _0725_ (.A1(net37),
    .A2(_0209_),
    .B1(_0208_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0210_));
 sky130_fd_sc_hd__xnor2_2 _0726_ (.A(_0106_),
    .B(_0210_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0211_));
 sky130_fd_sc_hd__xnor2_2 _0727_ (.A(_0124_),
    .B(_0126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0212_));
 sky130_fd_sc_hd__xnor2_2 _0728_ (.A(net17),
    .B(_0212_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0213_));
 sky130_fd_sc_hd__nand2_2 _0729_ (.A(_0211_),
    .B(_0213_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0214_));
 sky130_fd_sc_hd__xnor2_2 _0730_ (.A(_0211_),
    .B(_0213_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0215_));
 sky130_fd_sc_hd__xnor2_2 _0731_ (.A(_0157_),
    .B(_0159_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0216_));
 sky130_fd_sc_hd__o21a_2 _0732_ (.A1(net37),
    .A2(_0216_),
    .B1(_0208_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0217_));
 sky130_fd_sc_hd__xnor2_2 _0733_ (.A(net18),
    .B(_0217_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0218_));
 sky130_fd_sc_hd__inv_2 _0734_ (.A(_0218_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0219_));
 sky130_fd_sc_hd__or2_2 _0735_ (.A(_0215_),
    .B(_0218_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0220_));
 sky130_fd_sc_hd__nand3_2 _0736_ (.A(_0207_),
    .B(_0214_),
    .C(_0220_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0221_));
 sky130_fd_sc_hd__xor2_2 _0737_ (.A(_0121_),
    .B(_0123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0222_));
 sky130_fd_sc_hd__xnor2_2 _0738_ (.A(net17),
    .B(_0222_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0223_));
 sky130_fd_sc_hd__or2_2 _0739_ (.A(_0497_),
    .B(_0120_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0224_));
 sky130_fd_sc_hd__xnor2_2 _0740_ (.A(_0089_),
    .B(_0093_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0225_));
 sky130_fd_sc_hd__o21ai_2 _0741_ (.A1(net36),
    .A2(_0225_),
    .B1(_0224_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0226_));
 sky130_fd_sc_hd__xnor2_2 _0742_ (.A(_0106_),
    .B(_0226_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0227_));
 sky130_fd_sc_hd__and2_2 _0743_ (.A(_0223_),
    .B(_0227_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0228_));
 sky130_fd_sc_hd__xor2_2 _0744_ (.A(_0223_),
    .B(_0227_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0229_));
 sky130_fd_sc_hd__xnor2_2 _0745_ (.A(_0152_),
    .B(_0156_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0230_));
 sky130_fd_sc_hd__o21ai_2 _0746_ (.A1(net36),
    .A2(_0230_),
    .B1(_0224_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0231_));
 sky130_fd_sc_hd__xnor2_2 _0747_ (.A(net18),
    .B(_0231_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0232_));
 sky130_fd_sc_hd__xor2_2 _0748_ (.A(_0229_),
    .B(_0232_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0233_));
 sky130_fd_sc_hd__a21o_2 _0749_ (.A1(_0059_),
    .A2(_0060_),
    .B1(_0062_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0234_));
 sky130_fd_sc_hd__nand2_2 _0750_ (.A(net35),
    .B(_0234_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0235_));
 sky130_fd_sc_hd__a31o_2 _0751_ (.A1(_0059_),
    .A2(_0060_),
    .A3(_0062_),
    .B1(_0235_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0236_));
 sky130_fd_sc_hd__o2bb2a_2 _0752_ (.A1_N(net28),
    .A2_N(net61),
    .B1(_0090_),
    .B2(_0091_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0237_));
 sky130_fd_sc_hd__o31a_2 _0753_ (.A1(net35),
    .A2(_0092_),
    .A3(_0237_),
    .B1(_0236_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0238_));
 sky130_fd_sc_hd__xor2_4 _0754_ (.A(_0106_),
    .B(_0238_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0239_));
 sky130_fd_sc_hd__xor2_2 _0755_ (.A(net28),
    .B(_0058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0240_));
 sky130_fd_sc_hd__xnor2_2 _0756_ (.A(net17),
    .B(_0240_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0241_));
 sky130_fd_sc_hd__and2b_2 _0757_ (.A_N(_0239_),
    .B(_0241_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0242_));
 sky130_fd_sc_hd__xnor2_2 _0758_ (.A(_0239_),
    .B(_0241_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0243_));
 sky130_fd_sc_hd__o2bb2a_2 _0759_ (.A1_N(net28),
    .A2_N(\hCount1[1] ),
    .B1(_0153_),
    .B2(_0154_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0244_));
 sky130_fd_sc_hd__o31a_2 _0760_ (.A1(net35),
    .A2(_0155_),
    .A3(_0244_),
    .B1(_0236_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0245_));
 sky130_fd_sc_hd__xor2_4 _0761_ (.A(net18),
    .B(_0245_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0246_));
 sky130_fd_sc_hd__inv_2 _0762_ (.A(_0246_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0247_));
 sky130_fd_sc_hd__a21oi_2 _0763_ (.A1(_0243_),
    .A2(_0247_),
    .B1(_0242_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0248_));
 sky130_fd_sc_hd__and2b_2 _0764_ (.A_N(_0248_),
    .B(_0233_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0249_));
 sky130_fd_sc_hd__xnor2_2 _0765_ (.A(_0233_),
    .B(_0248_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0250_));
 sky130_fd_sc_hd__xnor2_2 _0766_ (.A(_0243_),
    .B(_0246_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0251_));
 sky130_fd_sc_hd__nor2_2 _0767_ (.A(net28),
    .B(_0061_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0252_));
 sky130_fd_sc_hd__o21ai_2 _0768_ (.A1(_0062_),
    .A2(_0252_),
    .B1(net36),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0253_));
 sky130_fd_sc_hd__xor2_2 _0769_ (.A(net28),
    .B(net61),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0254_));
 sky130_fd_sc_hd__o21ai_2 _0770_ (.A1(net36),
    .A2(_0254_),
    .B1(_0253_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0255_));
 sky130_fd_sc_hd__xnor2_2 _0771_ (.A(_0106_),
    .B(_0255_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0256_));
 sky130_fd_sc_hd__xor2_2 _0772_ (.A(net28),
    .B(\hCount1[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0257_));
 sky130_fd_sc_hd__o21ai_2 _0773_ (.A1(net36),
    .A2(_0257_),
    .B1(_0253_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0258_));
 sky130_fd_sc_hd__xnor2_2 _0774_ (.A(net18),
    .B(_0258_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0259_));
 sky130_fd_sc_hd__or2_2 _0775_ (.A(_0256_),
    .B(_0259_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0260_));
 sky130_fd_sc_hd__nand2_2 _0776_ (.A(_0256_),
    .B(_0259_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0261_));
 sky130_fd_sc_hd__xor2_2 _0777_ (.A(_0061_),
    .B(net63),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0262_));
 sky130_fd_sc_hd__nand2_2 _0778_ (.A(_0261_),
    .B(_0262_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0263_));
 sky130_fd_sc_hd__and3_2 _0779_ (.A(_0251_),
    .B(_0260_),
    .C(_0263_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0264_));
 sky130_fd_sc_hd__a21o_2 _0780_ (.A1(_0250_),
    .A2(_0264_),
    .B1(_0249_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0265_));
 sky130_fd_sc_hd__nand2_2 _0781_ (.A(_0215_),
    .B(_0218_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0266_));
 sky130_fd_sc_hd__nand2_2 _0782_ (.A(_0220_),
    .B(_0266_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0267_));
 sky130_fd_sc_hd__a21oi_2 _0783_ (.A1(_0229_),
    .A2(_0232_),
    .B1(_0228_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0268_));
 sky130_fd_sc_hd__nor2_2 _0784_ (.A(_0267_),
    .B(_0268_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0269_));
 sky130_fd_sc_hd__xor2_2 _0785_ (.A(_0267_),
    .B(_0268_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0270_));
 sky130_fd_sc_hd__a21o_2 _0786_ (.A1(_0214_),
    .A2(_0220_),
    .B1(_0207_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0271_));
 sky130_fd_sc_hd__o21ai_2 _0787_ (.A1(_0267_),
    .A2(_0268_),
    .B1(_0271_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0272_));
 sky130_fd_sc_hd__a21o_2 _0788_ (.A1(_0265_),
    .A2(_0270_),
    .B1(_0272_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0273_));
 sky130_fd_sc_hd__nand2_2 _0789_ (.A(_0221_),
    .B(_0273_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0274_));
 sky130_fd_sc_hd__a31o_4 _0790_ (.A1(_0206_),
    .A2(_0221_),
    .A3(_0273_),
    .B1(_0205_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0275_));
 sky130_fd_sc_hd__nor3_2 _0791_ (.A(_0175_),
    .B(_0182_),
    .C(_0188_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0276_));
 sky130_fd_sc_hd__nor2_2 _0792_ (.A(_0189_),
    .B(_0276_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0277_));
 sky130_fd_sc_hd__a21o_2 _0793_ (.A1(_0275_),
    .A2(_0277_),
    .B1(_0189_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0278_));
 sky130_fd_sc_hd__a21oi_2 _0794_ (.A1(_0174_),
    .A2(_0278_),
    .B1(_0502_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0279_));
 sky130_fd_sc_hd__nand2_2 _0795_ (.A(net37),
    .B(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0280_));
 sky130_fd_sc_hd__nand2_2 _0796_ (.A(_0502_),
    .B(_0280_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0281_));
 sky130_fd_sc_hd__nand2_2 _0797_ (.A(net20),
    .B(_0509_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0282_));
 sky130_fd_sc_hd__nand2_2 _0798_ (.A(\t[4] ),
    .B(_0512_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0283_));
 sky130_fd_sc_hd__or2_2 _0799_ (.A(\t[4] ),
    .B(_0512_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0284_));
 sky130_fd_sc_hd__nand2_2 _0800_ (.A(_0283_),
    .B(_0284_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0285_));
 sky130_fd_sc_hd__nand2_2 _0801_ (.A(net23),
    .B(_0515_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0286_));
 sky130_fd_sc_hd__nand2_2 _0802_ (.A(net25),
    .B(_0057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0287_));
 sky130_fd_sc_hd__or2_2 _0803_ (.A(net25),
    .B(_0057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0288_));
 sky130_fd_sc_hd__xnor2_2 _0804_ (.A(net27),
    .B(_0029_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0289_));
 sky130_fd_sc_hd__nand3_2 _0805_ (.A(net29),
    .B(_0030_),
    .C(_0031_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0290_));
 sky130_fd_sc_hd__nor2_2 _0806_ (.A(_0289_),
    .B(_0290_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0291_));
 sky130_fd_sc_hd__a21o_2 _0807_ (.A1(net27),
    .A2(_0029_),
    .B1(_0291_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0292_));
 sky130_fd_sc_hd__nand3_2 _0808_ (.A(_0287_),
    .B(_0288_),
    .C(_0292_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0293_));
 sky130_fd_sc_hd__or2_2 _0809_ (.A(net23),
    .B(_0515_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0294_));
 sky130_fd_sc_hd__nand2_2 _0810_ (.A(_0286_),
    .B(_0294_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0295_));
 sky130_fd_sc_hd__a21o_2 _0811_ (.A1(_0287_),
    .A2(_0293_),
    .B1(_0295_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0296_));
 sky130_fd_sc_hd__nand2_2 _0812_ (.A(_0286_),
    .B(_0296_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0297_));
 sky130_fd_sc_hd__a21o_2 _0813_ (.A1(_0286_),
    .A2(_0296_),
    .B1(_0285_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0298_));
 sky130_fd_sc_hd__or2_2 _0814_ (.A(net20),
    .B(_0509_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0299_));
 sky130_fd_sc_hd__nand2_2 _0815_ (.A(_0282_),
    .B(_0299_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0300_));
 sky130_fd_sc_hd__a21o_2 _0816_ (.A1(_0283_),
    .A2(_0298_),
    .B1(_0300_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0301_));
 sky130_fd_sc_hd__xnor2_2 _0817_ (.A(\t[6] ),
    .B(_0506_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0302_));
 sky130_fd_sc_hd__a21oi_2 _0818_ (.A1(_0282_),
    .A2(_0301_),
    .B1(_0302_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0303_));
 sky130_fd_sc_hd__a21o_2 _0819_ (.A1(\t[6] ),
    .A2(_0506_),
    .B1(_0303_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0304_));
 sky130_fd_sc_hd__xor2_2 _0820_ (.A(\hCount1[8] ),
    .B(_0103_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0305_));
 sky130_fd_sc_hd__xnor2_2 _0821_ (.A(_0304_),
    .B(_0305_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0306_));
 sky130_fd_sc_hd__nand2_2 _0822_ (.A(_0195_),
    .B(_0203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0307_));
 sky130_fd_sc_hd__or2_2 _0823_ (.A(_0195_),
    .B(_0203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0308_));
 sky130_fd_sc_hd__nand2_2 _0824_ (.A(_0307_),
    .B(_0308_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0309_));
 sky130_fd_sc_hd__nor2_2 _0825_ (.A(_0211_),
    .B(_0219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0310_));
 sky130_fd_sc_hd__nand2_2 _0826_ (.A(_0211_),
    .B(_0219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0311_));
 sky130_fd_sc_hd__and2_2 _0827_ (.A(_0227_),
    .B(_0232_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0312_));
 sky130_fd_sc_hd__nor2_2 _0828_ (.A(_0239_),
    .B(_0246_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0313_));
 sky130_fd_sc_hd__xor2_2 _0829_ (.A(_0239_),
    .B(_0246_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0314_));
 sky130_fd_sc_hd__a31o_2 _0830_ (.A1(_0256_),
    .A2(_0259_),
    .A3(_0314_),
    .B1(_0313_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0315_));
 sky130_fd_sc_hd__or2_2 _0831_ (.A(_0227_),
    .B(_0232_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0316_));
 sky130_fd_sc_hd__nand2b_2 _0832_ (.A_N(_0312_),
    .B(_0316_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0317_));
 sky130_fd_sc_hd__a21oi_2 _0833_ (.A1(_0315_),
    .A2(_0316_),
    .B1(_0312_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0318_));
 sky130_fd_sc_hd__a21o_2 _0834_ (.A1(_0311_),
    .A2(_0318_),
    .B1(_0310_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0319_));
 sky130_fd_sc_hd__a211o_2 _0835_ (.A1(_0311_),
    .A2(_0318_),
    .B1(_0309_),
    .C1(_0310_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0320_));
 sky130_fd_sc_hd__xnor2_2 _0836_ (.A(_0179_),
    .B(_0187_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0321_));
 sky130_fd_sc_hd__a21o_2 _0837_ (.A1(_0307_),
    .A2(_0320_),
    .B1(_0321_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0322_));
 sky130_fd_sc_hd__o21ai_2 _0838_ (.A1(_0179_),
    .A2(_0187_),
    .B1(_0322_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0323_));
 sky130_fd_sc_hd__xnor2_2 _0839_ (.A(_0111_),
    .B(_0173_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0324_));
 sky130_fd_sc_hd__a21oi_2 _0840_ (.A1(_0323_),
    .A2(_0324_),
    .B1(_0281_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0325_));
 sky130_fd_sc_hd__o21a_2 _0841_ (.A1(_0112_),
    .A2(_0173_),
    .B1(_0325_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0326_));
 sky130_fd_sc_hd__a21oi_2 _0842_ (.A1(_0281_),
    .A2(_0306_),
    .B1(_0326_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0327_));
 sky130_fd_sc_hd__o21bai_2 _0843_ (.A1(_0501_),
    .A2(_0327_),
    .B1_N(_0279_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0328_));
 sky130_fd_sc_hd__xnor2_2 _0844_ (.A(net32),
    .B(_0328_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0329_));
 sky130_fd_sc_hd__nor2_2 _0845_ (.A(net10),
    .B(_0496_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0330_));
 sky130_fd_sc_hd__or2_2 _0846_ (.A(_0174_),
    .B(_0278_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0331_));
 sky130_fd_sc_hd__and3_2 _0847_ (.A(_0282_),
    .B(_0301_),
    .C(_0302_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0332_));
 sky130_fd_sc_hd__nor3_2 _0848_ (.A(_0280_),
    .B(_0303_),
    .C(_0332_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0333_));
 sky130_fd_sc_hd__o21a_2 _0849_ (.A1(_0323_),
    .A2(_0324_),
    .B1(_0325_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0334_));
 sky130_fd_sc_hd__a211oi_4 _0850_ (.A1(_0331_),
    .A2(_0279_),
    .B1(_0333_),
    .C1(_0334_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0335_));
 sky130_fd_sc_hd__xnor2_2 _0851_ (.A(net32),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0336_));
 sky130_fd_sc_hd__a21o_2 _0852_ (.A1(_0496_),
    .A2(net13),
    .B1(_0330_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0337_));
 sky130_fd_sc_hd__xnor2_2 _0853_ (.A(_0329_),
    .B(_0337_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0338_));
 sky130_fd_sc_hd__nor2_2 _0854_ (.A(_0500_),
    .B(_0338_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net12));
 sky130_fd_sc_hd__nor2_2 _0855_ (.A(_0495_),
    .B(_0496_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0339_));
 sky130_fd_sc_hd__xor2_2 _0856_ (.A(_0250_),
    .B(_0264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0340_));
 sky130_fd_sc_hd__and2_2 _0857_ (.A(_0289_),
    .B(_0290_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0341_));
 sky130_fd_sc_hd__nor2_2 _0858_ (.A(_0291_),
    .B(_0341_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0342_));
 sky130_fd_sc_hd__xnor2_2 _0859_ (.A(_0261_),
    .B(_0314_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0343_));
 sky130_fd_sc_hd__o22a_2 _0860_ (.A1(_0280_),
    .A2(_0342_),
    .B1(_0343_),
    .B2(_0281_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0344_));
 sky130_fd_sc_hd__o21ai_2 _0861_ (.A1(_0502_),
    .A2(_0340_),
    .B1(_0344_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0345_));
 sky130_fd_sc_hd__xor2_2 _0862_ (.A(net8),
    .B(_0345_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0346_));
 sky130_fd_sc_hd__a21oi_2 _0863_ (.A1(_0260_),
    .A2(_0263_),
    .B1(_0251_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0347_));
 sky130_fd_sc_hd__nor2_2 _0864_ (.A(_0264_),
    .B(_0347_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0348_));
 sky130_fd_sc_hd__a21o_2 _0865_ (.A1(_0260_),
    .A2(_0261_),
    .B1(_0281_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0349_));
 sky130_fd_sc_hd__a21o_2 _0866_ (.A1(_0030_),
    .A2(_0031_),
    .B1(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0350_));
 sky130_fd_sc_hd__a21o_2 _0867_ (.A1(_0290_),
    .A2(_0350_),
    .B1(_0280_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0351_));
 sky130_fd_sc_hd__o211a_2 _0868_ (.A1(_0502_),
    .A2(_0348_),
    .B1(_0349_),
    .C1(_0351_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0352_));
 sky130_fd_sc_hd__xnor2_2 _0869_ (.A(net8),
    .B(_0352_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0353_));
 sky130_fd_sc_hd__nor2_2 _0870_ (.A(_0346_),
    .B(_0353_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0354_));
 sky130_fd_sc_hd__xnor2_2 _0871_ (.A(_0265_),
    .B(_0270_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0355_));
 sky130_fd_sc_hd__a21o_2 _0872_ (.A1(_0287_),
    .A2(_0288_),
    .B1(_0292_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0356_));
 sky130_fd_sc_hd__a21oi_2 _0873_ (.A1(_0293_),
    .A2(_0356_),
    .B1(_0280_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0357_));
 sky130_fd_sc_hd__xnor2_2 _0874_ (.A(_0315_),
    .B(_0317_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0358_));
 sky130_fd_sc_hd__nor2_2 _0875_ (.A(_0281_),
    .B(_0358_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0359_));
 sky130_fd_sc_hd__a211o_2 _0876_ (.A1(_0501_),
    .A2(_0355_),
    .B1(_0357_),
    .C1(_0359_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0360_));
 sky130_fd_sc_hd__xnor2_2 _0877_ (.A(net32),
    .B(_0360_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0361_));
 sky130_fd_sc_hd__nand2_2 _0878_ (.A(_0221_),
    .B(_0271_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0362_));
 sky130_fd_sc_hd__a21o_2 _0879_ (.A1(_0265_),
    .A2(_0270_),
    .B1(_0269_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0363_));
 sky130_fd_sc_hd__xnor2_2 _0880_ (.A(_0362_),
    .B(_0363_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0364_));
 sky130_fd_sc_hd__nand3_2 _0881_ (.A(_0287_),
    .B(_0293_),
    .C(_0295_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0365_));
 sky130_fd_sc_hd__a21o_2 _0882_ (.A1(_0296_),
    .A2(_0365_),
    .B1(_0280_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0366_));
 sky130_fd_sc_hd__and2b_2 _0883_ (.A_N(_0310_),
    .B(_0311_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0367_));
 sky130_fd_sc_hd__xnor2_2 _0884_ (.A(_0318_),
    .B(_0367_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0368_));
 sky130_fd_sc_hd__o221a_2 _0885_ (.A1(_0502_),
    .A2(_0364_),
    .B1(_0368_),
    .B2(_0281_),
    .C1(_0366_),
    ...
    .VPWR(VPWR),
    .X(_0369_));
 sky130_fd_sc_hd__xor2_2 _0886_ (.A(net32),
    .B(_0369_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0370_));
 sky130_fd_sc_hd__o21ai_2 _0887_ (.A1(_0354_),
    .A2(_0361_),
    .B1(_0370_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0371_));
 sky130_fd_sc_hd__xnor2_2 _0888_ (.A(_0206_),
    .B(_0274_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0372_));
 sky130_fd_sc_hd__xnor2_2 _0889_ (.A(_0285_),
    .B(_0297_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0373_));
 sky130_fd_sc_hd__nand2_2 _0890_ (.A(_0309_),
    .B(_0319_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0374_));
 sky130_fd_sc_hd__and2_2 _0891_ (.A(_0320_),
    .B(_0374_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0375_));
 sky130_fd_sc_hd__o22a_2 _0892_ (.A1(_0280_),
    .A2(_0373_),
    .B1(_0375_),
    .B2(_0281_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0376_));
 sky130_fd_sc_hd__o21a_2 _0893_ (.A1(_0502_),
    .A2(_0372_),
    .B1(_0376_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0377_));
 sky130_fd_sc_hd__xnor2_2 _0894_ (.A(net32),
    .B(_0377_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0378_));
 sky130_fd_sc_hd__and2_2 _0895_ (.A(_0371_),
    .B(_0378_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0379_));
 sky130_fd_sc_hd__xnor2_2 _0896_ (.A(_0275_),
    .B(_0277_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0380_));
 sky130_fd_sc_hd__nand3_2 _0897_ (.A(_0307_),
    .B(_0320_),
    .C(_0321_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0381_));
 sky130_fd_sc_hd__and2_2 _0898_ (.A(_0322_),
    .B(_0381_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0382_));
 sky130_fd_sc_hd__nand3_2 _0899_ (.A(_0283_),
    .B(_0298_),
    .C(_0300_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0383_));
 sky130_fd_sc_hd__a21o_2 _0900_ (.A1(_0301_),
    .A2(_0383_),
    .B1(_0280_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0384_));
 sky130_fd_sc_hd__o21ai_2 _0901_ (.A1(_0281_),
    .A2(_0382_),
    .B1(_0384_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0385_));
 sky130_fd_sc_hd__a21oi_2 _0902_ (.A1(_0501_),
    .A2(_0380_),
    .B1(_0385_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0386_));
 sky130_fd_sc_hd__xnor2_2 _0903_ (.A(net32),
    .B(_0386_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0387_));
 sky130_fd_sc_hd__a21o_2 _0904_ (.A1(_0371_),
    .A2(_0378_),
    .B1(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0388_));
 sky130_fd_sc_hd__nand2_2 _0905_ (.A(net14),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0389_));
 sky130_fd_sc_hd__xor2_2 _0906_ (.A(_0328_),
    .B(net60),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0390_));
 sky130_fd_sc_hd__nor3b_2 _0907_ (.A(_0390_),
    .B(_0388_),
    .C_N(_0330_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0391_));
 sky130_fd_sc_hd__or2_2 _0908_ (.A(net10),
    .B(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0392_));
 sky130_fd_sc_hd__inv_2 _0909_ (.A(_0392_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0393_));
 sky130_fd_sc_hd__o21a_2 _0910_ (.A1(net14),
    .A2(net13),
    .B1(_0388_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0394_));
 sky130_fd_sc_hd__nor2_2 _0911_ (.A(net14),
    .B(_0388_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0395_));
 sky130_fd_sc_hd__o211a_2 _0912_ (.A1(_0394_),
    .A2(_0395_),
    .B1(_0389_),
    .C1(_0393_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0396_));
 sky130_fd_sc_hd__nand2_2 _0913_ (.A(_0330_),
    .B(_0388_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0397_));
 sky130_fd_sc_hd__a2bb2o_2 _0914_ (.A1_N(_0329_),
    .A2_N(_0397_),
    .B1(_0390_),
    .B2(net10),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0398_));
 sky130_fd_sc_hd__or3_4 _0915_ (.A(_0391_),
    .B(_0396_),
    .C(_0398_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0399_));
 sky130_fd_sc_hd__or2_2 _0916_ (.A(net15),
    .B(_0392_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0400_));
 sky130_fd_sc_hd__a2bb2o_2 _0917_ (.A1_N(_0379_),
    .A2_N(_0400_),
    .B1(_0388_),
    .B2(_0330_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0401_));
 sky130_fd_sc_hd__xnor2_2 _0918_ (.A(_0336_),
    .B(_0401_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0402_));
 sky130_fd_sc_hd__or4_4 _0919_ (.A(_0391_),
    .B(_0396_),
    .C(_0398_),
    .D(_0402_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0403_));
 sky130_fd_sc_hd__o31ai_2 _0920_ (.A1(_0391_),
    .A2(_0396_),
    .A3(_0398_),
    .B1(_0402_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0404_));
 sky130_fd_sc_hd__a21oi_2 _0921_ (.A1(_0404_),
    .A2(_0403_),
    .B1(_0339_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0405_));
 sky130_fd_sc_hd__and2b_2 _0922_ (.A_N(_0329_),
    .B(_0339_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0406_));
 sky130_fd_sc_hd__nor3_2 _0923_ (.A(_0500_),
    .B(_0405_),
    .C(_0406_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(net11));
 sky130_fd_sc_hd__and2_2 _0924_ (.A(net13),
    .B(_0392_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0407_));
 sky130_fd_sc_hd__xnor2_2 _0925_ (.A(net13),
    .B(_0393_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0408_));
 sky130_fd_sc_hd__xnor2_2 _0926_ (.A(net15),
    .B(_0393_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0409_));
 sky130_fd_sc_hd__nand2_2 _0927_ (.A(_0346_),
    .B(_0353_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0410_));
 sky130_fd_sc_hd__a211oi_2 _0928_ (.A1(_0361_),
    .A2(_0410_),
    .B1(_0392_),
    .C1(_0370_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0411_));
 sky130_fd_sc_hd__o22ai_2 _0929_ (.A1(_0371_),
    .A2(_0393_),
    .B1(_0411_),
    .B2(_0378_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0412_));
 sky130_fd_sc_hd__a21bo_2 _0930_ (.A1(_0409_),
    .A2(_0412_),
    .B1_N(_0400_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0413_));
 sky130_fd_sc_hd__a21o_2 _0931_ (.A1(_0408_),
    .A2(_0413_),
    .B1(_0407_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0414_));
 sky130_fd_sc_hd__xnor2_2 _0932_ (.A(net14),
    .B(_0414_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0415_));
 sky130_fd_sc_hd__xnor2_2 _0933_ (.A(_0408_),
    .B(_0413_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0416_));
 sky130_fd_sc_hd__nor2_2 _0934_ (.A(_0415_),
    .B(_0416_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0417_));
 sky130_fd_sc_hd__a21o_2 _0935_ (.A1(_0415_),
    .A2(_0416_),
    .B1(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0418_));
 sky130_fd_sc_hd__a21oi_2 _0936_ (.A1(net10),
    .A2(_0496_),
    .B1(_0500_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0419_));
 sky130_fd_sc_hd__or2_2 _0937_ (.A(_0495_),
    .B(_0329_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0420_));
 sky130_fd_sc_hd__o211a_2 _0938_ (.A1(_0417_),
    .A2(_0418_),
    .B1(_0419_),
    .C1(_0420_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[2]));
 sky130_fd_sc_hd__or2_2 _0939_ (.A(_0495_),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0421_));
 sky130_fd_sc_hd__o21ba_2 _0940_ (.A1(_0496_),
    .A2(_0421_),
    .B1_N(_0500_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0422_));
 sky130_fd_sc_hd__mux2_1 _0941_ (.A0(net14),
    .A1(_0390_),
    .S(_0330_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0423_));
 sky130_fd_sc_hd__xnor2_2 _0942_ (.A(_0387_),
    .B(_0423_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0424_));
 sky130_fd_sc_hd__o21a_2 _0943_ (.A1(_0339_),
    .A2(_0424_),
    .B1(_0422_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[4]));
 sky130_fd_sc_hd__o21ai_2 _0944_ (.A1(net10),
    .A2(_0379_),
    .B1(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0425_));
 sky130_fd_sc_hd__o21ai_2 _0945_ (.A1(net10),
    .A2(_0388_),
    .B1(_0425_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0426_));
 sky130_fd_sc_hd__xnor2_2 _0946_ (.A(_0399_),
    .B(_0426_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0427_));
 sky130_fd_sc_hd__o21a_4 _0947_ (.A1(_0339_),
    .A2(_0427_),
    .B1(_0422_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[5]));
 sky130_fd_sc_hd__xnor2_2 _0948_ (.A(_0409_),
    .B(_0412_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0428_));
 sky130_fd_sc_hd__xnor2_2 _0949_ (.A(_0415_),
    .B(_0428_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0429_));
 sky130_fd_sc_hd__o211a_2 _0950_ (.A1(net10),
    .A2(_0429_),
    .B1(_0421_),
    .C1(_0419_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[6]));
 sky130_fd_sc_hd__or3b_2 _0951_ (.A(\vCount1[2] ),
    .B(\vCount1[9] ),
    .C_N(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0430_));
 sky130_fd_sc_hd__or4b_2 _0952_ (.A(_0494_),
    .B(_0430_),
    .C(\vCount1[4] ),
    .D_N(_0499_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(\c$app_arg_10 ));
 sky130_fd_sc_hd__nor2_2 _0953_ (.A(\hCount1[5] ),
    .B(net31),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0431_));
 sky130_fd_sc_hd__and2b_2 _0954_ (.A_N(\hCount1[4] ),
    .B(_0431_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0432_));
 sky130_fd_sc_hd__or4bb_2 _0955_ (.A(\hCount1[8] ),
    .B(_0432_),
    .C_N(\hCount1[9] ),
    .D_N(\hCount1[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0433_));
 sky130_fd_sc_hd__a31o_2 _0956_ (.A1(\hCount1[5] ),
    .A2(\hCount1[4] ),
    .A3(\hCount1[6] ),
    .B1(_0433_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(\c$app_arg_11 ));
 sky130_fd_sc_hd__xor2_2 _0957_ (.A(net65),
    .B(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0000_));
 sky130_fd_sc_hd__and3_2 _0958_ (.A(\hCount1[0] ),
    .B(\hCount1[1] ),
    .C(net1),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0434_));
 sky130_fd_sc_hd__a21oi_2 _0959_ (.A1(net67),
    .A2(net1),
    .B1(\hCount1[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0435_));
 sky130_fd_sc_hd__nor2_2 _0960_ (.A(_0434_),
    .B(_0435_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0001_));
 sky130_fd_sc_hd__and2_2 _0961_ (.A(\hCount1[2] ),
    .B(_0434_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0436_));
 sky130_fd_sc_hd__nor2_2 _0962_ (.A(\hCount1[2] ),
    .B(_0434_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0437_));
 sky130_fd_sc_hd__nor2_2 _0963_ (.A(_0436_),
    .B(_0437_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0002_));
 sky130_fd_sc_hd__xor2_2 _0964_ (.A(net66),
    .B(_0436_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0003_));
 sky130_fd_sc_hd__and3_2 _0965_ (.A(\hCount1[3] ),
    .B(\hCount1[4] ),
    .C(_0436_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0438_));
 sky130_fd_sc_hd__a21oi_2 _0966_ (.A1(\hCount1[3] ),
    .A2(_0436_),
    .B1(\hCount1[4] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0439_));
 sky130_fd_sc_hd__nor2_2 _0967_ (.A(_0438_),
    .B(_0439_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0004_));
 sky130_fd_sc_hd__and2_2 _0968_ (.A(\hCount1[5] ),
    .B(_0438_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0440_));
 sky130_fd_sc_hd__and4b_2 _0969_ (.A_N(\hCount1[7] ),
    .B(\hCount1[8] ),
    .C(\hCount1[9] ),
    .D(_0431_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0441_));
 sky130_fd_sc_hd__and2_2 _0970_ (.A(_0438_),
    .B(_0441_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0442_));
 sky130_fd_sc_hd__nand2_2 _0971_ (.A(_0438_),
    .B(_0441_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0443_));
 sky130_fd_sc_hd__o21ai_2 _0972_ (.A1(\hCount1[5] ),
    .A2(_0438_),
    .B1(_0443_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0444_));
 sky130_fd_sc_hd__nor2_2 _0973_ (.A(_0440_),
    .B(_0444_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0005_));
 sky130_fd_sc_hd__nand2_2 _0974_ (.A(net31),
    .B(_0440_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0445_));
 sky130_fd_sc_hd__or2_2 _0975_ (.A(net31),
    .B(_0440_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0446_));
 sky130_fd_sc_hd__and2_2 _0976_ (.A(_0445_),
    .B(_0446_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0006_));
 sky130_fd_sc_hd__xnor2_2 _0977_ (.A(\hCount1[7] ),
    .B(_0445_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0007_));
 sky130_fd_sc_hd__a31o_2 _0978_ (.A1(\hCount1[7] ),
    .A2(net31),
    .A3(_0440_),
    .B1(\hCount1[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0447_));
 sky130_fd_sc_hd__and4_2 _0979_ (.A(\hCount1[7] ),
    .B(net31),
    .C(\hCount1[8] ),
    .D(_0440_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0448_));
 sky130_fd_sc_hd__inv_2 _0980_ (.A(_0448_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0449_));
 sky130_fd_sc_hd__and3_2 _0981_ (.A(_0443_),
    .B(_0447_),
    .C(_0449_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0008_));
 sky130_fd_sc_hd__a21oi_2 _0982_ (.A1(\hCount1[9] ),
    .A2(_0448_),
    .B1(_0442_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0450_));
 sky130_fd_sc_hd__o21a_2 _0983_ (.A1(\hCount1[9] ),
    .A2(_0448_),
    .B1(_0450_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0009_));
 sky130_fd_sc_hd__nand2_2 _0984_ (.A(\vCount1[0] ),
    .B(_0442_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0451_));
 sky130_fd_sc_hd__or4b_2 _0985_ (.A(\vCount1[7] ),
    .B(\vCount1[6] ),
    .C(\vCount1[8] ),
    .D_N(\vCount1[9] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0452_));
 sky130_fd_sc_hd__or4b_2 _0986_ (.A(\vCount1[0] ),
    .B(net30),
    .C(\vCount1[5] ),
    .D_N(\vCount1[2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0453_));
 sky130_fd_sc_hd__or4_2 _0987_ (.A(_0494_),
    .B(\vCount1[4] ),
    .C(_0452_),
    .D(_0453_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0454_));
 sky130_fd_sc_hd__or4_2 _0988_ (.A(\vCount1[0] ),
    .B(net30),
    .C(_0494_),
    .D(\vCount1[4] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0455_));
 sky130_fd_sc_hd__or4b_2 _0989_ (.A(\vCount1[5] ),
    .B(_0452_),
    .C(_0455_),
    .D_N(\vCount1[2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0456_));
 sky130_fd_sc_hd__a31o_2 _0990_ (.A1(_0438_),
    .A2(_0441_),
    .A3(_0454_),
    .B1(\vCount1[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0457_));
 sky130_fd_sc_hd__and2_2 _0991_ (.A(_0451_),
    .B(_0457_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0010_));
 sky130_fd_sc_hd__xnor2_2 _0992_ (.A(net30),
    .B(_0451_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0011_));
 sky130_fd_sc_hd__a31o_2 _0993_ (.A1(\vCount1[0] ),
    .A2(net30),
    .A3(_0442_),
    .B1(\vCount1[2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0458_));
 sky130_fd_sc_hd__or2_2 _0994_ (.A(_0443_),
    .B(_0454_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0459_));
 sky130_fd_sc_hd__nand4_2 _0995_ (.A(\vCount1[0] ),
    .B(net30),
    .C(\vCount1[2] ),
    .D(_0442_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0460_));
 sky130_fd_sc_hd__and3_2 _0996_ (.A(\vCount1[0] ),
    .B(net30),
    .C(\vCount1[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0461_));
 sky130_fd_sc_hd__and3_2 _0997_ (.A(_0458_),
    .B(_0459_),
    .C(_0460_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0012_));
 sky130_fd_sc_hd__nor2_2 _0998_ (.A(_0443_),
    .B(_0456_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0462_));
 sky130_fd_sc_hd__and3_2 _0999_ (.A(\vCount1[3] ),
    .B(_0442_),
    .C(_0461_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0463_));
 sky130_fd_sc_hd__a211oi_2 _1000_ (.A1(_0494_),
    .A2(_0460_),
    .B1(_0462_),
    .C1(_0463_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0013_));
 sky130_fd_sc_hd__xor2_2 _1001_ (.A(\vCount1[4] ),
    .B(_0463_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0014_));
 sky130_fd_sc_hd__a21oi_2 _1002_ (.A1(\vCount1[4] ),
    .A2(_0463_),
    .B1(\vCount1[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0464_));
 sky130_fd_sc_hd__and3_2 _1003_ (.A(\vCount1[5] ),
    .B(\vCount1[4] ),
    .C(_0463_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0465_));
 sky130_fd_sc_hd__nor2_2 _1004_ (.A(_0464_),
    .B(_0465_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0015_));
 sky130_fd_sc_hd__nor2_2 _1005_ (.A(\vCount1[6] ),
    .B(_0465_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0466_));
 sky130_fd_sc_hd__and2_2 _1006_ (.A(\vCount1[6] ),
    .B(_0465_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0467_));
 sky130_fd_sc_hd__nor2_2 _1007_ (.A(_0466_),
    .B(_0467_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0016_));
 sky130_fd_sc_hd__and3_2 _1008_ (.A(\vCount1[7] ),
    .B(\vCount1[6] ),
    .C(_0465_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0468_));
 sky130_fd_sc_hd__o21ba_2 _1009_ (.A1(\vCount1[7] ),
    .A2(_0467_),
    .B1_N(_0468_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0017_));
 sky130_fd_sc_hd__xor2_2 _1010_ (.A(\vCount1[8] ),
    .B(_0468_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0018_));
 sky130_fd_sc_hd__nand3_2 _1011_ (.A(\vCount1[8] ),
    .B(\vCount1[9] ),
    .C(_0468_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0469_));
 sky130_fd_sc_hd__a21o_2 _1012_ (.A1(\vCount1[8] ),
    .A2(_0468_),
    .B1(\vCount1[9] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0470_));
 sky130_fd_sc_hd__and3_2 _1013_ (.A(_0459_),
    .B(_0469_),
    .C(_0470_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0019_));
 sky130_fd_sc_hd__or3_2 _1014_ (.A(net3),
    .B(_0443_),
    .C(_0456_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0471_));
 sky130_fd_sc_hd__or3_2 _1015_ (.A(net6),
    .B(net7),
    .C(_0471_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0472_));
 sky130_fd_sc_hd__xnor2_2 _1016_ (.A(net29),
    .B(_0472_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0020_));
 sky130_fd_sc_hd__nor2_2 _1017_ (.A(net6),
    .B(net29),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0473_));
 sky130_fd_sc_hd__or3_2 _1018_ (.A(net7),
    .B(_0471_),
    .C(_0473_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0474_));
 sky130_fd_sc_hd__xnor2_2 _1019_ (.A(net64),
    .B(_0474_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0021_));
 sky130_fd_sc_hd__and3_2 _1020_ (.A(_0491_),
    .B(net7),
    .C(net26),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0475_));
 sky130_fd_sc_hd__a21oi_2 _1021_ (.A1(_0491_),
    .A2(net7),
    .B1(net26),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0476_));
 sky130_fd_sc_hd__and4bb_2 _1022_ (.A_N(net7),
    .B_N(_0473_),
    .C(net26),
    .D(\t[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0477_));
 sky130_fd_sc_hd__o32a_2 _1023_ (.A1(net7),
    .A2(_0492_),
    .A3(_0473_),
    .B1(_0475_),
    .B2(_0476_),
    ...
    .VPWR(VPWR),
    .X(_0478_));
 sky130_fd_sc_hd__nor2_2 _1024_ (.A(_0477_),
    .B(_0478_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0479_));
 sky130_fd_sc_hd__mux2_1 _1025_ (.A0(_0479_),
    .A1(net26),
    .S(_0471_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0022_));
 sky130_fd_sc_hd__and3_2 _1026_ (.A(net6),
    .B(net7),
    .C(net24),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0480_));
 sky130_fd_sc_hd__a21oi_2 _1027_ (.A1(net6),
    .A2(net7),
    .B1(net24),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0481_));
 sky130_fd_sc_hd__nor2_2 _1028_ (.A(_0480_),
    .B(_0481_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0482_));
 sky130_fd_sc_hd__o21a_2 _1029_ (.A1(_0475_),
    .A2(_0477_),
    .B1(_0482_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0483_));
 sky130_fd_sc_hd__nor3_2 _1030_ (.A(_0475_),
    .B(_0477_),
    .C(_0482_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0484_));
 sky130_fd_sc_hd__nor2_2 _1031_ (.A(_0483_),
    .B(_0484_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0485_));
 sky130_fd_sc_hd__mux2_1 _1032_ (.A0(_0485_),
    .A1(net24),
    .S(_0471_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0023_));
 sky130_fd_sc_hd__o21ba_2 _1033_ (.A1(_0480_),
    .A2(_0483_),
    .B1_N(_0471_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0486_));
 sky130_fd_sc_hd__xor2_2 _1034_ (.A(net22),
    .B(_0486_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0024_));
 sky130_fd_sc_hd__a21oi_2 _1035_ (.A1(net22),
    .A2(_0486_),
    .B1(net21),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0487_));
 sky130_fd_sc_hd__and3_2 _1036_ (.A(net22),
    .B(net21),
    .C(_0486_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0488_));
 sky130_fd_sc_hd__nor2_2 _1037_ (.A(_0487_),
    .B(_0488_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0025_));
 sky130_fd_sc_hd__or2_2 _1038_ (.A(\t[6] ),
    .B(_0488_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0489_));
 sky130_fd_sc_hd__nand2_2 _1039_ (.A(\t[6] ),
    .B(_0488_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0490_));
 sky130_fd_sc_hd__and2_2 _1040_ (.A(_0489_),
    .B(_0490_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0026_));
 sky130_fd_sc_hd__xnor2_2 _1041_ (.A(\t[7] ),
    .B(_0490_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0027_));
 sky130_fd_sc_hd__dfrtp_2 _1042_ (.CLK(clknet_2_3__leaf_clk),
    .D(_0000_),
    .RESET_B(net42),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\hCount1[0] ));
 sky130_fd_sc_hd__dfrtp_2 _1043_ (.CLK(clknet_2_2__leaf_clk),
    .D(_0001_),
    .RESET_B(net42),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\hCount1[1] ));
 sky130_fd_sc_hd__dfrtp_2 _1044_ (.CLK(clknet_2_2__leaf_clk),
    .D(_0002_),
    .RESET_B(net42),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\hCount1[2] ));
 sky130_fd_sc_hd__dfrtp_2 _1045_ (.CLK(clknet_2_2__leaf_clk),
    .D(_0003_),
    .RESET_B(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\hCount1[3] ));
 sky130_fd_sc_hd__dfrtp_2 _1046_ (.CLK(clknet_2_2__leaf_clk),
    .D(_0004_),
    .RESET_B(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\hCount1[4] ));
 sky130_fd_sc_hd__dfrtp_2 _1047_ (.CLK(clknet_2_1__leaf_clk),
    .D(_0005_),
    .RESET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\hCount1[5] ));
 sky130_fd_sc_hd__dfrtp_2 _1048_ (.CLK(clknet_2_1__leaf_clk),
    .D(_0006_),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\hCount1[6] ));
 sky130_fd_sc_hd__dfrtp_2 _1049_ (.CLK(clknet_2_1__leaf_clk),
    .D(_0007_),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\hCount1[7] ));
 sky130_fd_sc_hd__dfrtp_2 _1050_ (.CLK(clknet_2_1__leaf_clk),
    .D(_0008_),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\hCount1[8] ));
 sky130_fd_sc_hd__dfrtp_2 _1051_ (.CLK(clknet_2_1__leaf_clk),
    .D(_0009_),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\hCount1[9] ));
 sky130_fd_sc_hd__dfrtp_2 _1052_ (.CLK(clknet_2_3__leaf_clk),
    .D(_0010_),
    .RESET_B(net40),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vCount1[0] ));
 sky130_fd_sc_hd__dfrtp_2 _1053_ (.CLK(clknet_2_3__leaf_clk),
    .D(_0011_),
    .RESET_B(net40),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vCount1[1] ));
 sky130_fd_sc_hd__dfrtp_2 _1054_ (.CLK(clknet_2_3__leaf_clk),
    .D(_0012_),
    .RESET_B(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vCount1[2] ));
 sky130_fd_sc_hd__dfrtp_2 _1055_ (.CLK(clknet_2_2__leaf_clk),
    .D(_0013_),
    .RESET_B(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vCount1[3] ));
 sky130_fd_sc_hd__dfrtp_2 _1056_ (.CLK(clknet_2_2__leaf_clk),
    .D(_0014_),
    .RESET_B(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vCount1[4] ));
 sky130_fd_sc_hd__dfrtp_2 _1057_ (.CLK(clknet_2_1__leaf_clk),
    .D(_0015_),
    .RESET_B(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vCount1[5] ));
 sky130_fd_sc_hd__dfrtp_2 _1058_ (.CLK(clknet_2_0__leaf_clk),
    .D(_0016_),
    .RESET_B(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vCount1[6] ));
 sky130_fd_sc_hd__dfrtp_2 _1059_ (.CLK(clknet_2_0__leaf_clk),
    .D(_0017_),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vCount1[7] ));
 sky130_fd_sc_hd__dfrtp_2 _1060_ (.CLK(clknet_2_0__leaf_clk),
    .D(_0018_),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vCount1[8] ));
 sky130_fd_sc_hd__dfrtp_2 _1061_ (.CLK(clknet_2_1__leaf_clk),
    .D(_0019_),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\vCount1[9] ));
 sky130_fd_sc_hd__dfrtp_2 _1062_ (.CLK(clknet_2_3__leaf_clk),
    .D(_0020_),
    .RESET_B(net42),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\t[0] ));
 sky130_fd_sc_hd__dfrtp_2 _1063_ (.CLK(clknet_2_3__leaf_clk),
    .D(_0021_),
    .RESET_B(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\t[1] ));
 sky130_fd_sc_hd__dfrtp_2 _1064_ (.CLK(clknet_2_3__leaf_clk),
    .D(_0022_),
    .RESET_B(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\t[2] ));
 sky130_fd_sc_hd__dfrtp_2 _1065_ (.CLK(clknet_2_2__leaf_clk),
    .D(_0023_),
    .RESET_B(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\t[3] ));
 sky130_fd_sc_hd__dfrtp_2 _1066_ (.CLK(clknet_2_0__leaf_clk),
    .D(_0024_),
    .RESET_B(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\t[4] ));
 sky130_fd_sc_hd__dfrtp_2 _1067_ (.CLK(clknet_2_0__leaf_clk),
    .D(_0025_),
    .RESET_B(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\t[5] ));
 sky130_fd_sc_hd__dfrtp_2 _1068_ (.CLK(clknet_2_0__leaf_clk),
    .D(_0026_),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\t[6] ));
 sky130_fd_sc_hd__dfrtp_2 _1069_ (.CLK(clknet_2_0__leaf_clk),
    .D(_0027_),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\t[7] ));
 sky130_fd_sc_hd__buf_2 _1086_ (.A(\c$app_arg_10 ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[3]));
 sky130_fd_sc_hd__buf_2 _1087_ (.A(\c$app_arg_11 ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(\t[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout21 (.A(\t[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net21));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout22 (.A(\t[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout23 (.A(net24),
    ...
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout24 (.A(\t[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout25 (.A(net26),
    ...
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout26 (.A(\t[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net26));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout27 (.A(\t[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout28 (.A(net29),
    ...
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout29 (.A(\t[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net29));
 sky130_fd_sc_hd__buf_6 fanout30 (.A(\vCount1[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout31 (.A(\hCount1[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout35 (.A(net37),
    ...
    .VPWR(VPWR),
    .X(net35));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout37 (.A(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout42 (.A(net2),
    ...
    .VPWR(VPWR),
    .X(net42));
 sky130_fd_sc_hd__dlygate4sd3_1 hold64 (.A(\t[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net64));
 sky130_fd_sc_hd__dlygate4sd3_1 hold65 (.A(\hCount1[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net65));
 sky130_fd_sc_hd__dlygate4sd3_1 hold66 (.A(\hCount1[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net66));
 sky130_fd_sc_hd__dlygate4sd3_1 hold67 (.A(\hCount1[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_4 load_slew43 (.A(net42),
    ...
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__buf_6 max_cap13 (.A(_0336_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__buf_2 max_cap14 (.A(_0329_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__clkbuf_2 max_cap15 (.A(_0387_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net15));
 sky130_fd_sc_hd__clkbuf_2 max_cap16 (.A(_0335_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__buf_6 max_cap17 (.A(_0137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__buf_6 max_cap18 (.A(_0170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__buf_6 max_cap32 (.A(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net32));
 sky130_fd_sc_hd__buf_2 rebuffer59 (.A(_0137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__buf_2 rebuffer60 (.A(_0335_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net60));
 sky130_fd_sc_hd__buf_2 rebuffer61 (.A(\vCount1[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net61));
 sky130_fd_sc_hd__buf_2 rebuffer62 (.A(_0034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net62));
 sky130_fd_sc_hd__buf_2 rebuffer63 (.A(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_clash_poc (.VGND(VGND),
    ...
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_clash_poc_44 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net44));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_clash_poc_45 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net45));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_clash_poc_46 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net46));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_clash_poc_47 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net47));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_clash_poc_48 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net48));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_clash_poc_49 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net49));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_clash_poc_50 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net50));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_clash_poc_51 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net51));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_clash_poc_52 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net52));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_clash_poc_53 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net53));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_clash_poc_54 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net54));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_clash_poc_55 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net55));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_clash_poc_56 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net56));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_clash_poc_57 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net57));
 sky130_fd_sc_hd__conb_1 tt_um_gerardvt_clash_poc_58 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net58));
