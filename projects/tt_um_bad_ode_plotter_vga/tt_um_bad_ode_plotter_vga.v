module tt_um_bad_ode_plotter_vga (clk,
    ena,
    rst_n,
    VPWR,
    VGND,
 ...
 wire \grid.hpos[8] ;
 wire \grid.hpos[9] ;
 wire \grid.shft_vpos[0] ;
 wire \grid.shft_vpos[1] ;
 wire \grid.shft_vpos[2] ;
 wire \grid.shft_vpos[3] ;
 wire \grid.shft_vpos[4] ;
 wire \grid.shft_vpos[5] ;
 wire \grid.shft_vpos[6] ;
 wire \grid.shft_vpos[7] ;
 wire \grid.vpos[0] ;
 wire \grid.vpos[1] ;
 wire hsync;
 wire \hvsync_gen.vsync ;
 wire \predict.old_rgb[0] ;
 wire \predict.old_rgb[1] ;
 wire \predict.old_xc[0] ;
 wire \predict.old_xc[1] ;
 wire \predict.old_xc[2] ;
 wire \predict.old_xc[3] ;
 wire \predict.old_xc[4] ;
 wire \predict.old_xc[5] ;
 wire \predict.old_xc[6] ;
 wire \predict.old_xc[7] ;
 wire \predict.saved_rgb[0] ;
 wire \predict.saved_rgb[1] ;
 wire \predict.saved_rgb[2] ;
 wire \predict.saved_rgb[3] ;
 wire \predict.saved_rgb[4] ;
 wire \predict.saved_rgb[5] ;
 wire net1;
 wire \sol.curr_x[0] ;
 wire \sol.curr_x[1] ;
 wire \sol.curr_x[2] ;
 ...
 wire \sol.old_x[7] ;
 wire \sol.saved_seen ;
 wire \sol.start_stepper.xin[0] ;
 wire \sol.start_stepper.xin[1] ;
 wire \sol.start_stepper.xin[2] ;
 wire \sol.start_stepper.xin[3] ;
 wire \sol.start_stepper.xin[4] ;
 wire \sol.start_stepper.xin[5] ;
 wire \sol.start_stepper.xin[6] ;
 wire \sol.start_stepper.xin[7] ;
 wire \sol.start_stepper.yin[0] ;
 wire \sol.start_stepper.yin[1] ;
 wire \sol.start_stepper.yin[2] ;
 wire \sol.start_stepper.yin[3] ;
 wire \sol.start_stepper.yin[4] ;
 wire \sol.start_stepper.yin[5] ;
 wire \sol.start_stepper.yin[6] ;
 wire \sol.start_stepper.yin[7] ;
 wire net40;
 wire net41;
 wire net42;
 wire net43;
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _0521_ (.A(\sol.start_stepper.xin[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0101_));
 sky130_fd_sc_hd__inv_2 _0522_ (.A(\sol.start_stepper.xin[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0102_));
 sky130_fd_sc_hd__inv_2 _0523_ (.A(\grid.hpos[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0103_));
 sky130_fd_sc_hd__inv_2 _0524_ (.A(\sol.old_x[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0104_));
 sky130_fd_sc_hd__inv_2 _0525_ (.A(\sol.old_x[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0105_));
 sky130_fd_sc_hd__inv_2 _0526_ (.A(\grid.shft_vpos[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0106_));
 sky130_fd_sc_hd__inv_2 _0527_ (.A(net82),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0107_));
 sky130_fd_sc_hd__inv_2 _0528_ (.A(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0108_));
 sky130_fd_sc_hd__inv_2 _0529_ (.A(\predict.saved_rgb[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0109_));
 sky130_fd_sc_hd__inv_2 _0530_ (.A(\predict.old_rgb[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0110_));
 sky130_fd_sc_hd__inv_2 _0531_ (.A(\predict.saved_rgb[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0111_));
 sky130_fd_sc_hd__inv_2 _0532_ (.A(\predict.old_rgb[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0112_));
 sky130_fd_sc_hd__inv_2 _0533_ (.A(\predict.saved_rgb[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0113_));
 sky130_fd_sc_hd__inv_2 _0534_ (.A(\predict.saved_rgb[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0114_));
 sky130_fd_sc_hd__inv_2 _0535_ (.A(\predict.saved_rgb[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0115_));
 sky130_fd_sc_hd__inv_2 _0536_ (.A(\predict.saved_rgb[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0116_));
 sky130_fd_sc_hd__o21a_2 _0537_ (.A1(\grid.hpos[7] ),
    .A2(\grid.hpos[8] ),
    .B1(\grid.hpos[9] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0117_));
 sky130_fd_sc_hd__and3_2 _0538_ (.A(\grid.shft_vpos[3] ),
    .B(\grid.shft_vpos[4] ),
    .C(\grid.shft_vpos[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0118_));
 sky130_fd_sc_hd__a21o_2 _0539_ (.A1(\grid.shft_vpos[6] ),
    .A2(_0118_),
    .B1(\grid.shft_vpos[7] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0119_));
 sky130_fd_sc_hd__or2_2 _0540_ (.A(net26),
    .B(_0119_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0120_));
 sky130_fd_sc_hd__nor2_2 _0541_ (.A(\grid.hpos[6] ),
    .B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0121_));
 sky130_fd_sc_hd__a211oi_2 _0542_ (.A1(\grid.hpos[8] ),
    .A2(\grid.hpos[9] ),
    .B1(\grid.hpos[6] ),
    .C1(\grid.hpos[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0122_));
 sky130_fd_sc_hd__a31o_2 _0543_ (.A1(\grid.hpos[7] ),
    .A2(_0103_),
    .A3(\grid.hpos[6] ),
    .B1(_0122_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0123_));
 sky130_fd_sc_hd__xnor2_2 _0544_ (.A(\predict.old_xc[5] ),
    .B(_0123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0124_));
 sky130_fd_sc_hd__or3b_2 _0545_ (.A(\grid.hpos[9] ),
    .B(_0122_),
    .C_N(\grid.hpos[8] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0125_));
 sky130_fd_sc_hd__or3_2 _0546_ (.A(\grid.hpos[7] ),
    .B(\grid.hpos[8] ),
    .C(\grid.hpos[6] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0126_));
 sky130_fd_sc_hd__nand2_2 _0547_ (.A(_0125_),
    .B(_0126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0127_));
 sky130_fd_sc_hd__nand2_2 _0548_ (.A(_0103_),
    .B(_0125_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0128_));
 sky130_fd_sc_hd__nor2_2 _0549_ (.A(\predict.old_xc[7] ),
    .B(_0128_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0129_));
 sky130_fd_sc_hd__or3_2 _0550_ (.A(\grid.hpos[3] ),
    .B(\predict.old_xc[1] ),
    .C(net25),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0130_));
 sky130_fd_sc_hd__o21ai_2 _0551_ (.A1(\grid.hpos[3] ),
    .A2(net25),
    .B1(\predict.old_xc[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0131_));
 sky130_fd_sc_hd__nor2_2 _0552_ (.A(net91),
    .B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0132_));
 sky130_fd_sc_hd__xnor2_2 _0553_ (.A(\predict.old_xc[3] ),
    .B(_0132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0133_));
 sky130_fd_sc_hd__or3_2 _0554_ (.A(net27),
    .B(\predict.old_xc[2] ),
    .C(net25),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0134_));
 sky130_fd_sc_hd__o21ai_2 _0555_ (.A1(net27),
    .A2(net25),
    .B1(\predict.old_xc[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0135_));
 sky130_fd_sc_hd__a22o_2 _0556_ (.A1(_0130_),
    .A2(_0131_),
    .B1(_0134_),
    .B2(_0135_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0136_));
 sky130_fd_sc_hd__or2_2 _0557_ (.A(\grid.hpos[2] ),
    .B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0137_));
 sky130_fd_sc_hd__xnor2_2 _0558_ (.A(\predict.old_xc[0] ),
    .B(_0137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0138_));
 sky130_fd_sc_hd__xnor2_2 _0559_ (.A(\predict.old_xc[4] ),
    .B(_0121_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0139_));
 sky130_fd_sc_hd__and2_2 _0560_ (.A(\predict.old_xc[7] ),
    .B(_0128_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0140_));
 sky130_fd_sc_hd__a211o_2 _0561_ (.A1(\predict.old_xc[6] ),
    .A2(_0127_),
    .B1(_0133_),
    .C1(_0136_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0141_));
 sky130_fd_sc_hd__o2111a_2 _0562_ (.A1(\predict.old_xc[6] ),
    .A2(_0127_),
    .B1(_0138_),
    .C1(_0139_),
    .D1(_0124_),
    ...
    .VPWR(VPWR),
    .X(_0142_));
 sky130_fd_sc_hd__or4b_2 _0563_ (.A(_0129_),
    .B(_0140_),
    .C(_0141_),
    .D_N(_0142_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0143_));
 sky130_fd_sc_hd__mux2_1 _0564_ (.A0(_0109_),
    .A1(_0110_),
    .S(_0143_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0144_));
 sky130_fd_sc_hd__nor2_1 _0565_ (.A(_0120_),
    .B(_0144_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net8));
 sky130_fd_sc_hd__mux2_1 _0566_ (.A0(_0111_),
    .A1(_0112_),
    .S(_0143_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0145_));
 sky130_fd_sc_hd__nor2_1 _0567_ (.A(_0120_),
    .B(_0145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net7));
 sky130_fd_sc_hd__mux2_1 _0568_ (.A0(_0113_),
    .A1(_0110_),
    .S(_0143_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0146_));
 sky130_fd_sc_hd__nor2_2 _0569_ (.A(_0120_),
    .B(_0146_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net6));
 sky130_fd_sc_hd__mux2_1 _0570_ (.A0(_0114_),
    .A1(_0112_),
    .S(_0143_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0147_));
 sky130_fd_sc_hd__nor2_1 _0571_ (.A(_0120_),
    .B(_0147_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net5));
 sky130_fd_sc_hd__mux2_1 _0572_ (.A0(_0115_),
    .A1(_0110_),
    .S(_0143_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0148_));
 sky130_fd_sc_hd__nor2_1 _0573_ (.A(_0120_),
    .B(_0148_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net4));
 sky130_fd_sc_hd__mux2_1 _0574_ (.A0(_0116_),
    .A1(_0112_),
    .S(_0143_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0149_));
 sky130_fd_sc_hd__nor2_1 _0575_ (.A(_0120_),
    .B(_0149_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net3));
 sky130_fd_sc_hd__and2_2 _0576_ (.A(\grid.shft_vpos[0] ),
    .B(\grid.shft_vpos[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0150_));
 sky130_fd_sc_hd__or4bb_2 _0577_ (.A(\grid.shft_vpos[0] ),
    .B(\grid.shft_vpos[2] ),
    .C_N(\grid.shft_vpos[1] ),
    .D_N(\grid.vpos[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0151_));
 sky130_fd_sc_hd__or4b_2 _0578_ (.A(_0107_),
    .B(_0151_),
    .C(\grid.shft_vpos[7] ),
    .D_N(_0118_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0001_));
 sky130_fd_sc_hd__and4_2 _0579_ (.A(\grid.hpos[7] ),
    .B(\grid.hpos[6] ),
    .C(net27),
    .D(\grid.hpos[5] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0152_));
 sky130_fd_sc_hd__and4bb_2 _0580_ (.A_N(\grid.hpos[8] ),
    .B_N(_0152_),
    .C(\grid.hpos[9] ),
    .D(\grid.hpos[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0153_));
 sky130_fd_sc_hd__o31ai_2 _0581_ (.A1(\grid.hpos[6] ),
    .A2(net27),
    .A3(net72),
    .B1(_0153_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0000_));
 sky130_fd_sc_hd__a21oi_2 _0582_ (.A1(\grid.hpos[2] ),
    .A2(\grid.hpos[3] ),
    .B1(net25),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0154_));
 sky130_fd_sc_hd__a41o_2 _0583_ (.A1(\grid.hpos[2] ),
    .A2(\grid.hpos[3] ),
    .A3(net27),
    .A4(\grid.hpos[5] ),
    .B1(net25),
    ...
    .VPWR(VPWR),
    .X(_0155_));
 sky130_fd_sc_hd__nand2_2 _0584_ (.A(_0122_),
    .B(_0155_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0156_));
 sky130_fd_sc_hd__and3_2 _0585_ (.A(_0122_),
    .B(_0126_),
    .C(_0155_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0157_));
 sky130_fd_sc_hd__xnor2_2 _0586_ (.A(_0127_),
    .B(_0156_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0158_));
 sky130_fd_sc_hd__nand2_2 _0587_ (.A(\sol.old_x[6] ),
    .B(_0158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0159_));
 sky130_fd_sc_hd__xnor2_2 _0588_ (.A(_0121_),
    .B(_0155_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0160_));
 sky130_fd_sc_hd__xor2_2 _0589_ (.A(\sol.old_x[4] ),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0161_));
 sky130_fd_sc_hd__a31oi_2 _0590_ (.A1(\grid.hpos[2] ),
    .A2(\grid.hpos[3] ),
    .A3(net27),
    .B1(net26),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0162_));
 sky130_fd_sc_hd__a21o_2 _0591_ (.A1(_0132_),
    .A2(_0162_),
    .B1(_0155_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0163_));
 sky130_fd_sc_hd__xor2_2 _0592_ (.A(\sol.old_x[3] ),
    .B(_0163_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0164_));
 sky130_fd_sc_hd__and3_2 _0593_ (.A(_0159_),
    .B(_0161_),
    .C(_0164_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0165_));
 sky130_fd_sc_hd__or2_2 _0594_ (.A(_0128_),
    .B(_0157_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0166_));
 sky130_fd_sc_hd__xor2_2 _0595_ (.A(\sol.old_x[7] ),
    .B(_0166_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0167_));
 sky130_fd_sc_hd__a21o_2 _0596_ (.A1(_0121_),
    .A2(_0155_),
    .B1(_0123_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0168_));
 sky130_fd_sc_hd__and2_2 _0597_ (.A(_0156_),
    .B(_0168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0169_));
 sky130_fd_sc_hd__nand2_2 _0598_ (.A(_0105_),
    .B(_0169_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0170_));
 sky130_fd_sc_hd__or2_2 _0599_ (.A(_0105_),
    .B(_0169_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0171_));
 sky130_fd_sc_hd__or3_2 _0600_ (.A(\grid.hpos[2] ),
    .B(\grid.hpos[3] ),
    .C(net25),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0172_));
 sky130_fd_sc_hd__and2_2 _0601_ (.A(_0154_),
    .B(_0172_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0173_));
 sky130_fd_sc_hd__a21oi_2 _0602_ (.A1(_0154_),
    .A2(_0172_),
    .B1(_0104_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0174_));
 sky130_fd_sc_hd__xnor2_2 _0603_ (.A(\sol.old_x[0] ),
    .B(_0137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0175_));
 sky130_fd_sc_hd__and3_2 _0604_ (.A(_0104_),
    .B(_0154_),
    .C(_0172_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0176_));
 sky130_fd_sc_hd__a211o_2 _0605_ (.A1(\grid.hpos[2] ),
    .A2(\grid.hpos[3] ),
    .B1(net27),
    .C1(net26),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0177_));
 sky130_fd_sc_hd__and2_2 _0606_ (.A(_0162_),
    .B(_0177_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0178_));
 sky130_fd_sc_hd__a21o_2 _0607_ (.A1(_0162_),
    .A2(_0177_),
    .B1(\sol.old_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0179_));
 sky130_fd_sc_hd__nand3_2 _0608_ (.A(\sol.old_x[2] ),
    .B(_0162_),
    .C(_0177_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0180_));
 sky130_fd_sc_hd__a2111oi_1 _0609_ (.A1(_0179_),
    .A2(_0180_),
    .B1(_0174_),
    .C1(_0175_),
    .D1(_0176_),
    ...
    .VPWR(VPWR),
    .Y(_0181_));
 sky130_fd_sc_hd__and4_2 _0610_ (.A(_0167_),
    .B(_0170_),
    .C(_0171_),
    .D(net11),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0182_));
 sky130_fd_sc_hd__o211a_2 _0611_ (.A1(\sol.old_x[6] ),
    .A2(_0158_),
    .B1(_0165_),
    .C1(_0182_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0183_));
 sky130_fd_sc_hd__or2_2 _0612_ (.A(\grid.shft_vpos[5] ),
    .B(\grid.shft_vpos[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0184_));
 sky130_fd_sc_hd__and2_2 _0613_ (.A(\grid.shft_vpos[2] ),
    .B(\grid.shft_vpos[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0185_));
 sky130_fd_sc_hd__nand2_2 _0614_ (.A(\grid.shft_vpos[4] ),
    .B(_0185_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0186_));
 sky130_fd_sc_hd__or2_2 _0615_ (.A(_0119_),
    .B(_0186_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0187_));
 sky130_fd_sc_hd__o31a_2 _0616_ (.A1(\grid.shft_vpos[4] ),
    .A2(\grid.shft_vpos[7] ),
    .A3(_0185_),
    .B1(_0187_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0188_));
 sky130_fd_sc_hd__and3_2 _0617_ (.A(\grid.hpos[9] ),
    .B(_0126_),
    .C(_0155_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0189_));
 sky130_fd_sc_hd__or2_2 _0618_ (.A(_0106_),
    .B(_0119_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0190_));
 sky130_fd_sc_hd__nor2_2 _0619_ (.A(\grid.shft_vpos[2] ),
    .B(_0119_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0191_));
 sky130_fd_sc_hd__and4_2 _0620_ (.A(\grid.shft_vpos[3] ),
    .B(_0150_),
    .C(_0189_),
    .D(_0191_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0192_));
 sky130_fd_sc_hd__a21bo_2 _0621_ (.A1(_0188_),
    .A2(_0192_),
    .B1_N(_0187_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0193_));
 sky130_fd_sc_hd__xnor2_2 _0622_ (.A(_0184_),
    .B(_0193_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0194_));
 sky130_fd_sc_hd__o21a_2 _0623_ (.A1(\grid.shft_vpos[0] ),
    .A2(_0119_),
    .B1(_0189_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0195_));
 sky130_fd_sc_hd__o21ai_2 _0624_ (.A1(\grid.shft_vpos[1] ),
    .A2(_0119_),
    .B1(_0195_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_2 _0625_ (.A(_0191_),
    ...
    .VPWR(VPWR),
    .Y(_0197_));
 sky130_fd_sc_hd__mux2_1 _0626_ (.A0(\grid.shft_vpos[3] ),
    .A1(_0190_),
    .S(_0197_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0198_));
 sky130_fd_sc_hd__or2_2 _0627_ (.A(_0191_),
    .B(_0196_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0199_));
 sky130_fd_sc_hd__nand2_2 _0628_ (.A(_0197_),
    .B(_0199_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0200_));
 sky130_fd_sc_hd__or2_2 _0629_ (.A(\sol.curr_y[2] ),
    .B(_0200_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0201_));
 sky130_fd_sc_hd__or3_2 _0630_ (.A(\grid.shft_vpos[1] ),
    .B(_0119_),
    .C(_0195_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0202_));
 sky130_fd_sc_hd__and2_2 _0631_ (.A(_0196_),
    .B(_0202_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0203_));
 sky130_fd_sc_hd__xor2_2 _0632_ (.A(\sol.curr_y[1] ),
    .B(_0203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0204_));
 sky130_fd_sc_hd__a211o_2 _0633_ (.A1(\grid.shft_vpos[2] ),
    .A2(_0118_),
    .B1(\grid.shft_vpos[7] ),
    .C1(\grid.shft_vpos[6] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0205_));
 sky130_fd_sc_hd__a41o_2 _0634_ (.A1(_0118_),
    .A2(_0150_),
    .A3(_0189_),
    .A4(_0191_),
    .B1(_0205_),
    ...
    .VPWR(VPWR),
    .X(_0206_));
 sky130_fd_sc_hd__and3_2 _0635_ (.A(\sol.curr_y[6] ),
    .B(\sol.curr_y[7] ),
    .C(_0206_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0207_));
 sky130_fd_sc_hd__nor3_2 _0636_ (.A(\sol.curr_y[6] ),
    .B(\sol.curr_y[7] ),
    .C(_0206_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0208_));
 sky130_fd_sc_hd__nand2_2 _0637_ (.A(\sol.curr_y[2] ),
    .B(_0200_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0209_));
 sky130_fd_sc_hd__nor3_2 _0638_ (.A(\grid.shft_vpos[0] ),
    .B(_0119_),
    .C(_0189_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0210_));
 sky130_fd_sc_hd__nor2_2 _0639_ (.A(_0195_),
    .B(_0210_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0211_));
 sky130_fd_sc_hd__xnor2_2 _0640_ (.A(\sol.curr_x[7] ),
    .B(_0166_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0212_));
 sky130_fd_sc_hd__xor2_2 _0641_ (.A(_0188_),
    .B(_0192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0213_));
 sky130_fd_sc_hd__nand2_2 _0642_ (.A(\sol.curr_y[4] ),
    .B(_0213_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0214_));
 sky130_fd_sc_hd__or2_2 _0643_ (.A(\sol.curr_y[4] ),
    .B(_0213_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0215_));
 sky130_fd_sc_hd__xnor2_2 _0644_ (.A(\sol.curr_x[3] ),
    .B(_0163_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0216_));
 sky130_fd_sc_hd__xnor2_2 _0645_ (.A(\sol.curr_x[2] ),
    .B(_0178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0217_));
 sky130_fd_sc_hd__xor2_2 _0646_ (.A(\sol.curr_x[0] ),
    .B(_0137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0218_));
 sky130_fd_sc_hd__xnor2_2 _0647_ (.A(\sol.curr_x[1] ),
    .B(_0173_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0219_));
 sky130_fd_sc_hd__xnor2_2 _0648_ (.A(\sol.curr_y[5] ),
    .B(_0194_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0220_));
 sky130_fd_sc_hd__o2111a_2 _0649_ (.A1(_0207_),
    .A2(_0208_),
    .B1(_0209_),
    .C1(_0204_),
    .D1(_0201_),
    ...
    .VPWR(VPWR),
    .X(_0221_));
 sky130_fd_sc_hd__xor2_2 _0650_ (.A(\sol.curr_y[3] ),
    .B(_0198_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0222_));
 sky130_fd_sc_hd__xnor2_2 _0651_ (.A(\sol.curr_x[5] ),
    .B(_0169_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0223_));
 sky130_fd_sc_hd__xor2_2 _0652_ (.A(\sol.curr_y[0] ),
    .B(_0211_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0224_));
 sky130_fd_sc_hd__and4_2 _0653_ (.A(_0214_),
    .B(_0215_),
    .C(_0223_),
    .D(_0224_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0225_));
 sky130_fd_sc_hd__o2111a_2 _0654_ (.A1(\sol.curr_x[6] ),
    .A2(net15),
    .B1(_0217_),
    .C1(_0218_),
    .D1(_0219_),
    ...
    .VPWR(VPWR),
    .X(_0226_));
 sky130_fd_sc_hd__xnor2_2 _0655_ (.A(\sol.curr_x[4] ),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0227_));
 sky130_fd_sc_hd__a2111oi_2 _0656_ (.A1(\sol.curr_x[6] ),
    .A2(net15),
    .B1(_0212_),
    .C1(_0216_),
    .D1(_0227_),
    ...
    .VPWR(VPWR),
    .Y(_0228_));
 sky130_fd_sc_hd__and4_2 _0657_ (.A(_0222_),
    .B(_0225_),
    .C(_0226_),
    .D(_0228_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0229_));
 sky130_fd_sc_hd__a31o_2 _0658_ (.A1(_0220_),
    .A2(_0221_),
    .A3(_0229_),
    .B1(\sol.saved_seen ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0230_));
 sky130_fd_sc_hd__and2_2 _0659_ (.A(\sol.start_stepper.yin[1] ),
    .B(_0203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0231_));
 sky130_fd_sc_hd__nor2_2 _0660_ (.A(\sol.start_stepper.yin[1] ),
    .B(_0203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0232_));
 sky130_fd_sc_hd__xnor2_2 _0661_ (.A(\sol.start_stepper.yin[4] ),
    .B(_0213_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0233_));
 sky130_fd_sc_hd__nand2_2 _0662_ (.A(\sol.start_stepper.xin[5] ),
    .B(_0169_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0234_));
 sky130_fd_sc_hd__or2_2 _0663_ (.A(\sol.start_stepper.xin[5] ),
    .B(_0169_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0235_));
 sky130_fd_sc_hd__a2bb2o_2 _0664_ (.A1_N(\sol.start_stepper.yin[0] ),
    .A2_N(_0211_),
    .B1(_0234_),
    .B2(_0235_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0236_));
 sky130_fd_sc_hd__xnor2_2 _0665_ (.A(_0101_),
    .B(_0178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0237_));
 sky130_fd_sc_hd__xnor2_2 _0666_ (.A(\sol.start_stepper.xin[3] ),
    .B(_0163_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0238_));
 sky130_fd_sc_hd__a211o_2 _0667_ (.A1(\sol.start_stepper.xin[4] ),
    .A2(net24),
    .B1(_0237_),
    .C1(_0238_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0239_));
 sky130_fd_sc_hd__xnor2_2 _0668_ (.A(\sol.start_stepper.xin[1] ),
    .B(_0173_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0240_));
 sky130_fd_sc_hd__or2_2 _0669_ (.A(\sol.start_stepper.xin[0] ),
    .B(_0137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0241_));
 sky130_fd_sc_hd__nand2_2 _0670_ (.A(\sol.start_stepper.xin[0] ),
    .B(_0137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0242_));
 sky130_fd_sc_hd__o2111ai_2 _0671_ (.A1(\sol.start_stepper.xin[4] ),
    .A2(net24),
    .B1(_0240_),
    .C1(_0241_),
    .D1(_0242_),
    ...
    .VPWR(VPWR),
    .Y(_0243_));
 sky130_fd_sc_hd__a211o_2 _0672_ (.A1(\sol.start_stepper.yin[0] ),
    .A2(_0211_),
    .B1(_0239_),
    .C1(_0243_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0244_));
 sky130_fd_sc_hd__xnor2_2 _0673_ (.A(\sol.start_stepper.xin[7] ),
    .B(_0166_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0245_));
 sky130_fd_sc_hd__xnor2_2 _0674_ (.A(\sol.start_stepper.xin[6] ),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0246_));
 sky130_fd_sc_hd__or4_2 _0675_ (.A(_0236_),
    .B(_0244_),
    .C(_0245_),
    .D(_0246_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0247_));
 sky130_fd_sc_hd__or4_2 _0676_ (.A(_0231_),
    .B(_0232_),
    .C(_0233_),
    .D(_0247_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0248_));
 sky130_fd_sc_hd__nand3_2 _0677_ (.A(\sol.start_stepper.yin[7] ),
    .B(\sol.start_stepper.yin[6] ),
    .C(_0206_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0249_));
 sky130_fd_sc_hd__or3_2 _0678_ (.A(\sol.start_stepper.yin[7] ),
    .B(\sol.start_stepper.yin[6] ),
    .C(_0206_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0250_));
 sky130_fd_sc_hd__xnor2_2 _0679_ (.A(\sol.start_stepper.yin[2] ),
    .B(_0200_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0251_));
 sky130_fd_sc_hd__or2_2 _0680_ (.A(\sol.start_stepper.yin[5] ),
    .B(_0194_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0252_));
 sky130_fd_sc_hd__nand2_2 _0681_ (.A(\sol.start_stepper.yin[5] ),
    .B(_0194_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0253_));
 sky130_fd_sc_hd__nor2_2 _0682_ (.A(\sol.start_stepper.yin[3] ),
    .B(_0198_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0254_));
 sky130_fd_sc_hd__and2_2 _0683_ (.A(\sol.start_stepper.yin[3] ),
    .B(_0198_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0255_));
 sky130_fd_sc_hd__a211o_2 _0684_ (.A1(_0252_),
    .A2(_0253_),
    .B1(_0254_),
    .C1(_0255_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0256_));
 sky130_fd_sc_hd__a2111o_2 _0685_ (.A1(_0249_),
    .A2(_0250_),
    .B1(_0251_),
    .C1(_0256_),
    .D1(_0183_),
    ...
    .VPWR(VPWR),
    .X(_0257_));
 sky130_fd_sc_hd__o2bb2a_2 _0686_ (.A1_N(_0183_),
    .A2_N(_0230_),
    .B1(_0248_),
    .B2(_0257_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_2 _0687_ (.A(net30),
    ...
    .VPWR(VPWR),
    .X(_0259_));
 sky130_fd_sc_hd__nor2_2 _0688_ (.A(_0258_),
    .B(_0259_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0002_));
 sky130_fd_sc_hd__and4_2 _0689_ (.A(_0118_),
    .B(_0191_),
    .C(_0203_),
    .D(_0211_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0260_));
 sky130_fd_sc_hd__o2bb2a_2 _0690_ (.A1_N(_0105_),
    .A2_N(_0169_),
    .B1(\sol.old_x[6] ),
    .B2(_0158_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0261_));
 sky130_fd_sc_hd__o2111a_2 _0691_ (.A1(_0105_),
    .A2(_0169_),
    .B1(net12),
    .C1(_0161_),
    .D1(_0164_),
    ...
    .VPWR(VPWR),
    .X(_0262_));
 sky130_fd_sc_hd__and4_2 _0692_ (.A(_0159_),
    .B(_0167_),
    .C(_0261_),
    .D(_0262_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0263_));
 sky130_fd_sc_hd__or3b_2 _0693_ (.A(_0157_),
    .B(_0260_),
    .C_N(_0258_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0264_));
 sky130_fd_sc_hd__and2b_2 _0694_ (.A_N(_0259_),
    .B(_0264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0003_));
 sky130_fd_sc_hd__nand3_2 _0695_ (.A(\grid.hpos[2] ),
    .B(\grid.hpos[0] ),
    .C(\grid.hpos[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0265_));
 sky130_fd_sc_hd__and4_2 _0696_ (.A(\grid.hpos[2] ),
    .B(\grid.hpos[0] ),
    .C(\grid.hpos[3] ),
    .D(\grid.hpos[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0266_));
 sky130_fd_sc_hd__and2_2 _0697_ (.A(net27),
    .B(_0266_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0267_));
 sky130_fd_sc_hd__or4b_2 _0698_ (.A(\grid.hpos[7] ),
    .B(\grid.hpos[6] ),
    .C(\grid.hpos[5] ),
    .D_N(\grid.hpos[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0268_));
 sky130_fd_sc_hd__inv_2 _0699_ (.A(_0268_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0269_));
 sky130_fd_sc_hd__or2_2 _0700_ (.A(\grid.vpos[0] ),
    .B(\grid.vpos[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0270_));
 sky130_fd_sc_hd__or4b_2 _0701_ (.A(\grid.shft_vpos[4] ),
    .B(\grid.shft_vpos[5] ),
    .C(\grid.shft_vpos[6] ),
    .D_N(\grid.shft_vpos[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0271_));
 sky130_fd_sc_hd__or4b_2 _0702_ (.A(\grid.shft_vpos[2] ),
    .B(_0271_),
    .C(\grid.shft_vpos[3] ),
    .D_N(_0150_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0272_));
 sky130_fd_sc_hd__o21a_2 _0703_ (.A1(_0270_),
    .A2(_0272_),
    .B1(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0273_));
 sky130_fd_sc_hd__and4_2 _0704_ (.A(\grid.hpos[9] ),
    .B(_0267_),
    .C(_0269_),
    .D(_0273_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0274_));
 sky130_fd_sc_hd__a31oi_2 _0705_ (.A1(\grid.hpos[9] ),
    .A2(_0267_),
    .A3(_0269_),
    .B1(net28),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0275_));
 sky130_fd_sc_hd__mux2_1 _0706_ (.A0(_0274_),
    .A1(net22),
    .S(net79),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0004_));
 sky130_fd_sc_hd__nand2_2 _0707_ (.A(\grid.vpos[0] ),
    .B(\grid.vpos[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0276_));
 sky130_fd_sc_hd__a32o_2 _0708_ (.A1(_0270_),
    .A2(_0274_),
    .A3(_0276_),
    .B1(net22),
    .B2(net74),
    ...
    .VPWR(VPWR),
    .X(_0005_));
 sky130_fd_sc_hd__xnor2_2 _0709_ (.A(\grid.shft_vpos[0] ),
    .B(_0276_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0277_));
 sky130_fd_sc_hd__a22o_2 _0710_ (.A1(\grid.shft_vpos[0] ),
    .A2(net22),
    .B1(_0277_),
    .B2(_0274_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0006_));
 sky130_fd_sc_hd__a31o_2 _0711_ (.A1(\grid.vpos[0] ),
    .A2(\grid.vpos[1] ),
    .A3(\grid.shft_vpos[0] ),
    .B1(\grid.shft_vpos[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0278_));
 sky130_fd_sc_hd__and3_2 _0712_ (.A(\grid.vpos[0] ),
    .B(\grid.vpos[1] ),
    .C(_0150_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0279_));
 sky130_fd_sc_hd__inv_2 _0713_ (.A(_0279_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0280_));
 sky130_fd_sc_hd__a32o_2 _0714_ (.A1(_0274_),
    .A2(_0278_),
    .A3(_0280_),
    .B1(net23),
    .B2(net76),
    ...
    .VPWR(VPWR),
    .X(_0007_));
 sky130_fd_sc_hd__or2_2 _0715_ (.A(\grid.shft_vpos[2] ),
    .B(_0279_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0281_));
 sky130_fd_sc_hd__and2_2 _0716_ (.A(\grid.shft_vpos[2] ),
    .B(_0279_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0282_));
 sky130_fd_sc_hd__inv_2 _0717_ (.A(_0282_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0283_));
 sky130_fd_sc_hd__a32o_2 _0718_ (.A1(_0274_),
    .A2(_0281_),
    .A3(_0283_),
    .B1(net23),
    .B2(net84),
    ...
    .VPWR(VPWR),
    .X(_0008_));
 sky130_fd_sc_hd__or2_2 _0719_ (.A(\grid.shft_vpos[3] ),
    .B(_0282_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0284_));
 sky130_fd_sc_hd__nand2_2 _0720_ (.A(_0185_),
    .B(_0279_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0285_));
 sky130_fd_sc_hd__a32o_2 _0721_ (.A1(_0274_),
    .A2(_0284_),
    .A3(_0285_),
    .B1(net23),
    .B2(net81),
    ...
    .VPWR(VPWR),
    .X(_0009_));
 sky130_fd_sc_hd__a21o_2 _0722_ (.A1(_0185_),
    .A2(_0279_),
    .B1(\grid.shft_vpos[4] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0286_));
 sky130_fd_sc_hd__or2_2 _0723_ (.A(_0186_),
    .B(_0280_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0287_));
 sky130_fd_sc_hd__a32o_2 _0724_ (.A1(_0274_),
    .A2(_0286_),
    .A3(_0287_),
    .B1(net23),
    .B2(net80),
    ...
    .VPWR(VPWR),
    .X(_0010_));
 sky130_fd_sc_hd__a31o_2 _0725_ (.A1(\grid.shft_vpos[4] ),
    .A2(_0185_),
    .A3(_0279_),
    .B1(\grid.shft_vpos[5] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0288_));
 sky130_fd_sc_hd__nand2_2 _0726_ (.A(_0118_),
    .B(_0282_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0289_));
 sky130_fd_sc_hd__a32o_2 _0727_ (.A1(_0274_),
    .A2(_0288_),
    .A3(_0289_),
    .B1(net23),
    .B2(net62),
    ...
    .VPWR(VPWR),
    .X(_0011_));
 sky130_fd_sc_hd__nand3_2 _0728_ (.A(\grid.shft_vpos[6] ),
    .B(_0118_),
    .C(_0282_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0290_));
 sky130_fd_sc_hd__a21o_2 _0729_ (.A1(_0273_),
    .A2(_0290_),
    .B1(net23),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0291_));
 sky130_fd_sc_hd__a31o_2 _0730_ (.A1(_0118_),
    .A2(_0274_),
    .A3(_0282_),
    .B1(\grid.shft_vpos[6] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0292_));
 sky130_fd_sc_hd__and2_2 _0731_ (.A(_0291_),
    .B(_0292_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0012_));
 sky130_fd_sc_hd__nor2_2 _0732_ (.A(\grid.shft_vpos[7] ),
    .B(_0290_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0293_));
 sky130_fd_sc_hd__a22o_2 _0733_ (.A1(net89),
    .A2(_0291_),
    .B1(_0293_),
    .B2(_0274_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0013_));
 sky130_fd_sc_hd__and2b_2 _0734_ (.A_N(\grid.hpos[0] ),
    .B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0014_));
 sky130_fd_sc_hd__o21ai_2 _0735_ (.A1(\grid.hpos[0] ),
    .A2(net66),
    .B1(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0294_));
 sky130_fd_sc_hd__a21oi_2 _0736_ (.A1(\grid.hpos[0] ),
    .A2(net66),
    .B1(_0294_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0015_));
 sky130_fd_sc_hd__a21o_2 _0737_ (.A1(\grid.hpos[0] ),
    .A2(\grid.hpos[1] ),
    .B1(\grid.hpos[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0295_));
 sky130_fd_sc_hd__and3_2 _0738_ (.A(net32),
    .B(_0265_),
    .C(_0295_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0016_));
 sky130_fd_sc_hd__a31o_2 _0739_ (.A1(\grid.hpos[2] ),
    .A2(\grid.hpos[0] ),
    .A3(\grid.hpos[1] ),
    .B1(\grid.hpos[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0296_));
 sky130_fd_sc_hd__and3b_2 _0740_ (.A_N(_0266_),
    .B(_0296_),
    .C(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0017_));
 sky130_fd_sc_hd__o21ai_2 _0741_ (.A1(net27),
    .A2(_0266_),
    .B1(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0297_));
 sky130_fd_sc_hd__nor2_2 _0742_ (.A(_0267_),
    .B(_0297_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0018_));
 sky130_fd_sc_hd__and3_2 _0743_ (.A(\grid.hpos[4] ),
    .B(\grid.hpos[5] ),
    .C(_0266_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0298_));
 sky130_fd_sc_hd__o21ai_2 _0744_ (.A1(net90),
    .A2(_0267_),
    .B1(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0299_));
 sky130_fd_sc_hd__nor2_2 _0745_ (.A(_0298_),
    .B(_0299_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0019_));
 sky130_fd_sc_hd__and2_2 _0746_ (.A(\grid.hpos[6] ),
    .B(_0298_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0300_));
 sky130_fd_sc_hd__o21ai_2 _0747_ (.A1(\grid.hpos[6] ),
    .A2(_0298_),
    .B1(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0301_));
 sky130_fd_sc_hd__nor2_2 _0748_ (.A(_0300_),
    .B(_0301_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0020_));
 sky130_fd_sc_hd__nand2_2 _0749_ (.A(_0152_),
    .B(_0266_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0302_));
 sky130_fd_sc_hd__o211a_2 _0750_ (.A1(\grid.hpos[7] ),
    .A2(_0300_),
    .B1(_0302_),
    .C1(net22),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0021_));
 sky130_fd_sc_hd__a21o_2 _0751_ (.A1(_0152_),
    .A2(_0266_),
    .B1(\grid.hpos[8] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0303_));
 sky130_fd_sc_hd__and3_2 _0752_ (.A(\grid.hpos[8] ),
    .B(_0152_),
    .C(_0266_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0304_));
 sky130_fd_sc_hd__and3b_2 _0753_ (.A_N(_0304_),
    .B(net22),
    .C(_0303_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0022_));
 sky130_fd_sc_hd__o21ai_2 _0754_ (.A1(\grid.hpos[9] ),
    .A2(_0304_),
    .B1(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0305_));
 sky130_fd_sc_hd__a21oi_2 _0755_ (.A1(net85),
    .A2(_0304_),
    .B1(_0305_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0023_));
 sky130_fd_sc_hd__nor2_2 _0756_ (.A(net29),
    .B(_0144_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0024_));
 sky130_fd_sc_hd__nor2_2 _0757_ (.A(net30),
    .B(_0145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0025_));
 sky130_fd_sc_hd__nor2_2 _0758_ (.A(net29),
    .B(_0146_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0026_));
 sky130_fd_sc_hd__nor2_2 _0759_ (.A(net30),
    .B(_0147_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0027_));
 sky130_fd_sc_hd__nor2_2 _0760_ (.A(net30),
    .B(_0148_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0028_));
 sky130_fd_sc_hd__nor2_2 _0761_ (.A(net31),
    .B(_0149_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0029_));
 sky130_fd_sc_hd__and2_2 _0762_ (.A(net32),
    .B(_0137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0030_));
 sky130_fd_sc_hd__o21a_2 _0763_ (.A1(\grid.hpos[3] ),
    .A2(net25),
    .B1(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0031_));
 sky130_fd_sc_hd__o21a_2 _0764_ (.A1(net27),
    .A2(net25),
    .B1(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0032_));
 sky130_fd_sc_hd__nor2_2 _0765_ (.A(net29),
    .B(_0132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0033_));
 sky130_fd_sc_hd__and2_2 _0766_ (.A(net32),
    .B(_0121_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0034_));
 sky130_fd_sc_hd__and2_2 _0767_ (.A(net32),
    .B(_0123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0035_));
 sky130_fd_sc_hd__nor2_2 _0768_ (.A(net29),
    .B(_0127_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0036_));
 sky130_fd_sc_hd__nor2_2 _0769_ (.A(net29),
    .B(_0128_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0037_));
 sky130_fd_sc_hd__nor2_2 _0770_ (.A(net29),
    .B(_0258_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0038_));
 sky130_fd_sc_hd__mux2_1 _0771_ (.A0(\sol.start_stepper.xin[0] ),
    .A1(\sol.curr_x[0] ),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0306_));
 sky130_fd_sc_hd__mux2_1 _0772_ (.A0(\sol.start_stepper.yin[2] ),
    .A1(\sol.curr_y[2] ),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0307_));
 sky130_fd_sc_hd__nand2b_2 _0773_ (.A_N(_0306_),
    .B(_0307_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0308_));
 sky130_fd_sc_hd__nand2b_2 _0774_ (.A_N(_0307_),
    .B(_0306_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0309_));
 sky130_fd_sc_hd__a21oi_2 _0775_ (.A1(_0308_),
    .A2(_0309_),
    .B1(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0039_));
 sky130_fd_sc_hd__mux2_1 _0776_ (.A0(\sol.start_stepper.xin[1] ),
    .A1(\sol.curr_x[1] ),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0310_));
 sky130_fd_sc_hd__mux2_1 _0777_ (.A0(\sol.start_stepper.yin[3] ),
    .A1(\sol.curr_y[3] ),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0311_));
 sky130_fd_sc_hd__and2b_2 _0778_ (.A_N(_0311_),
    .B(_0310_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0312_));
 sky130_fd_sc_hd__xnor2_2 _0779_ (.A(_0310_),
    .B(_0311_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0313_));
 sky130_fd_sc_hd__a21oi_2 _0780_ (.A1(_0308_),
    .A2(_0313_),
    .B1(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0314_));
 sky130_fd_sc_hd__o21a_2 _0781_ (.A1(_0308_),
    .A2(_0313_),
    .B1(_0314_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0040_));
 sky130_fd_sc_hd__a21oi_2 _0782_ (.A1(_0308_),
    .A2(_0313_),
    .B1(_0312_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0315_));
 sky130_fd_sc_hd__a21o_2 _0783_ (.A1(_0308_),
    .A2(_0313_),
    .B1(_0312_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0316_));
 sky130_fd_sc_hd__mux2_1 _0784_ (.A0(\sol.start_stepper.xin[2] ),
    .A1(\sol.curr_x[2] ),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0317_));
 sky130_fd_sc_hd__inv_2 _0785_ (.A(_0317_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0318_));
 sky130_fd_sc_hd__mux2_1 _0786_ (.A0(\sol.start_stepper.yin[4] ),
    .A1(\sol.curr_y[4] ),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0319_));
 sky130_fd_sc_hd__nor2_2 _0787_ (.A(_0318_),
    .B(_0319_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0320_));
 sky130_fd_sc_hd__xnor2_2 _0788_ (.A(_0317_),
    .B(_0319_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0321_));
 sky130_fd_sc_hd__inv_2 _0789_ (.A(_0321_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0322_));
 sky130_fd_sc_hd__xnor2_2 _0790_ (.A(_0316_),
    .B(_0321_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0323_));
 sky130_fd_sc_hd__nand2_2 _0791_ (.A(net33),
    .B(_0323_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0041_));
 sky130_fd_sc_hd__mux2_1 _0792_ (.A0(\sol.start_stepper.xin[3] ),
    .A1(\sol.curr_x[3] ),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0324_));
 sky130_fd_sc_hd__mux2_1 _0793_ (.A0(\sol.start_stepper.yin[5] ),
    .A1(\sol.curr_y[5] ),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0325_));
 sky130_fd_sc_hd__and2b_2 _0794_ (.A_N(_0324_),
    .B(_0325_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0326_));
 sky130_fd_sc_hd__nand2b_2 _0795_ (.A_N(_0325_),
    .B(_0324_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0327_));
 sky130_fd_sc_hd__nand2b_2 _0796_ (.A_N(_0326_),
    .B(_0327_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0328_));
 sky130_fd_sc_hd__a21oi_2 _0797_ (.A1(_0316_),
    .A2(_0321_),
    .B1(_0320_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0329_));
 sky130_fd_sc_hd__o21ai_2 _0798_ (.A1(_0328_),
    .A2(_0329_),
    .B1(net33),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0330_));
 sky130_fd_sc_hd__a21oi_2 _0799_ (.A1(_0328_),
    .A2(_0329_),
    .B1(_0330_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0042_));
 sky130_fd_sc_hd__mux2_1 _0800_ (.A0(\sol.start_stepper.xin[4] ),
    .A1(\sol.curr_x[4] ),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0331_));
 sky130_fd_sc_hd__mux2_1 _0801_ (.A0(\sol.start_stepper.yin[6] ),
    .A1(\sol.curr_y[6] ),
    .S(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0332_));
 sky130_fd_sc_hd__nand2b_2 _0802_ (.A_N(_0332_),
    .B(_0331_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0333_));
 sky130_fd_sc_hd__nand2b_2 _0803_ (.A_N(_0331_),
    .B(_0332_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0334_));
 sky130_fd_sc_hd__nand2_2 _0804_ (.A(_0333_),
    .B(_0334_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0335_));
 sky130_fd_sc_hd__o31a_2 _0805_ (.A1(_0318_),
    .A2(_0319_),
    .A3(_0326_),
    .B1(_0327_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0336_));
 sky130_fd_sc_hd__o31a_2 _0806_ (.A1(_0315_),
    .A2(_0322_),
    .A3(_0328_),
    .B1(_0336_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0337_));
 sky130_fd_sc_hd__nand2_2 _0807_ (.A(_0335_),
    .B(_0337_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0338_));
 sky130_fd_sc_hd__or2_2 _0808_ (.A(_0335_),
    .B(_0337_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0339_));
 sky130_fd_sc_hd__and3_2 _0809_ (.A(net33),
    .B(_0338_),
    .C(_0339_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0043_));
 sky130_fd_sc_hd__mux2_1 _0810_ (.A0(\sol.start_stepper.yin[7] ),
    .A1(\sol.curr_y[7] ),
    .S(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0340_));
 sky130_fd_sc_hd__mux2_1 _0811_ (.A0(\sol.start_stepper.xin[5] ),
    .A1(\sol.curr_x[5] ),
    .S(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0341_));
 sky130_fd_sc_hd__and2b_2 _0812_ (.A_N(_0341_),
    .B(_0340_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0342_));
 sky130_fd_sc_hd__nand2b_2 _0813_ (.A_N(_0340_),
    .B(_0341_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0343_));
 sky130_fd_sc_hd__nand2b_2 _0814_ (.A_N(_0342_),
    .B(_0343_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0344_));
 sky130_fd_sc_hd__a21oi_2 _0815_ (.A1(_0333_),
    .A2(_0339_),
    .B1(_0344_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0345_));
 sky130_fd_sc_hd__a31o_2 _0816_ (.A1(_0333_),
    .A2(_0339_),
    .A3(_0344_),
    .B1(net28),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0346_));
 sky130_fd_sc_hd__nor2_2 _0817_ (.A(_0345_),
    .B(_0346_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0044_));
 sky130_fd_sc_hd__mux2_1 _0818_ (.A0(\sol.start_stepper.xin[6] ),
    .A1(\sol.curr_x[6] ),
    .S(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0347_));
 sky130_fd_sc_hd__and2b_2 _0819_ (.A_N(_0340_),
    .B(_0347_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0348_));
 sky130_fd_sc_hd__nand2b_2 _0820_ (.A_N(_0347_),
    .B(_0340_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0349_));
 sky130_fd_sc_hd__nand2b_2 _0821_ (.A_N(_0348_),
    .B(_0349_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0350_));
 sky130_fd_sc_hd__o21a_2 _0822_ (.A1(_0333_),
    .A2(_0342_),
    .B1(_0343_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0351_));
 sky130_fd_sc_hd__o31ai_2 _0823_ (.A1(_0335_),
    .A2(_0337_),
    .A3(_0344_),
    .B1(_0351_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0352_));
 sky130_fd_sc_hd__xor2_2 _0824_ (.A(_0350_),
    .B(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0353_));
 sky130_fd_sc_hd__nor2_2 _0825_ (.A(net28),
    .B(_0353_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0045_));
 sky130_fd_sc_hd__a21oi_2 _0826_ (.A1(_0349_),
    .A2(_0352_),
    .B1(_0348_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0354_));
 sky130_fd_sc_hd__mux2_1 _0827_ (.A0(\sol.start_stepper.xin[7] ),
    .A1(\sol.curr_x[7] ),
    .S(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0355_));
 sky130_fd_sc_hd__and2b_2 _0828_ (.A_N(_0340_),
    .B(_0355_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0356_));
 sky130_fd_sc_hd__and2b_2 _0829_ (.A_N(_0355_),
    .B(_0340_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0357_));
 sky130_fd_sc_hd__and2_2 _0830_ (.A(_0340_),
    .B(_0355_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0358_));
 sky130_fd_sc_hd__nor2_2 _0831_ (.A(_0340_),
    .B(_0355_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0359_));
 sky130_fd_sc_hd__nor2_2 _0832_ (.A(_0356_),
    .B(_0357_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0360_));
 sky130_fd_sc_hd__or2_2 _0833_ (.A(_0356_),
    .B(_0357_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0361_));
 sky130_fd_sc_hd__a211o_2 _0834_ (.A1(_0349_),
    .A2(_0352_),
    .B1(_0360_),
    .C1(_0348_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0362_));
 sky130_fd_sc_hd__o311a_2 _0835_ (.A1(_0354_),
    .A2(_0356_),
    .A3(_0357_),
    .B1(_0362_),
    .C1(net33),
    ...
    .VPWR(VPWR),
    .X(_0046_));
 sky130_fd_sc_hd__mux2_1 _0836_ (.A0(\sol.start_stepper.yin[0] ),
    .A1(\sol.curr_y[0] ),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0363_));
 sky130_fd_sc_hd__and2_2 _0837_ (.A(_0317_),
    .B(_0363_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0364_));
 sky130_fd_sc_hd__o21ai_2 _0838_ (.A1(_0317_),
    .A2(_0363_),
    .B1(net33),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0365_));
 sky130_fd_sc_hd__nor2_2 _0839_ (.A(_0364_),
    .B(_0365_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0047_));
 sky130_fd_sc_hd__mux2_1 _0840_ (.A0(\sol.start_stepper.yin[1] ),
    .A1(\sol.curr_y[1] ),
    .S(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0366_));
 sky130_fd_sc_hd__xor2_2 _0841_ (.A(_0324_),
    .B(_0366_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0367_));
 sky130_fd_sc_hd__a21oi_2 _0842_ (.A1(_0364_),
    .A2(_0367_),
    .B1(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0368_));
 sky130_fd_sc_hd__o21a_2 _0843_ (.A1(_0364_),
    .A2(_0367_),
    .B1(_0368_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0048_));
 sky130_fd_sc_hd__a22o_2 _0844_ (.A1(_0324_),
    .A2(_0366_),
    .B1(_0367_),
    .B2(_0364_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0369_));
 sky130_fd_sc_hd__and2_2 _0845_ (.A(_0307_),
    .B(_0331_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0370_));
 sky130_fd_sc_hd__nor2_2 _0846_ (.A(_0307_),
    .B(_0331_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0371_));
 sky130_fd_sc_hd__nor2_2 _0847_ (.A(_0370_),
    .B(_0371_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0372_));
 sky130_fd_sc_hd__a21oi_2 _0848_ (.A1(_0369_),
    .A2(_0372_),
    .B1(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0373_));
 sky130_fd_sc_hd__o21a_2 _0849_ (.A1(_0369_),
    .A2(_0372_),
    .B1(_0373_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0049_));
 sky130_fd_sc_hd__xor2_2 _0850_ (.A(_0311_),
    .B(_0341_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0374_));
 sky130_fd_sc_hd__a21o_2 _0851_ (.A1(_0369_),
    .A2(_0372_),
    .B1(_0370_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0375_));
 sky130_fd_sc_hd__a21oi_2 _0852_ (.A1(_0374_),
    .A2(_0375_),
    .B1(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0376_));
 sky130_fd_sc_hd__o21a_2 _0853_ (.A1(_0374_),
    .A2(_0375_),
    .B1(_0376_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0050_));
 sky130_fd_sc_hd__nand2_2 _0854_ (.A(_0319_),
    .B(_0347_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_2 _0855_ (.A(_0319_),
    ...
    .VPWR(VPWR),
    .X(_0378_));
 sky130_fd_sc_hd__and2_2 _0856_ (.A(_0377_),
    .B(_0378_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0379_));
 sky130_fd_sc_hd__o211a_2 _0857_ (.A1(_0311_),
    .A2(_0341_),
    .B1(_0331_),
    .C1(_0307_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0380_));
 sky130_fd_sc_hd__a21o_2 _0858_ (.A1(_0311_),
    .A2(_0341_),
    .B1(_0380_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0381_));
 sky130_fd_sc_hd__a31o_2 _0859_ (.A1(_0369_),
    .A2(_0372_),
    .A3(_0374_),
    .B1(_0381_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0382_));
 sky130_fd_sc_hd__or2_2 _0860_ (.A(_0379_),
    .B(_0382_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0383_));
 sky130_fd_sc_hd__nand2_2 _0861_ (.A(_0379_),
    .B(_0382_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0384_));
 sky130_fd_sc_hd__and3_2 _0862_ (.A(net33),
    .B(_0383_),
    .C(_0384_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0051_));
 sky130_fd_sc_hd__nand2_2 _0863_ (.A(_0325_),
    .B(_0355_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0385_));
 sky130_fd_sc_hd__or2_2 _0864_ (.A(_0325_),
    .B(_0355_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0386_));
 sky130_fd_sc_hd__nand2_2 _0865_ (.A(_0385_),
    .B(_0386_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0387_));
 sky130_fd_sc_hd__a21oi_2 _0866_ (.A1(_0377_),
    .A2(_0384_),
    .B1(_0387_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0388_));
 sky130_fd_sc_hd__a31o_2 _0867_ (.A1(_0377_),
    .A2(_0384_),
    .A3(_0387_),
    .B1(net30),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0389_));
 sky130_fd_sc_hd__nor2_2 _0868_ (.A(_0388_),
    .B(_0389_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0052_));
 sky130_fd_sc_hd__and2_2 _0869_ (.A(_0332_),
    .B(_0355_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0390_));
 sky130_fd_sc_hd__nor2_2 _0870_ (.A(_0332_),
    .B(_0355_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0391_));
 sky130_fd_sc_hd__nor2_2 _0871_ (.A(_0390_),
    .B(_0391_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0392_));
 sky130_fd_sc_hd__nand2_2 _0872_ (.A(_0377_),
    .B(_0385_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0393_));
 sky130_fd_sc_hd__a21o_2 _0873_ (.A1(_0379_),
    .A2(_0382_),
    .B1(_0393_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0394_));
 sky130_fd_sc_hd__a21oi_2 _0874_ (.A1(_0386_),
    .A2(_0394_),
    .B1(_0392_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0395_));
 sky130_fd_sc_hd__a31o_2 _0875_ (.A1(_0386_),
    .A2(_0392_),
    .A3(_0394_),
    .B1(net30),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0396_));
 sky130_fd_sc_hd__nor2_2 _0876_ (.A(_0395_),
    .B(_0396_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0053_));
 sky130_fd_sc_hd__a31oi_2 _0877_ (.A1(_0386_),
    .A2(_0392_),
    .A3(_0394_),
    .B1(_0390_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0397_));
 sky130_fd_sc_hd__a311o_2 _0878_ (.A1(_0386_),
    .A2(_0392_),
    .A3(_0394_),
    .B1(_0390_),
    .C1(_0361_),
    ...
    .VPWR(VPWR),
    .X(_0398_));
 sky130_fd_sc_hd__o311a_2 _0879_ (.A1(_0358_),
    .A2(_0359_),
    .A3(_0397_),
    .B1(_0398_),
    .C1(net33),
    ...
    .VPWR(VPWR),
    .X(_0054_));
 sky130_fd_sc_hd__or4_2 _0880_ (.A(\counter[0] ),
    .B(\counter[1] ),
    .C(\counter[2] ),
    .D(\counter[5] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0399_));
 sky130_fd_sc_hd__or3_2 _0881_ (.A(\counter[3] ),
    .B(\counter[4] ),
    .C(_0399_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0400_));
 sky130_fd_sc_hd__or4_2 _0882_ (.A(\counter[10] ),
    .B(\counter[11] ),
    .C(\counter[12] ),
    .D(\counter[13] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0401_));
 sky130_fd_sc_hd__or4_2 _0883_ (.A(\counter[6] ),
    .B(\counter[7] ),
    .C(\counter[8] ),
    .D(\counter[9] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0402_));
 sky130_fd_sc_hd__or4_2 _0884_ (.A(\counter[18] ),
    .B(\counter[19] ),
    .C(\counter[20] ),
    .D(\counter[21] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0403_));
 sky130_fd_sc_hd__or4_2 _0885_ (.A(\counter[14] ),
    .B(\counter[15] ),
    .C(\counter[16] ),
    .D(\counter[17] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0404_));
 sky130_fd_sc_hd__or4_2 _0886_ (.A(_0401_),
    .B(_0402_),
    .C(_0403_),
    .D(_0404_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0405_));
 sky130_fd_sc_hd__nor2_2 _0887_ (.A(_0400_),
    .B(_0405_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0406_));
 sky130_fd_sc_hd__a21oi_2 _0888_ (.A1(\sol.start_stepper.yin[2] ),
    .A2(net16),
    .B1(net86),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0407_));
 sky130_fd_sc_hd__a31o_2 _0889_ (.A1(\sol.start_stepper.yin[2] ),
    .A2(\sol.start_stepper.xin[0] ),
    .A3(net16),
    .B1(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0408_));
 sky130_fd_sc_hd__nor2_2 _0890_ (.A(_0407_),
    .B(_0408_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0055_));
 sky130_fd_sc_hd__and2b_2 _0891_ (.A_N(\sol.start_stepper.yin[3] ),
    .B(\sol.start_stepper.xin[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0409_));
 sky130_fd_sc_hd__and2b_2 _0892_ (.A_N(\sol.start_stepper.xin[1] ),
    .B(\sol.start_stepper.yin[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0410_));
 sky130_fd_sc_hd__or2_2 _0893_ (.A(_0409_),
    .B(_0410_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0411_));
 sky130_fd_sc_hd__and3_2 _0894_ (.A(\sol.start_stepper.yin[2] ),
    .B(_0102_),
    .C(_0411_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0412_));
 sky130_fd_sc_hd__a21oi_2 _0895_ (.A1(\sol.start_stepper.yin[2] ),
    .A2(_0102_),
    .B1(_0411_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0413_));
 sky130_fd_sc_hd__o21ai_2 _0896_ (.A1(_0412_),
    .A2(_0413_),
    .B1(net16),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0414_));
 sky130_fd_sc_hd__o211a_2 _0897_ (.A1(\sol.start_stepper.xin[1] ),
    .A2(net20),
    .B1(_0414_),
    .C1(net39),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0056_));
 sky130_fd_sc_hd__or2_2 _0898_ (.A(\sol.start_stepper.yin[4] ),
    .B(_0101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0415_));
 sky130_fd_sc_hd__nand2_2 _0899_ (.A(\sol.start_stepper.yin[4] ),
    .B(_0101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0416_));
 sky130_fd_sc_hd__o211a_2 _0900_ (.A1(_0409_),
    .A2(_0413_),
    .B1(_0415_),
    .C1(_0416_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0417_));
 sky130_fd_sc_hd__inv_2 _0901_ (.A(_0417_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0418_));
 sky130_fd_sc_hd__a211o_2 _0902_ (.A1(_0415_),
    .A2(_0416_),
    .B1(_0409_),
    .C1(_0413_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0419_));
 sky130_fd_sc_hd__o21ai_2 _0903_ (.A1(_0101_),
    .A2(net18),
    .B1(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0420_));
 sky130_fd_sc_hd__a31o_2 _0904_ (.A1(net18),
    .A2(_0418_),
    .A3(_0419_),
    .B1(_0420_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0057_));
 sky130_fd_sc_hd__nand2b_2 _0905_ (.A_N(\sol.start_stepper.yin[5] ),
    .B(\sol.start_stepper.xin[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0421_));
 sky130_fd_sc_hd__nand2b_2 _0906_ (.A_N(\sol.start_stepper.xin[3] ),
    .B(\sol.start_stepper.yin[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0422_));
 sky130_fd_sc_hd__nand2_2 _0907_ (.A(_0421_),
    .B(_0422_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0423_));
 sky130_fd_sc_hd__and2_2 _0908_ (.A(_0415_),
    .B(_0418_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0424_));
 sky130_fd_sc_hd__xnor2_2 _0909_ (.A(_0423_),
    .B(_0424_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0425_));
 sky130_fd_sc_hd__nand2_2 _0910_ (.A(net19),
    .B(_0425_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0426_));
 sky130_fd_sc_hd__o211a_2 _0911_ (.A1(\sol.start_stepper.xin[3] ),
    .A2(net19),
    .B1(_0426_),
    .C1(net37),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0058_));
 sky130_fd_sc_hd__nand2b_2 _0912_ (.A_N(\sol.start_stepper.yin[6] ),
    .B(\sol.start_stepper.xin[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0427_));
 sky130_fd_sc_hd__nand2b_2 _0913_ (.A_N(\sol.start_stepper.xin[4] ),
    .B(\sol.start_stepper.yin[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0428_));
 sky130_fd_sc_hd__nand2_2 _0914_ (.A(_0427_),
    .B(_0428_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0429_));
 sky130_fd_sc_hd__o21a_2 _0915_ (.A1(_0423_),
    .A2(_0424_),
    .B1(_0421_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0430_));
 sky130_fd_sc_hd__xnor2_2 _0916_ (.A(_0429_),
    .B(_0430_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0431_));
 sky130_fd_sc_hd__nand2_2 _0917_ (.A(net19),
    .B(_0431_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0432_));
 sky130_fd_sc_hd__o211a_2 _0918_ (.A1(\sol.start_stepper.xin[4] ),
    .A2(net19),
    .B1(_0432_),
    .C1(net37),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0059_));
 sky130_fd_sc_hd__nand2b_2 _0919_ (.A_N(\sol.start_stepper.yin[7] ),
    .B(\sol.start_stepper.xin[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0433_));
 sky130_fd_sc_hd__nand2b_2 _0920_ (.A_N(\sol.start_stepper.xin[5] ),
    .B(\sol.start_stepper.yin[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0434_));
 sky130_fd_sc_hd__nand2_2 _0921_ (.A(_0433_),
    .B(_0434_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0435_));
 sky130_fd_sc_hd__o21a_2 _0922_ (.A1(_0429_),
    .A2(_0430_),
    .B1(_0427_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0436_));
 sky130_fd_sc_hd__xnor2_2 _0923_ (.A(_0435_),
    .B(_0436_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0437_));
 sky130_fd_sc_hd__nand2_2 _0924_ (.A(net17),
    .B(_0437_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0438_));
 sky130_fd_sc_hd__o211a_2 _0925_ (.A1(\sol.start_stepper.xin[5] ),
    .A2(net17),
    .B1(_0438_),
    .C1(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0060_));
 sky130_fd_sc_hd__nand2b_2 _0926_ (.A_N(\sol.start_stepper.yin[7] ),
    .B(\sol.start_stepper.xin[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0439_));
 sky130_fd_sc_hd__nand2b_2 _0927_ (.A_N(\sol.start_stepper.xin[6] ),
    .B(\sol.start_stepper.yin[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0440_));
 sky130_fd_sc_hd__nand2_2 _0928_ (.A(_0439_),
    .B(_0440_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0441_));
 sky130_fd_sc_hd__o21a_2 _0929_ (.A1(_0435_),
    .A2(_0436_),
    .B1(_0433_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0442_));
 sky130_fd_sc_hd__xnor2_2 _0930_ (.A(_0441_),
    .B(_0442_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0443_));
 sky130_fd_sc_hd__nand2_2 _0931_ (.A(net17),
    .B(_0443_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0444_));
 sky130_fd_sc_hd__o211a_2 _0932_ (.A1(\sol.start_stepper.xin[6] ),
    .A2(net17),
    .B1(_0444_),
    .C1(net34),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0061_));
 sky130_fd_sc_hd__o21a_2 _0933_ (.A1(_0441_),
    .A2(_0442_),
    .B1(_0439_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0445_));
 sky130_fd_sc_hd__xor2_2 _0934_ (.A(\sol.start_stepper.yin[7] ),
    .B(\sol.start_stepper.xin[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0446_));
 sky130_fd_sc_hd__xnor2_2 _0935_ (.A(_0445_),
    .B(_0446_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0447_));
 sky130_fd_sc_hd__nand2_2 _0936_ (.A(net17),
    .B(_0447_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0448_));
 sky130_fd_sc_hd__o211a_2 _0937_ (.A1(\sol.start_stepper.xin[7] ),
    .A2(net17),
    .B1(_0448_),
    .C1(net38),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0062_));
 sky130_fd_sc_hd__a21oi_2 _0938_ (.A1(\sol.start_stepper.xin[2] ),
    .A2(net18),
    .B1(net87),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0449_));
 sky130_fd_sc_hd__a311oi_2 _0939_ (.A1(net87),
    .A2(\sol.start_stepper.xin[2] ),
    .A3(net18),
    .B1(_0449_),
    .C1(net30),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0063_));
 sky130_fd_sc_hd__xor2_2 _0940_ (.A(\sol.start_stepper.yin[1] ),
    .B(\sol.start_stepper.xin[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0450_));
 sky130_fd_sc_hd__and3_2 _0941_ (.A(\sol.start_stepper.yin[0] ),
    .B(\sol.start_stepper.xin[2] ),
    .C(_0450_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0451_));
 sky130_fd_sc_hd__a21oi_2 _0942_ (.A1(\sol.start_stepper.yin[0] ),
    .A2(\sol.start_stepper.xin[2] ),
    .B1(_0450_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0452_));
 sky130_fd_sc_hd__o21ai_2 _0943_ (.A1(_0451_),
    .A2(_0452_),
    .B1(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0453_));
 sky130_fd_sc_hd__o211a_2 _0944_ (.A1(\sol.start_stepper.yin[1] ),
    .A2(net18),
    .B1(_0453_),
    .C1(net38),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0064_));
 sky130_fd_sc_hd__nand2_2 _0945_ (.A(\sol.start_stepper.yin[2] ),
    .B(\sol.start_stepper.xin[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0454_));
 sky130_fd_sc_hd__or2_2 _0946_ (.A(\sol.start_stepper.yin[2] ),
    .B(\sol.start_stepper.xin[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0455_));
 sky130_fd_sc_hd__nand2_2 _0947_ (.A(_0454_),
    .B(_0455_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0456_));
 sky130_fd_sc_hd__a21oi_2 _0948_ (.A1(\sol.start_stepper.yin[1] ),
    .A2(\sol.start_stepper.xin[3] ),
    .B1(_0451_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0457_));
 sky130_fd_sc_hd__xnor2_2 _0949_ (.A(_0456_),
    .B(_0457_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0458_));
 sky130_fd_sc_hd__nand2_2 _0950_ (.A(net21),
    .B(_0458_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0459_));
 sky130_fd_sc_hd__o211a_2 _0951_ (.A1(\sol.start_stepper.yin[2] ),
    .A2(net21),
    .B1(_0459_),
    .C1(net39),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0065_));
 sky130_fd_sc_hd__nand2_2 _0952_ (.A(\sol.start_stepper.yin[3] ),
    .B(\sol.start_stepper.xin[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0460_));
 sky130_fd_sc_hd__or2_2 _0953_ (.A(\sol.start_stepper.yin[3] ),
    .B(\sol.start_stepper.xin[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0461_));
 sky130_fd_sc_hd__nand2_2 _0954_ (.A(_0460_),
    .B(_0461_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0462_));
 sky130_fd_sc_hd__o21a_2 _0955_ (.A1(_0456_),
    .A2(_0457_),
    .B1(_0454_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0463_));
 sky130_fd_sc_hd__xnor2_2 _0956_ (.A(_0462_),
    .B(_0463_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0464_));
 sky130_fd_sc_hd__nand2_2 _0957_ (.A(net21),
    .B(_0464_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0465_));
 sky130_fd_sc_hd__o211a_2 _0958_ (.A1(\sol.start_stepper.yin[3] ),
    .A2(net21),
    .B1(_0465_),
    .C1(net39),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0066_));
 sky130_fd_sc_hd__nand2_2 _0959_ (.A(\sol.start_stepper.yin[4] ),
    .B(\sol.start_stepper.xin[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0466_));
 sky130_fd_sc_hd__or2_2 _0960_ (.A(\sol.start_stepper.yin[4] ),
    .B(\sol.start_stepper.xin[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0467_));
 sky130_fd_sc_hd__nand2_2 _0961_ (.A(_0466_),
    .B(_0467_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0468_));
 sky130_fd_sc_hd__o21a_2 _0962_ (.A1(_0462_),
    .A2(_0463_),
    .B1(_0460_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0469_));
 sky130_fd_sc_hd__xnor2_2 _0963_ (.A(_0468_),
    .B(_0469_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0470_));
 sky130_fd_sc_hd__nand2_2 _0964_ (.A(net20),
    .B(_0470_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0471_));
 sky130_fd_sc_hd__o211a_2 _0965_ (.A1(\sol.start_stepper.yin[4] ),
    .A2(net18),
    .B1(_0471_),
    .C1(net38),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0067_));
 sky130_fd_sc_hd__nand2_2 _0966_ (.A(\sol.start_stepper.yin[5] ),
    .B(\sol.start_stepper.xin[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0472_));
 sky130_fd_sc_hd__or2_2 _0967_ (.A(\sol.start_stepper.yin[5] ),
    .B(\sol.start_stepper.xin[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0473_));
 sky130_fd_sc_hd__nand2_2 _0968_ (.A(_0472_),
    .B(_0473_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0474_));
 sky130_fd_sc_hd__o21a_2 _0969_ (.A1(_0468_),
    .A2(_0469_),
    .B1(_0466_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0475_));
 sky130_fd_sc_hd__xnor2_2 _0970_ (.A(_0474_),
    .B(_0475_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0476_));
 sky130_fd_sc_hd__nand2_2 _0971_ (.A(net20),
    .B(_0476_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0477_));
 sky130_fd_sc_hd__o211a_2 _0972_ (.A1(\sol.start_stepper.yin[5] ),
    .A2(net20),
    .B1(_0477_),
    .C1(net37),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0068_));
 sky130_fd_sc_hd__nand2_2 _0973_ (.A(\sol.start_stepper.yin[6] ),
    .B(\sol.start_stepper.xin[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0478_));
 sky130_fd_sc_hd__or2_2 _0974_ (.A(\sol.start_stepper.yin[6] ),
    .B(\sol.start_stepper.xin[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0479_));
 sky130_fd_sc_hd__nand2_2 _0975_ (.A(_0478_),
    .B(_0479_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0480_));
 sky130_fd_sc_hd__o21ai_2 _0976_ (.A1(_0474_),
    .A2(_0475_),
    .B1(_0472_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0481_));
 sky130_fd_sc_hd__xor2_2 _0977_ (.A(_0480_),
    .B(_0481_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0482_));
 sky130_fd_sc_hd__nand2_2 _0978_ (.A(net20),
    .B(_0482_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0483_));
 sky130_fd_sc_hd__o211a_2 _0979_ (.A1(\sol.start_stepper.yin[6] ),
    .A2(net20),
    .B1(_0483_),
    .C1(net37),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0069_));
 sky130_fd_sc_hd__a21boi_2 _0980_ (.A1(_0479_),
    .A2(_0481_),
    .B1_N(_0478_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0484_));
 sky130_fd_sc_hd__xnor2_2 _0981_ (.A(_0446_),
    .B(_0484_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0485_));
 sky130_fd_sc_hd__o21a_2 _0982_ (.A1(\sol.start_stepper.yin[7] ),
    .A2(net17),
    .B1(net36),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0486_));
 sky130_fd_sc_hd__o31a_2 _0983_ (.A1(_0400_),
    .A2(_0405_),
    .A3(_0485_),
    .B1(_0486_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0070_));
 sky130_fd_sc_hd__nor2_2 _0984_ (.A(net28),
    .B(_0137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0071_));
 sky130_fd_sc_hd__and3_2 _0985_ (.A(net32),
    .B(_0154_),
    .C(_0172_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0072_));
 sky130_fd_sc_hd__and3_2 _0986_ (.A(net32),
    .B(_0162_),
    .C(_0177_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0073_));
 sky130_fd_sc_hd__nor2_2 _0987_ (.A(net29),
    .B(_0163_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0074_));
 sky130_fd_sc_hd__nor2_2 _0988_ (.A(net29),
    .B(_0160_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0075_));
 sky130_fd_sc_hd__and2_2 _0989_ (.A(net33),
    .B(_0169_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0076_));
 sky130_fd_sc_hd__nor2_2 _0990_ (.A(net28),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0077_));
 sky130_fd_sc_hd__nor2_2 _0991_ (.A(net29),
    .B(_0166_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0078_));
 sky130_fd_sc_hd__nor2_2 _0992_ (.A(net65),
    .B(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0079_));
 sky130_fd_sc_hd__o21ai_2 _0993_ (.A1(\counter[0] ),
    .A2(net60),
    .B1(net34),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0487_));
 sky130_fd_sc_hd__a21oi_2 _0994_ (.A1(\counter[0] ),
    .A2(net60),
    .B1(_0487_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0080_));
 sky130_fd_sc_hd__a21o_2 _0995_ (.A1(\counter[0] ),
    .A2(\counter[1] ),
    .B1(\counter[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0488_));
 sky130_fd_sc_hd__and3_2 _0996_ (.A(\counter[0] ),
    .B(\counter[1] ),
    .C(\counter[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0489_));
 sky130_fd_sc_hd__and3b_2 _0997_ (.A_N(_0489_),
    .B(net34),
    .C(_0488_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0081_));
 sky130_fd_sc_hd__and4_2 _0998_ (.A(\counter[0] ),
    .B(\counter[1] ),
    .C(\counter[2] ),
    .D(\counter[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0490_));
 sky130_fd_sc_hd__o21ai_2 _0999_ (.A1(net63),
    .A2(_0489_),
    .B1(net36),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0491_));
 sky130_fd_sc_hd__nor2_2 _1000_ (.A(_0490_),
    .B(_0491_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0082_));
 sky130_fd_sc_hd__a21oi_2 _1001_ (.A1(\counter[4] ),
    .A2(_0490_),
    .B1(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0492_));
 sky130_fd_sc_hd__o21a_2 _1002_ (.A1(net77),
    .A2(_0490_),
    .B1(_0492_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0083_));
 sky130_fd_sc_hd__a21o_2 _1003_ (.A1(\counter[4] ),
    .A2(_0490_),
    .B1(\counter[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0493_));
 sky130_fd_sc_hd__and3_2 _1004_ (.A(\counter[4] ),
    .B(\counter[5] ),
    .C(_0490_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0494_));
 sky130_fd_sc_hd__and3b_2 _1005_ (.A_N(_0494_),
    .B(net36),
    .C(_0493_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0084_));
 sky130_fd_sc_hd__and4_2 _1006_ (.A(\counter[4] ),
    .B(\counter[5] ),
    .C(\counter[6] ),
    .D(_0490_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0495_));
 sky130_fd_sc_hd__o21ai_2 _1007_ (.A1(net64),
    .A2(_0494_),
    .B1(net36),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0496_));
 sky130_fd_sc_hd__nor2_2 _1008_ (.A(_0495_),
    .B(_0496_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0085_));
 sky130_fd_sc_hd__a21oi_2 _1009_ (.A1(net75),
    .A2(_0495_),
    .B1(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0497_));
 sky130_fd_sc_hd__o21a_2 _1010_ (.A1(net75),
    .A2(_0495_),
    .B1(_0497_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0086_));
 sky130_fd_sc_hd__a21o_2 _1011_ (.A1(\counter[7] ),
    .A2(_0495_),
    .B1(\counter[8] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0498_));
 sky130_fd_sc_hd__and3_2 _1012_ (.A(\counter[7] ),
    .B(\counter[8] ),
    .C(_0495_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0499_));
 sky130_fd_sc_hd__and3b_2 _1013_ (.A_N(_0499_),
    .B(net36),
    .C(_0498_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0087_));
 sky130_fd_sc_hd__and2_2 _1014_ (.A(\counter[9] ),
    .B(_0499_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0500_));
 sky130_fd_sc_hd__o21ai_2 _1015_ (.A1(net71),
    .A2(_0499_),
    .B1(net35),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0501_));
 sky130_fd_sc_hd__nor2_2 _1016_ (.A(_0500_),
    .B(_0501_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0088_));
 sky130_fd_sc_hd__o21ai_2 _1017_ (.A1(net59),
    .A2(_0500_),
    .B1(net35),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0502_));
 sky130_fd_sc_hd__a21oi_2 _1018_ (.A1(net59),
    .A2(_0500_),
    .B1(_0502_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0089_));
 sky130_fd_sc_hd__a31o_2 _1019_ (.A1(\counter[9] ),
    .A2(\counter[10] ),
    .A3(_0499_),
    .B1(\counter[11] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0503_));
 sky130_fd_sc_hd__and3_2 _1020_ (.A(\counter[10] ),
    .B(\counter[11] ),
    .C(_0500_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0504_));
 sky130_fd_sc_hd__and3b_2 _1021_ (.A_N(_0504_),
    .B(net37),
    .C(_0503_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0090_));
 sky130_fd_sc_hd__and2_2 _1022_ (.A(\counter[12] ),
    .B(_0504_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0505_));
 sky130_fd_sc_hd__o21ai_2 _1023_ (.A1(net70),
    .A2(_0504_),
    .B1(net37),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0506_));
 sky130_fd_sc_hd__nor2_2 _1024_ (.A(_0505_),
    .B(_0506_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0091_));
 sky130_fd_sc_hd__o21ai_2 _1025_ (.A1(net56),
    .A2(_0505_),
    .B1(net36),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0507_));
 sky130_fd_sc_hd__a21oi_2 _1026_ (.A1(net56),
    .A2(_0505_),
    .B1(_0507_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0092_));
 sky130_fd_sc_hd__a31o_2 _1027_ (.A1(\counter[12] ),
    .A2(\counter[13] ),
    .A3(_0504_),
    .B1(\counter[14] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0508_));
 sky130_fd_sc_hd__and3_2 _1028_ (.A(\counter[13] ),
    .B(\counter[14] ),
    .C(_0505_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0509_));
 sky130_fd_sc_hd__and3b_2 _1029_ (.A_N(_0509_),
    .B(net36),
    .C(_0508_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0093_));
 sky130_fd_sc_hd__and2_2 _1030_ (.A(\counter[15] ),
    .B(_0509_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0510_));
 sky130_fd_sc_hd__o21ai_2 _1031_ (.A1(net68),
    .A2(_0509_),
    .B1(net36),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0511_));
 sky130_fd_sc_hd__nor2_2 _1032_ (.A(_0510_),
    .B(_0511_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0094_));
 sky130_fd_sc_hd__o21ai_2 _1033_ (.A1(net57),
    .A2(_0510_),
    .B1(net34),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0512_));
 sky130_fd_sc_hd__a21oi_2 _1034_ (.A1(net57),
    .A2(_0510_),
    .B1(_0512_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0095_));
 sky130_fd_sc_hd__a31o_2 _1035_ (.A1(\counter[15] ),
    .A2(\counter[16] ),
    .A3(_0509_),
    .B1(\counter[17] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0513_));
 sky130_fd_sc_hd__and3_2 _1036_ (.A(\counter[16] ),
    .B(\counter[17] ),
    .C(_0510_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0514_));
 sky130_fd_sc_hd__and3b_2 _1037_ (.A_N(_0514_),
    .B(net34),
    .C(_0513_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0096_));
 sky130_fd_sc_hd__and2_2 _1038_ (.A(\counter[18] ),
    .B(_0514_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0515_));
 sky130_fd_sc_hd__o21ai_2 _1039_ (.A1(net69),
    .A2(_0514_),
    .B1(net34),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0516_));
 sky130_fd_sc_hd__nor2_2 _1040_ (.A(_0515_),
    .B(_0516_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0097_));
 sky130_fd_sc_hd__o21ai_2 _1041_ (.A1(net58),
    .A2(_0515_),
    .B1(net34),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0517_));
 sky130_fd_sc_hd__a21oi_2 _1042_ (.A1(net58),
    .A2(_0515_),
    .B1(_0517_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0098_));
 sky130_fd_sc_hd__a31o_2 _1043_ (.A1(\counter[18] ),
    .A2(\counter[19] ),
    .A3(_0514_),
    .B1(\counter[20] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0518_));
 sky130_fd_sc_hd__and3_2 _1044_ (.A(\counter[19] ),
    .B(\counter[20] ),
    .C(_0515_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0519_));
 sky130_fd_sc_hd__and3b_2 _1045_ (.A_N(_0519_),
    .B(net34),
    .C(_0518_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0099_));
 sky130_fd_sc_hd__o21ai_2 _1046_ (.A1(net55),
    .A2(_0519_),
    .B1(net34),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0520_));
 sky130_fd_sc_hd__a21oi_2 _1047_ (.A1(net55),
    .A2(_0519_),
    .B1(_0520_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0100_));
 sky130_fd_sc_hd__dfxtp_2 _1048_ (.CLK(clknet_4_7_0_clk),
    .D(_0002_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\predict.old_rgb[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1049_ (.CLK(clknet_4_7_0_clk),
    .D(_0003_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1050_ (.CLK(clknet_4_13_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\grid.vpos[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1051_ (.CLK(clknet_4_7_0_clk),
    .D(_0005_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\grid.vpos[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1052_ (.CLK(clknet_4_7_0_clk),
    .D(_0006_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\grid.shft_vpos[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1053_ (.CLK(clknet_4_7_0_clk),
    .D(_0007_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\grid.shft_vpos[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1054_ (.CLK(clknet_4_12_0_clk),
    .D(_0008_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\grid.shft_vpos[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1055_ (.CLK(clknet_4_12_0_clk),
    .D(_0009_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\grid.shft_vpos[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1056_ (.CLK(clknet_4_12_0_clk),
    .D(_0010_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\grid.shft_vpos[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1057_ (.CLK(clknet_4_13_0_clk),
    .D(_0011_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\grid.shft_vpos[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1058_ (.CLK(clknet_4_12_0_clk),
    .D(_0012_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\grid.shft_vpos[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1059_ (.CLK(clknet_4_12_0_clk),
    .D(_0013_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\grid.shft_vpos[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1060_ (.CLK(clknet_4_4_0_clk),
    .D(_0014_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\grid.hpos[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1061_ (.CLK(clknet_4_5_0_clk),
    .D(net67),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\grid.hpos[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1062_ (.CLK(clknet_4_4_0_clk),
    .D(_0016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\grid.hpos[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1063_ (.CLK(clknet_4_4_0_clk),
    .D(_0017_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\grid.hpos[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1064_ (.CLK(clknet_4_5_0_clk),
    .D(_0018_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\grid.hpos[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1065_ (.CLK(clknet_4_5_0_clk),
    .D(_0019_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\grid.hpos[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1066_ (.CLK(clknet_4_4_0_clk),
    .D(_0020_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\grid.hpos[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1067_ (.CLK(clknet_4_5_0_clk),
    .D(_0021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\grid.hpos[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1068_ (.CLK(clknet_4_6_0_clk),
    .D(_0022_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\grid.hpos[8] ));
 sky130_fd_sc_hd__dfxtp_2 _1069_ (.CLK(clknet_4_6_0_clk),
    .D(_0023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1070_ (.CLK(clknet_4_6_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\predict.saved_rgb[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1071_ (.CLK(clknet_4_7_0_clk),
    .D(_0025_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\predict.saved_rgb[1] ));
 ...
 sky130_fd_sc_hd__dfxtp_2 _1073_ (.CLK(clknet_4_13_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\predict.saved_rgb[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1074_ (.CLK(clknet_4_6_0_clk),
    .D(_0028_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\predict.saved_rgb[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1075_ (.CLK(clknet_4_13_0_clk),
    .D(_0029_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\predict.saved_rgb[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1076_ (.CLK(clknet_4_1_0_clk),
    .D(_0030_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\predict.old_xc[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1077_ (.CLK(clknet_4_4_0_clk),
    .D(_0031_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\predict.old_xc[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1078_ (.CLK(clknet_4_4_0_clk),
    .D(_0032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\predict.old_xc[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1079_ (.CLK(clknet_4_4_0_clk),
    .D(_0033_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1080_ (.CLK(clknet_4_1_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\predict.old_xc[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1081_ (.CLK(clknet_4_5_0_clk),
    .D(_0035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\predict.old_xc[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1082_ (.CLK(clknet_4_3_0_clk),
    .D(_0036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1083_ (.CLK(clknet_4_6_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\predict.old_xc[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1084_ (.CLK(clknet_4_3_0_clk),
    .D(_0038_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.saved_seen ));
 sky130_fd_sc_hd__dfxtp_2 _1085_ (.CLK(clknet_4_1_0_clk),
    .D(_0039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.curr_x[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1086_ (.CLK(clknet_4_0_0_clk),
    .D(_0040_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.curr_x[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1087_ (.CLK(clknet_4_0_0_clk),
    .D(_0041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.curr_x[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1088_ (.CLK(clknet_4_0_0_clk),
    .D(_0042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.curr_x[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1089_ (.CLK(clknet_4_0_0_clk),
    .D(_0043_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.curr_x[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1090_ (.CLK(clknet_4_0_0_clk),
    .D(_0044_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.curr_x[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1091_ (.CLK(clknet_4_0_0_clk),
    .D(_0045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.curr_x[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1092_ (.CLK(clknet_4_2_0_clk),
    .D(_0046_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.curr_x[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1093_ (.CLK(clknet_4_2_0_clk),
    .D(_0047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.curr_y[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1094_ (.CLK(clknet_4_2_0_clk),
    .D(_0048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.curr_y[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1095_ (.CLK(clknet_4_2_0_clk),
    .D(_0049_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.curr_y[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1096_ (.CLK(clknet_4_2_0_clk),
    .D(_0050_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.curr_y[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1097_ (.CLK(clknet_4_2_0_clk),
    .D(_0051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.curr_y[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1098_ (.CLK(clknet_4_2_0_clk),
    .D(_0052_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1099_ (.CLK(clknet_4_9_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\sol.curr_y[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1100_ (.CLK(clknet_4_9_0_clk),
    .D(_0054_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1103_ (.CLK(clknet_4_15_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.start_stepper.xin[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1104_ (.CLK(clknet_4_15_0_clk),
    .D(_0058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.start_stepper.xin[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1105_ (.CLK(clknet_4_11_0_clk),
    .D(_0059_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.start_stepper.xin[4] ));
 ...
 sky130_fd_sc_hd__dfxtp_2 _1108_ (.CLK(clknet_4_14_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.start_stepper.xin[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1109_ (.CLK(clknet_4_15_0_clk),
    .D(net88),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.start_stepper.yin[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1110_ (.CLK(clknet_4_14_0_clk),
    .D(_0064_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.start_stepper.yin[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1111_ (.CLK(clknet_4_12_0_clk),
    .D(_0065_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.start_stepper.yin[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1112_ (.CLK(clknet_4_15_0_clk),
    .D(_0066_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.start_stepper.yin[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1113_ (.CLK(clknet_4_15_0_clk),
    .D(_0067_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.start_stepper.yin[4] ));
 ...
 sky130_fd_sc_hd__dfxtp_2 _1115_ (.CLK(clknet_4_10_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.start_stepper.yin[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1116_ (.CLK(clknet_4_14_0_clk),
    .D(_0070_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.start_stepper.yin[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1117_ (.CLK(clknet_4_1_0_clk),
    .D(_0071_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.old_x[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1118_ (.CLK(clknet_4_1_0_clk),
    .D(_0072_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.old_x[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1119_ (.CLK(clknet_4_1_0_clk),
    .D(_0073_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.old_x[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1120_ (.CLK(clknet_4_0_0_clk),
    .D(_0074_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.old_x[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1121_ (.CLK(clknet_4_3_0_clk),
    .D(_0075_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.old_x[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1122_ (.CLK(clknet_4_3_0_clk),
    .D(_0076_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.old_x[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1123_ (.CLK(clknet_4_3_0_clk),
    .D(_0077_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.old_x[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1124_ (.CLK(clknet_4_3_0_clk),
    .D(_0078_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sol.old_x[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1125_ (.CLK(clknet_4_9_0_clk),
    .D(_0079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\counter[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1126_ (.CLK(clknet_4_9_0_clk),
    .D(net61),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\counter[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1127_ (.CLK(clknet_4_8_0_clk),
    .D(_0081_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1128_ (.CLK(clknet_4_14_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\counter[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1129_ (.CLK(clknet_4_11_0_clk),
    .D(net78),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\counter[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1130_ (.CLK(clknet_4_8_0_clk),
    .D(_0084_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1131_ (.CLK(clknet_4_10_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\counter[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1132_ (.CLK(clknet_4_11_0_clk),
    .D(_0086_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1134_ (.CLK(clknet_4_10_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\counter[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1135_ (.CLK(clknet_4_11_0_clk),
    .D(_0089_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1136_ (.CLK(clknet_4_11_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\counter[11] ));
 sky130_fd_sc_hd__dfxtp_2 _1137_ (.CLK(clknet_4_11_0_clk),
    .D(_0091_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\counter[12] ));
 sky130_fd_sc_hd__dfxtp_2 _1138_ (.CLK(clknet_4_10_0_clk),
    .D(_0092_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\counter[13] ));
 sky130_fd_sc_hd__dfxtp_2 _1139_ (.CLK(clknet_4_10_0_clk),
    .D(_0093_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\counter[14] ));
 sky130_fd_sc_hd__dfxtp_2 _1140_ (.CLK(clknet_4_8_0_clk),
    .D(_0094_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\counter[15] ));
 sky130_fd_sc_hd__dfxtp_2 _1141_ (.CLK(clknet_4_8_0_clk),
    .D(_0095_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1142_ (.CLK(clknet_4_8_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\counter[17] ));
 sky130_fd_sc_hd__dfxtp_2 _1143_ (.CLK(clknet_4_8_0_clk),
    .D(_0097_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\counter[18] ));
 sky130_fd_sc_hd__dfxtp_2 _1144_ (.CLK(clknet_4_9_0_clk),
    .D(_0098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\counter[19] ));
 sky130_fd_sc_hd__dfxtp_2 _1145_ (.CLK(clknet_4_8_0_clk),
    .D(_0099_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\counter[20] ));
 sky130_fd_sc_hd__dfxtp_2 _1146_ (.CLK(clknet_4_9_0_clk),
    .D(_0100_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\counter[21] ));
 sky130_fd_sc_hd__dfxtp_2 _1147_ (.CLK(clknet_4_5_0_clk),
    .D(net73),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(hsync));
 sky130_fd_sc_hd__dfxtp_2 _1148_ (.CLK(clknet_4_13_0_clk),
    .D(net83),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 _1165_ (.A(\hvsync_gen.vsync ),
    ...
    .VPWR(VPWR),
    .X(uo_out[3]));
 sky130_fd_sc_hd__buf_2 _1166_ (.A(hsync),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 clkload9 (.A(clknet_4_14_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout10 (.A(_0263_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout19 (.A(net21),
    ...
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout21 (.A(_0406_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net21));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout22 (.A(_0275_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout23 (.A(_0275_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout25 (.A(net26),
    ...
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout26 (.A(_0117_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net26));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout27 (.A(\grid.hpos[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout30 (.A(net31),
    ...
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout31 (.A(_0108_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout39 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout9 (.A(_0263_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__dlygate4sd3_1 hold55 (.A(\counter[21] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__dlygate4sd3_1 hold56 (.A(\counter[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd3_1 hold57 (.A(\counter[16] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net57));
 sky130_fd_sc_hd__dlygate4sd3_1 hold58 (.A(\counter[19] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__dlygate4sd3_1 hold59 (.A(\counter[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__dlygate4sd3_1 hold60 (.A(\counter[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold61 (.A(_0080_),
    ...
    .VPWR(VPWR),
    .X(net61));
 sky130_fd_sc_hd__dlygate4sd3_1 hold62 (.A(\grid.shft_vpos[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold63 (.A(\counter[3] ),
    ...
    .VPWR(VPWR),
    .X(net63));
 sky130_fd_sc_hd__dlygate4sd3_1 hold64 (.A(\counter[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold65 (.A(\counter[0] ),
    ...
    .VPWR(VPWR),
    .X(net65));
 sky130_fd_sc_hd__dlygate4sd3_1 hold66 (.A(\grid.hpos[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold67 (.A(_0015_),
    ...
    .VPWR(VPWR),
    .X(net67));
 sky130_fd_sc_hd__dlygate4sd3_1 hold68 (.A(\counter[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net68));
 sky130_fd_sc_hd__dlygate4sd3_1 hold69 (.A(\counter[18] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net69));
 sky130_fd_sc_hd__dlygate4sd3_1 hold70 (.A(\counter[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net70));
 sky130_fd_sc_hd__dlygate4sd3_1 hold71 (.A(\counter[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net71));
 sky130_fd_sc_hd__dlygate4sd3_1 hold72 (.A(\grid.hpos[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold73 (.A(_0000_),
    ...
    .VPWR(VPWR),
    .X(net73));
 sky130_fd_sc_hd__dlygate4sd3_1 hold74 (.A(\grid.vpos[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net74));
 sky130_fd_sc_hd__dlygate4sd3_1 hold75 (.A(\counter[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net75));
 sky130_fd_sc_hd__dlygate4sd3_1 hold76 (.A(\grid.shft_vpos[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net76));
 sky130_fd_sc_hd__dlygate4sd3_1 hold77 (.A(\counter[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net77));
 sky130_fd_sc_hd__dlygate4sd3_1 hold78 (.A(_0083_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net78));
 sky130_fd_sc_hd__dlygate4sd3_1 hold79 (.A(\grid.vpos[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net79));
 sky130_fd_sc_hd__dlygate4sd3_1 hold80 (.A(\grid.shft_vpos[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net80));
 sky130_fd_sc_hd__dlygate4sd3_1 hold81 (.A(\grid.shft_vpos[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net81));
 sky130_fd_sc_hd__dlygate4sd3_1 hold82 (.A(\grid.shft_vpos[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net82));
 sky130_fd_sc_hd__dlygate4sd3_1 hold83 (.A(_0001_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net83));
 sky130_fd_sc_hd__dlygate4sd3_1 hold84 (.A(\grid.shft_vpos[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net84));
 sky130_fd_sc_hd__dlygate4sd3_1 hold85 (.A(\grid.hpos[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net85));
 sky130_fd_sc_hd__dlygate4sd3_1 hold86 (.A(\sol.start_stepper.xin[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net86));
 sky130_fd_sc_hd__dlygate4sd3_1 hold87 (.A(\sol.start_stepper.yin[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold88 (.A(_0063_),
    ...
    .VPWR(VPWR),
    .X(net88));
 sky130_fd_sc_hd__dlygate4sd3_1 hold89 (.A(\grid.shft_vpos[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net89));
 sky130_fd_sc_hd__dlygate4sd3_1 hold90 (.A(\grid.hpos[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net90));
 sky130_fd_sc_hd__dlygate4sd3_1 hold91 (.A(\grid.hpos[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap11 (.A(net12),
    ...
    .VPWR(VPWR),
    .X(net11));
 sky130_fd_sc_hd__clkbuf_2 max_cap15 (.A(_0158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net15));
 sky130_fd_sc_hd__buf_1 max_cap2 (.A(_0352_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net2));
 sky130_fd_sc_hd__buf_2 max_cap24 (.A(_0160_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__conb_1 tt_um_bad_ode_plotter_vga (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_bad_ode_plotter_vga_40 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net40));
 sky130_fd_sc_hd__conb_1 tt_um_bad_ode_plotter_vga_41 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net41));
 sky130_fd_sc_hd__conb_1 tt_um_bad_ode_plotter_vga_42 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net42));
 sky130_fd_sc_hd__conb_1 tt_um_bad_ode_plotter_vga_43 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net43));
 sky130_fd_sc_hd__conb_1 tt_um_bad_ode_plotter_vga_44 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net44));
 sky130_fd_sc_hd__conb_1 tt_um_bad_ode_plotter_vga_45 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net45));
 sky130_fd_sc_hd__conb_1 tt_um_bad_ode_plotter_vga_46 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net46));
 sky130_fd_sc_hd__conb_1 tt_um_bad_ode_plotter_vga_47 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net47));
 sky130_fd_sc_hd__conb_1 tt_um_bad_ode_plotter_vga_48 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net48));
 sky130_fd_sc_hd__conb_1 tt_um_bad_ode_plotter_vga_49 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net49));
 sky130_fd_sc_hd__conb_1 tt_um_bad_ode_plotter_vga_50 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net50));
 sky130_fd_sc_hd__conb_1 tt_um_bad_ode_plotter_vga_51 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net51));
 sky130_fd_sc_hd__conb_1 tt_um_bad_ode_plotter_vga_52 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net52));
 sky130_fd_sc_hd__conb_1 tt_um_bad_ode_plotter_vga_53 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net53));
 sky130_fd_sc_hd__conb_1 tt_um_bad_ode_plotter_vga_54 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net54));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 wire13 (.A(net14),
    ...
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__clkdlybuf4s25_1 wire14 (.A(_0181_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
